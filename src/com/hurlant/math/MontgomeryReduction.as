package com.hurlant.math
{
   ...
   class MontgomeryReduction implements IReduction
   {
      ...
      function MontgomeryReduction(param1:BigInteger)
      {
         super();
         this.m = param1;
         this.var_1754 = param1.invDigit();
         this.var_1753 = this.var_1754 & 32767;
         this.var_2384 = this.var_1754 >> 15;
         this.var_2385 = 131071;
         this.var_2386 = 2 * param1.t;
      }
      ...
      public function convert(param1:BigInteger) : BigInteger
      {
         ...
         if(param1.s < 0 && _loc2_.compareTo(BigInteger.const_192) > 0)
         {
