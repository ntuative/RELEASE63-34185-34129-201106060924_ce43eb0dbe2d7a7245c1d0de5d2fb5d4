package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1259:String = "AssetLibraryReady";
      
      public static const const_944:String = "AssetLibraryLoaded";
      
      public static const const_1826:String = "AssetLibraryUnloaded";
      
      public static const const_1764:String = "AssetLibraryLoadError";
      
      private static const const_660:String = "name";
      
      private static const const_1083:String = "asset";
      
      private static const const_1082:String = "param";
      ...
      private static var var_1912:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_540:uint = 0;
      
      private static var var_1007:Array = new Array();
      ...
      private var var_1009:Boolean = true;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_540;
         this.var_458 = new Dictionary(false);
         this.var_541 = new Dictionary(false);
         this.var_1008 = new Dictionary(false);
         this.var_169 = new Dictionary(false);
         var_1007.push(this);
      }
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_665 + " doesn\'t contain valid resource class!");
         }
         var _loc5_:XMLList = param2.child(const_1081);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            _loc5_ = _loc5_.child(const_1083);
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               _loc7_ = _loc6_.attribute(const_660);
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc11_ = _loc6_.child(const_1082);
                  if(_loc11_.length())
                  {
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_665 + "!");
               }
               _loc15_++;
            }
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_1007.splice(var_1007.indexOf(this),1);
            --var_540;
            this.var_541 = null;
            this.var_1008 = null;
            this.var_169 = null;
      ...
      {
         if(this.var_665 == param1.url && this.var_1006)
         {
            if(!this.var_1009 && param2)
            {
      ...
      public function unload() : void
      {
         ...
         {
            _loc2_ = this.var_541[_loc1_];
            _loc2_.assetLoader.dispose();
            delete this.var_541[_loc1_];
         }
         for(_loc1_ in this.var_169)
         {
            delete this.var_169[_loc1_];
         }
         for(_loc1_ in this.var_1008)
         {
            delete this.var_1008[_loc1_];
         }
         if(this.var_43 != null)
         {
            this.var_43.dispose();
         ...
         this.var_1006 = false;
         this.var_665 = null;
         dispatchEvent(new Event(AssetLibrary.const_1826));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_1008[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_541[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1139,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1335,this.assetLoadEventHandler);
         ...
         this.var_541[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_541[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_29:
               ...
               if(decl != null)
               {
                  ...
                  if(this.var_169[struct.assetName] == null)
                  {
                     ++this.var_459;
                     this.var_457.push(struct.assetName);
                  }
                  this.var_169[struct.assetName] = asset;
               }
               else
               {
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_541[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         var _loc2_:IAsset = this.var_169[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      {
         return param1 < this.var_457.length ? this.getAssetByName(this.var_457[param1]) : null;
      }
      ...
      public function getAssetByContent(param1:Object) : IAsset
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         for(_loc2_ in this.var_169)
         {
            _loc3_ = this.var_169[_loc2_];
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_169)
         {
            if(this.var_169[_loc2_] == param1)
            {
               return this.var_457.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_169[param1] != null || (this.var_666 != null ? this.var_666[param1] != null : false);
      }
      
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         var _loc4_:* = this.var_169[param1] == null;
         if((param3 || _loc4_) && param2)
         {
            if(_loc4_)
            {
               ++this.var_459;
               this.var_457.push(param1);
            }
            this.var_169[param1] = param2;
            if(param2 is ILazyAsset)
            {
               var_1912.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in this.var_169)
            {
               if(this.var_169[_loc2_] == param1)
               {
                  this.var_457.splice(this.var_457.indexOf(_loc2_),1);
                  delete this.var_169[_loc2_];
                  --this.var_459;
                  return param1;
               }
            }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(this.var_458.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_458[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         return AssetTypeDeclaration(this.var_458[param1]);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in this.var_458)
         {
            _loc3_ = AssetTypeDeclaration(this.var_458[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in this.var_458)
         {
            _loc4_ = AssetTypeDeclaration(this.var_458[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_665 = _loc2_.url;
         if(this.var_1009)
         {
            AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_666);
         }
         this.var_1006 = true;
         dispatchEvent(new Event(AssetLibrary.const_944));
         dispatchEvent(new Event(AssetLibrary.const_1259));
         if(this.var_1009)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1764));
         this.var_43 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_1081);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.child(const_1083);
            _loc5_ = null;
