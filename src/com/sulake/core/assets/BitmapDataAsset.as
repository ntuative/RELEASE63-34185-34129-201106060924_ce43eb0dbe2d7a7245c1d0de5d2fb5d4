   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_112 is BitmapDataAsset)
         {
            ...
            this.var_1511 = BitmapDataAsset(this.var_112).var_1511;
            this.var_1512 = BitmapDataAsset(this.var_112).var_1512;
            if(this._bitmap != null)
            {
               this.var_112 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1511 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
                  this.var_1512 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }
