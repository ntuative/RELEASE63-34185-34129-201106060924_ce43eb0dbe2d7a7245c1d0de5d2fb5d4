package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1698:int = 10000;
      ...
      private var var_1155:IEncryption;
      
      private var var_745:IProtocol;
      
      private var _id:String;
      
      private var var_1154:IMessageClassManager;
      
      private var var_257:ICoreCommunicationManager;
      
      private var var_507:IConnectionStateListener;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this.var_1154 = new MessageClassManager();
         this.var_78 = new Socket();
         this.var_203 = new Timer(const_1698,1);
         this.var_203.addEventListener(TimerEvent.TIMER,this.onTimeOutTimer);
         this.var_78.addEventListener(Event.CONNECT,this.onConnect);
         this.var_78.addEventListener(Event.COMPLETE,this.include);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_78)
         {
            ...
            this.var_78.removeEventListener(Event.COMPLETE,this.include);
         ...
         {
            this.var_203.stop();
            this.var_203.removeEventListener(TimerEvent.TIMER,this.onTimeOutTimer);
         }
         this.var_203 = null;
         this.var_508 = null;
         this.var_507 = null;
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         if(this.var_507)
         {
            this.var_507.connectionInit(param1,param2);
         }
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_1154.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
         ...
         if(this.var_507)
         {
            this.var_507.messageSent(String(_loc4_),_loc6_.toString());
         }
         if(this.var_1155 != null)
         {
            _loc3_ = this.var_1155.encipher(_loc6_);
         }
         else
         {
            _loc3_ = _loc6_;
      ...
      {
         this.var_1154.registerMessages(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         return _loc1_ + ("Encryption: " + this.var_1155 + "\n");
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_745.getMessages(this.var_508,receivedMessages);
         try
         {
            for each(message in receivedMessages)
            {
               ...
               if(this.var_507)
               {
                  this.var_507.messageReceived(String(id),data.toString());
               }
               eventClasses = this.var_1154.getMessageEventClasses(id);
               events = new Array();
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         _loc2_.text = "Socket Timeout (" + this.var_203.delay + " ms). Possible Firewall.";
