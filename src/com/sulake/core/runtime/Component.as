package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      protected static const const_455:String = "_INTERNAL_EVENT_UNLOCKED";
      
      public static const COMPONENT_FLAG_NULL:uint = 0;
      
      public static const const_2088:uint = 1;
      ...
      protected var var_866:uint = 0;
      
      protected var var_1382:String = "";
      
      protected var var_2203:String = "";
      ...
      private var var_527:InterfaceStructList;
      ...
      public function Component(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_527 = new InterfaceStructList();
      ...
      {
         var _loc3_:InterfaceStruct = this.var_527.getStructByInterface(param1);
         if(_loc3_ == null)
         {
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = this.var_527.getStructByInterface(param1);
         if(_loc2_ == null)
         {
            this.var_1382 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(this.var_1382);
         }
         var _loc3_:uint = _loc2_.release();
         if(this.var_1527 & const_1323)
         {
            if(_loc3_ == 0)
            {
               if(this.var_527.getTotalReferenceCount() == 0)
               {
      ...
      protected final function unlock() : void
      {
         ...
         {
            this.var_964 = false;
            this._events.dispatchEvent(new LockEvent(const_455,this));
         }
      }
      
      public function toString() : String
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + this.var_866 + "]";
      }
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         var _loc7_:uint = this.var_527.length;
         var _loc8_:int = 0;
         while(_loc8_ < _loc7_)
         {
            _loc6_ = this.var_527.getStructByIndex(_loc8_);
