package com.sulake.core.utils
{
   ...
   public class Map extends Proxy implements IDisposable
   {
      ...
      public function dispose() : void
      {
         ...
         {
            for(_loc1_ in this.var_146)
            {
               delete this.var_146[_loc1_];
            }
            this.var_146 = null;
         }
         this._length = 0;
      ...
      {
         return this.var_146[param1];
      }
      
      public function remove(param1:*) : *
      {
         var _loc2_:Object = this.var_146[param1];
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      override flash_proxy function setProperty(param1:*, param2:*) : void
      {
         ...
         if(this._singleWrite)
         {
            if(this.var_146[param1] != null)
            {
               Core.error("Trying to write to a single write Map. Key: " + param1 + ", value: " + param2,true,Core.const_1925);
            }
         }
         this.var_146[param1] = param2;
