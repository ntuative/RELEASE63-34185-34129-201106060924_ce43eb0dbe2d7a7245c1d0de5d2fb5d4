package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1152:uint = 0;
      ...
      private static const const_1026:Point = new Point();
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(!this.var_22)
         {
            this.var_22 = this.getGraphicContext(!testParamFlag(WindowParam.const_34));
         }
         this._events = new WindowEventDispatcher(this);
         this._children = new Array();
         this.var_354 = new Rectangle();
         if(_loc12_ != null)
         {
            var_413 = new Rectangle(0,0,int(_loc12_.attribute("width")),int(_loc12_.attribute("height")));
            var_65 = var_413.clone();
            var_11 = var_413.clone();
            ...
            var_65.x = param6.x;
            var_65.y = param6.y;
            var_65.width = param6.width;
            var_65.height = param6.height;
         }
         var _loc13_:DefaultAttStruct = param5.getWindowFactory().getDefaultsByTypeAndStyle(param2,param3);
         if(_loc13_)
         {
            _blend = _loc13_.blend;
            var_490 = _loc13_.var_2969;
            if(var_489 != _loc13_.background)
            {
               this.background = _loc13_.background;
            }
            if(var_248 != _loc13_.color)
            {
               this.color = _loc13_.color;
            }
            if(_loc13_.hasRectLimits())
            {
               var_77.assign(_loc13_.width_min,_loc13_.width_max,_loc13_.height_min,_loc13_.height_max);
            }
         }
         if(param9)
         {
      ...
      {
         var_489 = param1;
         var_248 = !!var_489 ? uint(var_248 | var_583) : uint(var_248 & 16777215);
         this.var_178 = this.var_178 || param1;
         _context.invalidate(this,var_11,WindowRedrawFlag.const_62);
      }
      
      public function set color(param1:uint) : void
      {
         var_583 = param1 & 4278190080;
         var_248 = !!var_489 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_62);
      }
      ...
      {
         var_583 = param1 << 24;
         var_248 = !!var_489 ? uint(var_583 | var_248) : uint(16777215 & var_248);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_62);
      }
      ...
      public function set blend(param1:Number) : void
      {
         ...
         _context.invalidate(this,var_11,WindowRedrawFlag.const_1304);
      }
      ...
      {
         var_490 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            _context.invalidate(this,var_11,WindowRedrawFlag.const_898);
         }
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               this.var_354 = this._parent.rectangle.clone();
               var_65.x = var_11.x;
               var_65.y = var_11.y;
               var_65.width = var_11.width;
               var_65.height = var_11.height;
               _loc4_ = WindowEvent.allocate(WindowEvent.const_512,this,this._parent);
            ...
            else
            {
               this.var_354.x = 0;
               this.var_354.y = 0;
               this.var_354.width = 0;
               this.var_354.height = 0;
               _loc4_ = WindowEvent.allocate(WindowEvent.const_1924,this,_loc2_);
               this.update(this,_loc4_);
            }
            _loc4_.recycle();
         }
      ...
      {
         return this.var_22 != null || !testParamFlag(WindowParam.const_34);
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         ...
         {
            this.var_22 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_819,var_11);
            this.var_22.visible = var_305;
         }
         return this.var_22;
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_83,var_21,_context,var_11,null,this.var_717,this.properties,var_896.concat(),_id) as WindowController;
         _loc2_.var_490 = var_490;
         _loc2_.var_178 = this.var_178;
         _loc2_._debug = this._debug;
         _loc2_.var_354 = this.var_354.clone();
         _loc2_.var_11 = var_11.clone();
         _loc2_.var_413 = var_413.clone();
         _loc2_.var_65 = var_65.clone();
         _loc2_.var_153 = !!var_153 ? var_153.clone() : null;
         _loc2_.var_154 = !!var_154 ? var_154.clone() : null;
         _loc2_.var_77 = !!var_77 ? var_77.clone(_loc2_) : null;
         _loc2_._context = _context;
         _loc2_.var_248 = var_248;
         _loc2_.var_583 = var_583;
         _loc2_.var_716 = var_716;
         _loc2_.var_305 = var_305;
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + _name + " " + this.var_2307 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         param4 = Math.max(var_77.minHeight,param4);
         param4 = Math.min(var_77.maxHeight,param4);
         param3 = Math.max(var_77.minWidth,param3);
         param3 = Math.min(var_77.maxWidth,param3);
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            else if(_loc7_ == WindowParam.const_535)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
            ...
            else if(_loc7_ == WindowParam.const_516)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            ...
            if(_loc6_)
            {
               _loc9_ = WindowEvent.allocate(WindowEvent.const_1177,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               _loc9_ = WindowEvent.allocate(WindowEvent.const_440,this,null);
               this.update(this,_loc9_);
               _loc9_.recycle();
            }
            if(_loc6_)
      ...
      public function getRegionProperties(param1:Rectangle = null, param2:Rectangle = null, param3:Rectangle = null, param4:Rectangle = null) : void
      {
         ...
         if(param2 != null)
         {
            param2.x = var_65.x;
            param2.y = var_65.y;
            param2.width = var_65.width;
            param2.height = var_65.height;
         }
         if(param3 != null && var_153 != null)
         {
            param3.x = var_153.x;
            param3.y = var_153.y;
            param3.width = var_153.width;
            param3.height = var_153.height;
         }
         if(param4 != null && var_154 != null)
         {
            param4.x = var_154.x;
            param4.y = var_154.y;
            param4.width = var_154.width;
            param4.height = var_154.height;
         }
      }
      ...
      public function setRegionProperties(param1:Rectangle = null, param2:Rectangle = null, param3:Rectangle = null) : void
      {
         if(param3 != null)
         {
            ...
            var_154.x = param3.x;
            var_154.y = param3.y;
            var_154.width = param3.width;
            var_154.height = param3.height;
         }
         if(param2 != null)
         {
            ...
            var_153.x = param2.x;
            var_153.y = param2.y;
            var_153.width = param2.width;
            var_153.height = param2.height;
         }
      ...
      public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = 0;
         if(!testParamFlag(WindowParam.const_994))
         {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_44:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1268;
                  if(testParamFlag(WindowParam.const_379))
                  {
                     _loc3_ = {};
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_299))
                        {
                  ...
                  if((var_21 & 0) > 0)
                  {
                     ...
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_355))
                        {
               ...
               case WindowMouseEvent.const_56:
                  ...
                  if(testParamFlag(WindowParam.const_299))
                  {
                     _context.getWindowServices().getMouseDraggingService().end(this);
                  }
                  if(testParamFlag(WindowParam.const_355))
                  {
         ...
         else if(param2 is WindowEvent)
         {
            switch(param2.type)
            {
               case WindowEvent.const_41:
                  _context.invalidate(this,var_11.union(var_65),WindowRedrawFlag.RESIZE);
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_915,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(testParamFlag(WindowParam.const_223,WindowParam.const_193))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_227,WindowParam.const_190))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
                     {
                        _loc7_ = uint(var_21);
                        var_21 &= ~(0 | 0);
                        if(testParamFlag(WindowParam.const_507))
                        {
                           this._parent.width += 0 - 0;
                        }
                        if(testParamFlag(WindowParam.const_631))
                        {
                           this._parent.height += 0 - 0;
                        }
                        var_21 = _loc7_;
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_124,this._parent,this);
                        this._parent.update(this,_loc5_);
                        _loc5_.recycle();
                     }
                  }
                  break;
               case WindowEvent.const_440:
                  _loc6_ = var_11.union(var_65);
                  if(this._parent)
                  {
                  ...
                  _context.invalidate(this,_loc6_,WindowRedrawFlag.const_1348);
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_1701,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(this._parent != null)
                     {
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_220,this._parent,this);
                        this._parent.update(this,_loc5_);
                        _loc5_.recycle();
                     }
                  }
                  break;
               case WindowEvent.const_615:
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_1272,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(this._parent != null)
                     {
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_366,this._parent,this);
                        this._parent.update(this,_loc5_);
                        _loc5_.recycle();
                     }
                  }
                  break;
               case WindowEvent.const_512:
                  if(testParamFlag(WindowParam.const_223,WindowParam.const_193))
                  {
                     this.updateScaleRelativeToParent();
                  }
                  ...
                  _context.invalidate(this,var_11,WindowRedrawFlag.const_62);
                  break;
               case WindowEvent.const_915:
                  this._parent.getRegionProperties(null,this.var_354);
                  this.updateScaleRelativeToParent();
                  break;
               case WindowEvent.const_344:
               ...
               case WindowEvent.const_385:
                  break;
               case WindowEvent.const_366:
                  this.activate();
                  break;
               case WindowEvent.const_124:
                  if(testParamFlag(WindowParam.WINDOW_PARAM_RESIZE_TO_ACCOMMODATE_CHILDREN))
                  {
                     expandToAccommodateChild(this,param2.related);
                  }
      ...
      {
         return this.testLocalPointHitAgainstAlpha(param1,param2,var_490);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return this.testLocalPointHitAgainstAlpha(_loc3_,param2,var_490);
      }
         ...
         if(this.var_178 && var_490 > 0)
         {
            if(!testParamFlag(WindowParam.const_34))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(const_1026,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(const_1026,param3,param1)) : false;
            }
         }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_141,WindowParam.const_193);
         var _loc2_:* = !testParamFlag(WindowParam.const_159,WindowParam.const_190);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               _loc4_ = this._parent.width - this.var_354.width;
               _loc5_ = uint(var_21 & 0);
               if(_loc5_ == WindowParam.const_399)
               {
                  _loc3_.width += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_445)
               {
                  _loc3_.x += _loc4_;
               }
            ...
            if(_loc2_)
            {
               _loc4_ = this._parent.height - this.var_354.height;
               _loc5_ = uint(var_21 & 0);
               if(_loc5_ == WindowParam.const_313)
               {
                  _loc3_.height += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_252)
               {
                  _loc3_.y += _loc4_;
               }
      ...
      {
         if(_state == WindowState.const_598)
         {
            return true;
         }
         _state = WindowState.const_598;
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1799,this,null);
         ...
         _loc1_.recycle();
         _loc1_ = WindowEvent.allocate(WindowEvent.const_312,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         this.dispose();
         return true;
      ...
      public function minimize() : Boolean
      {
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1746,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function maximize() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1679,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_74,true);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1846,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      {
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1777,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1837,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      {
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1822,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_615,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function deactivate() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1775,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1681,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_74,true);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1847,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1738,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_74,false);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1694,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function enable() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_891,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_246,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function disable() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_851,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_264,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function focus() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1724,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_329,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function unfocus() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1797,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1848,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1153 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         var _loc3_:WindowEvent = WindowEvent.allocate(WindowEvent.const_344,this,param1);
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1153 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         var _loc4_:WindowEvent = WindowEvent.allocate(WindowEvent.const_344,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         var _loc4_:WindowEvent = WindowEvent.allocate(WindowEvent.const_385,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
