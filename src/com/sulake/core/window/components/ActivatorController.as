package com.sulake.core.window.components
{
   ...
   public class ActivatorController extends ContainerController
   {
      ...
      {
         if(param2.type == WindowEvent.const_366)
         {
            this.setActiveChild(param1 as IWindow);
         }
         else if(param2.type == WindowEvent.const_1272)
         {
            return true;
         }
      ...
      public function setActiveChild(param1:IWindow) : IWindow
      {
         ...
         var _loc2_:IWindow = this.var_895;
         if(this.var_895 != param1)
         {
            if(this.var_895 != null)
            {
               if(!this.var_895.disposed)
               {
                  this.var_895.deactivate();
               }
            }
            this.var_895 = param1;
