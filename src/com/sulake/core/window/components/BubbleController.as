package com.sulake.core.window.components
{
   ...
   public class BubbleController extends FrameController implements IBubbleWindow
   {
      ...
      private static const const_2030:String = "_POINTER_UP";
      
      private static const const_2028:String = "_POINTER_DOWN";
      
      private static const const_2027:String = "_POINTER_LEFT";
      
      private static const const_2029:String = "_POINTER_RIGHT";
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_892,this._direction,PropertyStruct.const_52,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1903);
         }
         return _loc1_;
      }
