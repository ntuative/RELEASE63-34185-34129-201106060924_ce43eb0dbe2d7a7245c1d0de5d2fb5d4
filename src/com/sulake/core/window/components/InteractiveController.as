package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_559)
         {
            if(param2.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
            {
               param1.context.getWindowServices().getToolTipAgentService().begin(param1);
            }
            else if(param2.type != WindowMouseEvent.const_230)
            {
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_559)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_964,param1.toolTipCaption,PropertyStruct.const_52,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1942);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_1332)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_727,param1.toolTipDelay,PropertyStruct.const_301,true));
         }
         else
         {
      ...
      {
         this.var_1397 = param1 == null ? "null" : param1;
      }
      ...
      public function setMouseCursorForState(param1:uint, param2:uint) : uint
      {
         ...
         if(param2 == MouseCursorType.const_32 || param2 == -1)
         {
