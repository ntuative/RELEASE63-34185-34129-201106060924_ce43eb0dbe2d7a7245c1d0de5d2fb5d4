package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_718:Number;
      
      protected var var_720:Number;
      
      protected var var_116:Number;
      
      protected var var_102:Number;
      
      protected var _container:IWindowContainer;
      
      protected var var_2186:Boolean = false;
      ...
      protected var var_719:Number = -1.0;
      
      protected var var_721:Number = -1.0;
      ...
      protected var var_2187:int = 0;
      
      protected var var_2188:int = 0;
      
      protected var var_1380:Number;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_116 = 0;
         this.var_102 = 0;
         this._horizontal = param2 == WindowType.const_439;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_178 = var_489 || !testParamFlag(WindowParam.const_34);
         this._container = _context.create("_CONTAINER","",WindowType.const_449,WindowStyle.const_131,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         this._container.addEventListener(WindowEvent.const_41,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_385,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_124,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_220,this.containerEventHandler);
         this._container.clipping = clipping;
         this.resizeOnItemUpdate = this.var_1378;
      }
      ...
      {
         return Math.max(0,this.var_116 - width);
      }
      ...
      {
         return new Rectangle(this.var_718 * this.maxScrollH,this.var_720 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            this.var_718 = param1;
            this._container.x = -this.var_718 * this.maxScrollH;
            _context.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_62);
            _loc2_ = WindowEvent.allocate(WindowEvent.const_637,this,null);
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         if(param1 != this.var_720)
         {
            this.var_720 = param1;
            this._container.y = -this.var_720 * this.maxScrollV;
            _loc2_ = WindowEvent.allocate(WindowEvent.const_637,this,null);
            _events.dispatchEvent(_loc2_);
            _loc2_.recycle();
         }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            ...
            {
               this._container.setParamFlag(WindowParam.const_631,param1);
            }
         }
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_385,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_124,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_220,this.containerEventHandler);
            super.dispose();
         }
      }
      ...
      public function addListItem(param1:IWindow) : IWindow
      {
         ...
         if(this._horizontal)
         {
            param1.x = this.var_116 + (this.numListItems > 0 ? this._spacing : 0);
            this.var_116 = param1.rectangle.right;
            this._container.width = this.var_116;
         }
         else
         {
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_230:
               if(this.var_1377)
               {
                  this.var_1380 = this.var_2187 - _loc3_;
                  this.var_1379 = this.var_2188 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1380 != 0 && this.var_116 != 0)
                     {
                        this.scrollH += this.var_1380 / this.var_116;
                     }
                  }
                  else if(this.var_1379 != 0 && this.var_102 != 0)
                  {
                     this.scrollV += this.var_1379 / this.var_102;
                  }
                  this.var_2187 = _loc3_;
                  this.var_2188 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_226:
               if(this.var_1377)
               {
                  if(this._horizontal)
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1380,0);
                  }
                  else
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1379);
                  }
                  this.var_1377 = false;
                  _loc2_ = true;
               }
      ...
      private function scrollAnimationCallback(param1:int, param2:int) : void
      {
         if(!disposed)
         {
            this.scrollH -= param1 / this.var_116;
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_1109 && !this.var_584 && this._container)
         {
            this.var_584 = true;
            ...
            if(this._horizontal)
            {
               ...
               while(_loc4_ < _loc1_)
               {
                  ...
                  if(_loc2_.visible)
                  {
                     _loc2_.x = this.var_116;
                     this.var_116 += _loc2_.width + this._spacing;
                     if(this.var_491)
                     {
               ...
               if(_loc1_ > 0)
               {
                  this.var_116 -= this._spacing;
               }
            }
            else
            {
               this.var_116 = var_11.width;
               this.var_102 = 0;
               _loc4_ = 0;
               while(_loc4_ < _loc1_)
               {
                  ...
                  if(_loc2_.visible)
                  {
                     ...
                     if(this.var_491)
                     {
                        ...
                        this.var_116 = _loc3_ > this.var_116 ? Number(_loc3_) : Number(this.var_116);
                     }
                  }
                  _loc4_++;
               }
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_448,this._spacing,PropertyStruct.const_40,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1209);
         }
         if(this.var_1109 != PropertyDefaults.const_1359)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_730,this.var_1109,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1841);
         }
         if(this.var_491 != PropertyDefaults.const_1311)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_746,this.var_491,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1702);
         }
         if(this.var_1378 != PropertyDefaults.const_1192)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_707,this.var_1378,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1888);
         }
         if(this.var_719 != PropertyDefaults.const_1155)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_845,this.var_719,PropertyStruct.const_129,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1851);
         }
         if(this.var_721 != PropertyDefaults.const_1363)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_793,this.var_721,PropertyStruct.const_129,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1696);
         }
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_746:
                  ...
                  break;
               case PropertyDefaults.const_707:
                  this.resizeOnItemUpdate = _loc2_.value as Boolean;
                  break;
               case PropertyDefaults.const_730:
                  this.var_1109 = _loc2_.value as Boolean;
                  break;
               case PropertyDefaults.const_845:
                  this.var_719 = _loc2_.value as Number;
                  break;
               case PropertyDefaults.const_793:
                  this.var_721 = _loc2_.value as Number;
                  break;
            }
         }
