package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1184:IItemListWindow;
      
      private var var_438:IScrollbarWindow;
      
      private var var_1791:Boolean = true;
      ...
      override public function dispose() : void
      {
         if(this.var_438)
         {
            this.var_438.removeEventListener(WindowEvent.const_246,this.scrollBarEventProc);
            this.var_438.removeEventListener(WindowEvent.const_264,this.scrollBarEventProc);
            this.var_438 = null;
         }
         if(this.var_1184)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1184)
         {
            this.var_1184 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_438)
         {
            this.var_438 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_438)
            {
               this.var_438.addEventListener(WindowEvent.const_246,this.scrollBarEventProc);
               this.var_438.addEventListener(WindowEvent.const_264,this.scrollBarEventProc);
            }
         }
         return this.var_438;
      }
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_264)
         {
            this.hideScrollBar();
         }
      }
