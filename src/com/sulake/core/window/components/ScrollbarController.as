package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1587:String = "increment";
      
      private static const const_1586:String = "decrement";
      
      private static const const_1106:String = "slider_track";
      
      private static const const_687:String = "slider_bar";
       
      
      protected var _offset:Number = 0;
      
      protected var var_725:Number = 0.1;
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_178 = false;
         this.var_19 = param12;
         this._horizontal = param2 == WindowType.const_610;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         ...
         {
            this.var_19.removeEventListener(WindowEvent.const_41,this.onScrollableResized);
            this.var_19.removeEventListener(WindowEvent.const_637,this.onScrollableScrolled);
         }
         this.var_19 = param1;
         if(this.var_19 != null && !this.var_19.disposed)
         {
            this.var_19.addEventListener(WindowEvent.const_41,this.onScrollableResized);
            this.var_19.addEventListener(WindowEvent.const_637,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         else if(this.var_1055 != null)
         {
            _loc2_ = this.var_1055;
         }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_1055 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      {
         return findChildByName(const_1106) as WindowController;
      }
      
      protected function get lift() : WindowController
      {
         return this.track.findChildByName(const_687) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_687:
               if(param2.type == WindowEvent.const_220)
               {
                  if(!this.var_1297)
                  {
                     if(this._horizontal)
         ...
         if(param2.type == WindowEvent.const_512)
         {
            if(this.var_19 == null)
            {
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_316)
            {
               if(WindowMouseEvent(param2).delta > 0)
               {
                  if(this._horizontal)
                  {
                     this.scrollH -= this.var_725;
                  }
                  else
                  {
                     this.scrollV -= this.var_725;
                  }
               }
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_44 || param1.type == WindowTouchEvent.const_804)
         {
            ...
            else if(param2.name == const_1586)
            {
               if(this.var_19)
               {
                  this.var_1297 = true;
            ...
            else if(param2.name == const_1106)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_687).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
         ...
         if(param1.type == WindowMouseEvent.const_316)
         {
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_1055) as IScrollableWindow;
            if(_loc1_ == null && _parent is IWindowContainer)
            {
               _loc1_ = IWindowContainer(_parent).findChildByName(this.var_1055) as IScrollableWindow;
               if(_loc1_)
               {
