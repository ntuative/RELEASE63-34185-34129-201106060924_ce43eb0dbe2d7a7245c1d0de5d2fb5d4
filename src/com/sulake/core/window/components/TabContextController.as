package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1608:String = "_SELECTOR";
      
      private static const const_1607:String = "_CONTENT";
       
      
      protected var var_1116:ITabSelectorWindow;
      
      protected var var_2210:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1116 = findChildByTag(const_1608) as ITabSelectorWindow;
            if(this.var_1116 != null)
            {
               this.var_1116.procedure = this.selectorEventProc;
            }
         }
      ...
      {
         if(this.var_2210 == null)
         {
            this.var_2210 = findChildByTag(const_1607) as IWindowContainer;
         }
      ...
      {
         return !!this.var_754 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_1116.numSelectables;
      }
