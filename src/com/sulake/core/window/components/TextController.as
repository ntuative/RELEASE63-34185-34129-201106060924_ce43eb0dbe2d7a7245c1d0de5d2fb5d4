package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1379:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_904:Number;
      
      protected var var_589:Number;
      
      protected var var_588:Boolean;
      
      protected var var_40:TextMargins;
      
      protected var _autoSize:String = "none";
      
      protected var var_136:Boolean = false;
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_471,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_471 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_471,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_198);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_801 ? true : null;
         }
      ...
      {
         this.var_904 = param1;
         this._field.scrollH = this.var_904 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_904 * this.maxScrollH,this.var_589 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_706,this._field.antiAliasType,PropertyStruct.const_52,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1221));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1145 ? new PropertyStruct(PropertyDefaults.const_940,this._autoSize,PropertyStruct.const_52,true,PropertyDefaults.const_1214) : PropertyDefaults.const_1868);
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_301,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1211 ? new PropertyStruct(PropertyDefaults.const_1135,this._field.gridFitType,PropertyStruct.const_52,true,PropertyDefaults.const_1313) : PropertyDefaults.const_1883);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_887) ? new PropertyStruct(PropertyDefaults.const_386,this._field.textColor,PropertyStruct.const_164,true) : PropertyDefaults.const_1226);
         ...
         _loc1_.push(this.var_40.left != PropertyDefaults.const_894 ? new PropertyStruct(PropertyDefaults.const_275,this.var_40.left,PropertyStruct.const_40,true) : PropertyDefaults.const_832);
         _loc1_.push(this.var_40.top != PropertyDefaults.const_835 ? new PropertyStruct(PropertyDefaults.const_270,this.var_40.top,PropertyStruct.const_40,true) : PropertyDefaults.const_844);
         _loc1_.push(this.var_40.right != PropertyDefaults.const_821 ? new PropertyStruct(PropertyDefaults.const_303,this.var_40.right,PropertyStruct.const_40,true) : PropertyDefaults.const_954);
         _loc1_.push(this.var_40.bottom != PropertyDefaults.const_864 ? new PropertyStruct(PropertyDefaults.const_256,this.var_40.bottom,PropertyStruct.const_40,true) : PropertyDefaults.const_916);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1225 ? new PropertyStruct(PropertyDefaults.const_709,this._field.mouseWheelEnabled,PropertyStruct.const_38,true) : PropertyDefaults.const_1728);
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_129,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_129,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_129,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
