package com.sulake.core.window.events
{
   ...
   public class WindowKeyboardEvent extends WindowEvent
   {
      ...
      public static const const_365:String = "WKE_KEY_UP";
      
      public static const const_217:String = "WKE_KEY_DOWN";
      ...
      public static function allocate(param1:String, param2:Event, param3:IWindow, param4:IWindow, param5:Boolean = false) : WindowKeyboardEvent
      {
         ...
         _loc6_.var_715 = param4;
         _loc6_.var_494 = false;
         _loc6_.var_488 = param5;
         _loc6_.var_714 = POOL;
         return _loc6_;
      }
      ...
      {
         return "WindowKeyboardEvent { type: " + _type + " cancelable: " + var_488 + " window: " + _window + " charCode: " + this.charCode + " }";
      }
   }
}
