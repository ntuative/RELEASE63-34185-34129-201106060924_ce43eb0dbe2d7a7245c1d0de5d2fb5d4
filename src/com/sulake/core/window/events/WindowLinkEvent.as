package com.sulake.core.window.events
{
   ...
   public class WindowLinkEvent extends WindowEvent
   {
      ...
      public static const const_1932:String = "WE_LINK";
      ...
      public static function allocate(param1:String, param2:IWindow, param3:IWindow) : WindowEvent
      {
         ...
         _loc4_.var_2142 = param1;
         _loc4_._window = param2;
         _loc4_.var_715 = param3;
         _loc4_.var_494 = false;
         _loc4_.var_714 = POOL;
         return _loc4_;
      }
      ...
      {
         return allocate(this.var_2142,window,related);
      }
      
      override public function toString() : String
      {
         return "WindowLinkEvent { type: " + _type + " link: " + this.link + " cancelable: " + var_488 + " window: " + _window + " }";
      }
   }
}
