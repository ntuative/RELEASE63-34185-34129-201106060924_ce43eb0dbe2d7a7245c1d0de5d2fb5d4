package com.sulake.core.window.events
{
   ...
   public class WindowMouseEvent extends WindowEvent
   {
      ...
      public static const const_2095:String = "WME_MIDDLE_CLICK";
      
      public static const const_2094:String = "WME_MIDDLE_DOWN";
      
      public static const const_2180:String = "WME_MIDDLE_UP";
      
      public static const const_230:String = "WME_MOVE";
      ...
      public static const const_226:String = "WME_UP_OUTSIDE";
      
      public static const const_316:String = "WME_WHEEL";
      
      public static const const_2034:String = "WME_RIGHT_CLICK";
      
      public static const const_2154:String = "WME_RIGHT_DOWN";
      
      public static const const_2201:String = "WME_RIGHT_UP";
      
      public static const const_1789:String = "WME_ROLL_OUT";
      
      public static const const_1934:String = "WME_ROLL_OVER";
      
      public static const const_2207:String = "WME_HOVERING";
      ...
      public static function allocate(param1:String, param2:IWindow, param3:IWindow, param4:Number, param5:Number, param6:Number, param7:Number, param8:Boolean, param9:Boolean, param10:Boolean, param11:Boolean, param12:int) : WindowMouseEvent
      {
         ...
         _loc13_.var_715 = param3;
         _loc13_.var_494 = false;
         _loc13_.var_714 = POOL;
      ...
      {
         return "WindowMouseEvent { type: " + _type + " cancelable: " + var_488 + " window: " + _window + " localX: " + this.localX + " localY: " + this.localY + " }";
      }
   }
}
