package com.sulake.core.window.events
{
   ...
   public class WindowTouchEvent extends WindowEvent
   {
      ...
      public static const const_729:String = "WTE_BEGIN";
      
      public static const const_1160:String = "WTE_END";
      
      public static const const_2235:String = "WTE_MOVE";
      
      public static const const_2234:String = "WTE_OUT";
      
      public static const const_2143:String = "WTE_OVER";
      
      public static const const_2142:String = "WTE_ROLL_OUT";
      
      public static const const_2236:String = "WTE_ROLL_OVER";
      
      public static const const_804:String = "WTE_TAP";
      ...
      public static function allocate(param1:String, param2:IWindow, param3:IWindow, param4:Number, param5:Number, param6:Number, param7:Number, param8:Number, param9:Number, param10:Number, param11:Boolean, param12:Boolean, param13:Boolean) : WindowTouchEvent
      {
         ...
         _loc14_.var_715 = param3;
         _loc14_.var_494 = false;
         _loc14_.var_714 = POOL;
      ...
      {
         return "WindowTouchEvent { type: " + _type + " cancelable: " + var_488 + " window: " + _window + " localX: " + this.localX + " localY: " + this.localY + " }";
      }
   }
}
