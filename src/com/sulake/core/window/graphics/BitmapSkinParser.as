package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      public static const const_103:String = "BadgePointLimitsEvent";
      
      public static const const_93:String = "active";
      
      public static const const_92:String = "focused";
      
      public static const const_91:String = "hovering";
      
      public static const const_58:String = "selected";
      
      public static const const_94:String = "pressed";
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_338 = SkinLayoutEntity.const_557;
                  break;
               case "move":
                  _loc5_.var_338 = SkinLayoutEntity.const_368;
                  break;
               case "strech":
                  _loc5_.var_338 = SkinLayoutEntity.const_508;
                  break;
               case "tiled":
                  _loc5_.var_338 = SkinLayoutEntity.const_325;
                  break;
               case "center":
                  _loc5_.var_338 = SkinLayoutEntity.const_519;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_339 = SkinLayoutEntity.const_557;
                  break;
               case "move":
                  _loc5_.var_339 = SkinLayoutEntity.const_368;
                  break;
               case "strech":
                  _loc5_.var_339 = SkinLayoutEntity.const_508;
                  break;
               case "tiled":
                  _loc5_.var_339 = SkinLayoutEntity.const_325;
                  break;
               case "center":
                  _loc5_.var_339 = SkinLayoutEntity.const_519;
            }
         }
