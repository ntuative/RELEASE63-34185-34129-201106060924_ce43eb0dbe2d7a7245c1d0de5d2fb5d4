package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1864:uint = 0;
      
      public static const const_819:uint = 1;
      
      public static const const_1148:uint = 2;
      
      public static const const_884:uint = 4;
      
      public static const const_1759:uint = 8;
      
      public static const const_1750:uint = 16;
      
      public static const const_2086:uint = 64;
      
      public static const const_2103:uint = 128;
      
      public static const const_1315:uint = 256;
      
      protected static var var_592:uint = 0;
      
      protected static var var_346:uint = 0;
       
      
      protected var var_224:DisplayObjectContainer;
      
      protected var var_2206:Boolean;
      
      protected var var_901:Boolean;
         ...
         if(this.var_901)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_346 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2206,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2206,16777215);
                  }
                  var_346 += bitmap.width * bitmap.height * 4;
               }
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(this.var_901)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_346 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         if(this.var_224 == null)
         {
            ...
            this.var_224.name = this.name + " - Child Container";
      ...
      {
         return this.var_224 != null ? int(this.var_224.numChildren) : 0;
      }
