package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1095:uint = 8;
      
      private static const const_1565:String = "skin";
      
      private static const const_1562:String = "bitmap";
      
      private static const const_1561:String = "fill";
      
      private static const const_1566:String = "text";
      
      private static const const_1564:String = "label";
      
      private static const const_1563:String = "shape";
      ...
      private var var_1043:Dictionary;
      ...
      private var var_2712:Dictionary;
      
      private var var_2711:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_1043 = new Dictionary();
         this.var_1044 = new Dictionary();
         this.var_1966 = new Dictionary();
         this.var_2710 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1966,this.var_2710);
         this.var_2712 = new Dictionary();
         this.var_2711 = new Dictionary();
         StateCodeTable.fillTables(this.var_2712,this.var_2711);
         this.var_462 = new Dictionary();
         this.var_462[const_1565] = BitmapSkinRenderer;
         this.var_462[const_1562] = BitmapDataRenderer;
         this.var_462[const_1561] = FillSkinRenderer;
         this.var_462[const_1566] = TextSkinRenderer;
         this.var_462[const_1564] = LabelRenderer;
         this.var_462[const_1563] = ShapeSkinRenderer;
         this.var_462[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_462[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_347 == null)
         {
            var_347 = new Array();
            var_347.push(WindowState.const_74);
            var_347.push(WindowState.const_89);
            var_347.push(WindowState.const_94);
            var_347.push(WindowState.const_58);
            var_347.push(WindowState.const_91);
            var_347.push(WindowState.const_92);
            var_347.push(WindowState.const_93);
            var_347.push(WindowState.const_103);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2969 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_1966[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         ...
         {
            this.var_1043[param1] = new Array(const_1095);
         }
         this.var_1043[param1][param2] = param3;
         if(this.var_1044[param1] == null)
         {
            this.var_1044[param1] = new Array(const_1095);
         }
         this.var_1044[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_1043[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_131)
            {
               _loc4_ = _loc3_["null"];
            }
         }
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_1044[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_131)
