package com.sulake.core.window.services
{
   ...
   public class GestureAgentService implements IGestureAgentService, IDisposable
   {
      ...
      protected var var_1527:uint = 0;
      
      protected var var_292:Function;
      
      protected var var_1393:int;
      
      protected var var_1392:int;
      ...
      public function begin(param1:IWindow, param2:Function, param3:uint, param4:int, param5:int) : IWindow
      {
         ...
         if(param1 && !param1.disposed)
         {
            ...
            this.var_1392 = param5;
            this.var_216 = new Timer(40,0);
            this.var_216.addEventListener(TimerEvent.TIMER,this.operate);
            this.var_216.start();
         }
         return _loc6_;
      }
      ...
      protected function operate(param1:TimerEvent) : void
      {
         this.var_1393 *= 0.75;
         this.var_1392 *= 0.75;
         if(Math.abs(this.var_1393) <= 1 && Math.abs(this.var_1392) <= 1)
         {
            this.end(this._window);
         }
         else if(this.var_292 != null)
         {
            this.var_292(this.var_1393,this.var_1392);
         }
      }
      ...
      public function end(param1:IWindow) : IWindow
      {
         ...
         {
            this.var_216.stop();
            this.var_216.removeEventListener(TimerEvent.TIMER,this.operate);
            this.var_216 = null;
         }
         if(this._working)
         {
