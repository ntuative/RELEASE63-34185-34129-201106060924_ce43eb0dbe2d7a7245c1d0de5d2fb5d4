package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1594:Class = ProfilerOutput_profiler_dialog_xml;
      
      private static var var_1595:Class = ProfilerOutput_profiler_task_xml;
       
      
      private var _disposed:Boolean = false;
      
      private var var_170:IProfiler;
      
      private var var_24:ICore;
      
      private var _window:IFrameWindow;
      
      private var var_3019:Array;
      ...
      public function ProfilerOutput(param1:IContext, param2:ICoreWindowManager, param3:IWindowRenderer)
      {
         ...
         this.var_3019 = new Array();
         this.var_170 = this.profiler;
         this._windowManager = param2;
         this.var_947 = param3;
         var _loc4_:ByteArray = new var_1594() as ByteArray;
      ...
      public function set profiler(param1:IProfiler) : void
      {
         if(this.var_170)
         {
            this.var_170.removeStopEventListener(this.refresh);
            this.var_170 = null;
         }
         if(!this.var_170 && param1)
         {
            this.var_170 = param1;
            this.var_170.addStopEventListener(this.refresh);
         }
      }
      ...
      private function profilerWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param2.name == "footer_enable_toggle")
         {
            ...
            else if(param1.type == WindowEvent.const_496)
            {
               this.var_2004 = false;
               ILabelWindow(this._window.findChildByName("footer")).textColor = 4284900966;
            }
      ...
      {
         var _loc2_:Array = this.var_170.getProfilerAgentsInArray();
         ...
         if(this.var_2004)
         {
            this._window.findChildByName("footer").caption = "Assets - Libraries: " + this.var_170.numAssetLibraryInstances + " " + "Bitmaps: " + this.var_170.numBitmapAssetInstances + " / " + this.var_170.numAllocatedBitmapDataBytes + " bytes \n" + "Windows - Allocated bitmap data: " + (this.var_947.allocatedByteCount + GraphicContext.allocatedByteCount) + " bytes \n" + "Tracked bitmap data: " + this.var_170.numTrackedBitmapDataInstances + " / " + this.var_170.numTrackedBitmapDataBytes + " bytes";
         }
      }
      ...
      {
         var _loc2_:ByteArray = new var_1595() as ByteArray;
