package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_198:String = "regular";
      
      public static const ITALIC:String = "italic";
      
      public static const BOLD:String = "bold";
      
      private static var var_93:Map;
      
      private static var var_560:Array;
      
      private static var _eventDispatcher:IEventDispatcher;
      
      private static const const_690:String = "{";
      
      private static const const_691:String = "}";
      
      private static const const_1598:String = "/*";
      
      private static const const_1597:String = "*/";
      ...
      {
         return var_93.getWithIndex(param1);
      }
      
      public static function setStyle(param1:String, param2:TextStyle) : void
      {
         var _loc3_:* = var_93.getKeys().indexOf(param1) == -1;
         param2.name = param1;
         var_93[param1] = param2;
         if(_loc3_)
         {
            var_560.push(param1);
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_93[const_198],var_93[ITALIC],var_93[BOLD]];
            var_93.reset();
            var_93[const_198] = _loc5_[0];
            var_93[ITALIC] = _loc5_[1];
            var_93[BOLD] = _loc5_[2];
         }
         var _loc3_:int = 0;
         for each(_loc4_ in param1)
         {
            var_93[_loc4_.name] = _loc4_;
            if(var_560.indexOf(_loc4_.name) == -1)
            {
               var_560.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
         if(var_93.length != _loc3_)
         {
            _eventDispatcher.dispatchEvent(new Event(Event.ADDED));
         }
      }
      ...
      public static function enumerateStyles() : Array
      {
         ...
         while(_loc3_ < _loc2_)
         {
            _loc1_.push(var_93.getWithIndex(_loc3_));
            _loc3_++;
         }
         return _loc1_;
      }
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_691);
         if(countSubStrings(param1,const_690) != countSubStrings(param1,const_691))
         {
            throw new Error("Mismatching amount of \"" + const_690 + "\" versus \"" + const_691 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1598) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1597) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_690)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
