package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_2057:String = "_INCLUDE";
      
      public static const const_2055:String = "_TEMP";
      
      private static const const_1540:String = "layout";
      
      private static const const_1086:String = "window";
      
      private static const const_1087:String = "variables";
      
      private static const const_1088:String = "filters";
      
      private static const const_660:String = "name";
      
      private static const const_1542:String = "style";
      
      private static const const_677:String = "params";
      
      private static const const_1541:String = "tags";
      ...
      private static const const_1537:String = "visible";
      
      private static const const_1530:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_5:String = "background";
      
      private static const const_1304:String = "blend";
      
      private static const const_1532:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1531:String = "treshold";
      
      private static const const_1534:String = "children";
      
      private static const const_1535:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1539:String = "height_min";
      
      private static const const_1533:String = "height_max";
      
      private static const const_678:String = "true";
      
      private static const const_192:String = "0";
      
      private static const const_1536:String = "$";
      
      private static const const_1544:String = ",";
      
      private static const const_51:String = "";
      
      private static const const_1538:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1543:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1387:Dictionary;
      
      protected var var_1388:Dictionary;
      
      protected var var_1114:Dictionary;
      
      protected var var_1665:Dictionary;
      
      protected var var_2208:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         this.var_1388 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1387,this.var_1388);
         this.var_1114 = new Dictionary();
         this.var_1665 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1114,this.var_1665);
         this.var_2208 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1543,const_51);
         return param1.replace(const_1538,const_51);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1387)
            {
               delete this.var_1387[_loc1_];
            }
            for(_loc1_ in this.var_1388)
            {
               delete this.var_1388[_loc1_];
            }
            for(_loc1_ in this.var_1114)
            {
               delete this.var_1114[_loc1_];
            }
            for(_loc1_ in this.var_1665)
            {
               delete this.var_1665[_loc1_];
            }
            this.var_2208.dispose();
            this.var_2208 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1540)
         {
            _loc8_ = param1.child(const_1087);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_1088).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
            ...
            _loc4_ = param1.child(const_1086);
         ...
         if(param1.localName() == const_1086)
         {
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1387[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_660,variables,"")));
         style = uint(this.parseAttribute(xml,const_1542,variables,style));
         params = uint(this.parseAttribute(xml,const_677,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1541,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_192));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_192));
         rect.width = Number(this.parseAttribute(xml,name_5,variables,const_192));
         rect.height = Number(this.parseAttribute(xml,name_1,variables,const_192));
         visible = this.parseAttribute(xml,const_1537,variables,visible.toString()) == const_678;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_677).length() > 0)
         {
            list = xml.child(const_677).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               node = list[i];
               param = this.parseAttribute(node,const_660,variables,"") as String;
               if(this.var_1114[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_660)) + "\"!");
               }
               params |= this.var_1114[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_51) : const_51;
         caption = unescape(String(this.parseAttribute(xml,const_1530,variables,caption)));
         if(tag != const_51)
         {
            tags = tag.split(const_1544);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_1087)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1535,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1539,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1533,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_5,variables,window.background.toString()) == const_678;
         blend = Number(this.parseAttribute(xml,const_1304,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1532,variables,window.clipping.toString()) == const_678;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1531,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_1088).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
            ...
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  if(window.x != rect.x || window.y != rect.y || window.width != rect.width || window.height != rect.height)
                  {
                     ...
                     if((params & 0) == WindowParam.const_227)
                     {
                        window.y = rect.y;
                     }
                  }
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_51;
         var _loc3_:String = this.var_1388[param1.type];
