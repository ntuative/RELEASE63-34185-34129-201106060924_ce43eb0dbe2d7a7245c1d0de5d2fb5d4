package com.sulake.core.window.utils
{
   ...
   public class WindowRectLimits implements IRectLimiter
   {
      ...
      {
         this.var_329 = param1;
         if(this.var_329 < int.MAX_VALUE && !this._target.disposed && this._target.height > this.var_329)
         {
            this._target.height = this.var_329;
         }
      }
      
      public function get isEmpty() : Boolean
      {
         return this.var_326 == int.MIN_VALUE && this.var_327 == int.MAX_VALUE && this.var_328 == int.MIN_VALUE && this.var_329 == int.MAX_VALUE;
      }
      ...
      public function limit() : void
      {
         if(!this.isEmpty && this._target)
         {
            ...
            else if(this._target.height > this.var_329)
            {
               this._target.height = this.var_329;
            }
         }
