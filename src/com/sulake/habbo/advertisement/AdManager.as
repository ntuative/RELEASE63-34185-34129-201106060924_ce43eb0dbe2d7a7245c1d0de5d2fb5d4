package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1338:BitmapData = null;
      
      private var var_1336:BitmapData = null;
      ...
      public function AdManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         events.addEventListener(AdImageEvent.const_188,this.onLoadAdImage);
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2848 = this._config.getKey("interstitial.enabled","false") == "true";
         this.var_2849 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2847 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_2071 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_245 != null && this.var_245.running)
         {
            this.var_245.reset();
            return false;
         }
         if(this.var_1337 == 0)
         {
            this.var_1337 = getTimer();
            return false;
         }
         if(this.var_2071 > 0 && this.var_2070 >= this.var_2071)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1337;
         if(_loc1_ > this.var_2849)
         {
            ++this.var_2070;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1626 = _loc2_.imageUrl;
         this.var_2846 = _loc2_.clickUrl;
         this.var_1337 = getTimer();
         if(this.var_1626 != "")
         {
            _loc3_ = this.var_1626;
            ...
            {
               this.var_245 = new Timer(this.var_2847,1);
               this.var_245.addEventListener(TimerEvent.TIMER_COMPLETE,this.interstitialTimerComplete);
            }
            if(this.var_245.running)
            {
               this.var_245.reset();
            }
            this.var_245.start();
            _loc4_ = new URLRequest(this.var_1626);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_640,0,0,param1.bitmapData,this.var_2846));
            this.var_1337 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_513));
         }
      }
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1627 = _loc2_.imageUrl;
         this.var_2072 = _loc2_.clickUrl;
         if(this.var_1627 != "" && this.var_2072 != "")
         {
            _loc3_ = this.var_1627;
            if(assets.hasAsset(_loc3_))
            {
               assets.removeAsset(assets.getAssetByName(_loc3_));
            }
            _loc4_ = new URLRequest(this.var_1627);
            _loc5_ = assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_623,0,0,_loc4_,_loc2_.assetName,this.var_2072,this.var_1338,this.var_1336));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1338 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1336 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function loadRoomAdImage(param1:int, param2:int, param3:String, param4:String) : void
      {
         if(events != null)
         {
            events.dispatchEvent(new AdImageEvent(AdImageEvent.const_188,param3,param4,param1,param2));
         }
      }
      ...
      private function loadImageAsset(param1:AdImageEvent) : void
      {
         ...
         var _loc3_:Array = this.var_697.getValue(_loc2_);
         if(_loc3_ == null)
         {
            _loc3_ = new Array();
            this.var_697.add(_loc2_,_loc3_);
         }
         if(_loc3_.length > 0)
         {
         ...
         _loc5_.addEventListener(AssetLoaderEvent.const_43,this.onBillboardImageLoadError);
      }
      ...
      private function onBillboardImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc2_:AssetLoaderStruct = param1.target as AssetLoaderStruct;
         var _loc3_:Bitmap = _loc2_.assetLoader.content as Bitmap;
         var _loc4_:Array = this.var_697.remove(_loc2_.assetName);
      ...
      private function dispatchImageAsset(param1:BitmapData, param2:AdImageEvent) : void
      {
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_920,param2.roomId,0,param1.clone(),param2.imageUrl,param2.clickUrl,null,null,param2.objectId));
         }
      }
      ...
      private function onBillboardImageLoadError(param1:AssetLoaderEvent) : void
      {
         var _loc4_:* = null;
         var _loc2_:AssetLoaderStruct = param1.target as AssetLoaderStruct;
         var _loc3_:Array = this.var_697.remove(_loc2_.assetName);
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_787,_loc4_.roomId,0,null,_loc4_.imageUrl,_loc4_.clickUrl,null,null,_loc4_.objectId));
         }
      }
   }
}
