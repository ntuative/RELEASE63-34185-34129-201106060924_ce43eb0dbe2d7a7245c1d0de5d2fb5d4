package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1374:IWindowContainer;
      
      public static var var_1657:IWindowContainer;
      
      public static var var_2156:int = 6710886;
      ...
      private var var_400:ITabSelectorWindow;
      
      private var _catalog:IHabboCatalog;
      
      private var var_556:IFrameWindow;
      
      private var var_463:Timer;
      
      private var var_2750:Number = 0;
      
      private var var_2749:Boolean = true;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1294 = [];
         this.var_1521 = [AvatarEditorFigureCategory.const_774,AvatarEditorFigureCategory.const_53,AvatarEditorFigureCategory.const_266,AvatarEditorFigureCategory.const_913,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_111];
         super();
         ...
         if(var_1374 == null)
         {
            ...
            var_1374 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1657 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1657 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_463 = new Timer(1000);
         this.var_463.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1521;
         }
         for each(_loc6_ in param4)
         {
            this.var_1294.push(_loc6_);
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_463.stop();
            this.var_463.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_463 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1521);
         }
         if(param1.length != this.var_1294.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1294.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2749 = this.canChangeOutfit();
            this.var_463.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_400 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_400.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_400.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1294.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_400.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_400.numSelectables)
               {
                  this.var_400.getSelectableAt(_loc6_).x = this.var_400.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
         }
         this.var_400.setSelected(this.var_400.getSelectableAt(0));
         this.attachImages();
         this.update();
      }
      ...
      private function attachImages() : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc1_:Array = this.var_1521;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_37) && (this.var_1989 == AvatarEditorSideCategory.const_111 || this.var_2751))
         {
         ...
         this.setViewToCategory(this.var_364);
      }
      ...
      {
         if(this.var_1989 == AvatarEditorSideCategory.const_111)
         {
            this.var_2751 = false;
            this.setSideContent(AvatarEditorSideCategory.const_873);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_873:
               break;
            case AvatarEditorSideCategory.const_522:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_522);
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_364 = param1;
         this.var_400.setSelected(this.var_400.getSelectableByName(param1));
      }
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "save":
                  ...
                  this.var_2750 = new Date().valueOf();
                  this.var_2749 = false;
                  this.var_463.start();
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_556)
         {
            ...
            this.var_556 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_556.procedure = this.stripClubDialogEventProc;
            this.var_556.center();
         }
         else
         {
      ...
      private function canChangeOutfit() : Boolean
      {
         ...
         return _loc1_ - this.var_2750 > 5000;
      }
   }
}
