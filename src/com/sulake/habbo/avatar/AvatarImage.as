package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      protected var var_778:Array;
      
      protected var _assets:AssetAliasCollection;
      
      protected var var_269:AvatarImageCache;
      
      protected var var_611:AvatarFigureContainer;
      
      protected var var_586:IAvatarDataContainer;
      
      protected var var_344:Array;
      ...
      private var var_2621:String = null;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_53 || param1 == AvatarSetType.const_42)
         {
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_273.length == 1 && this.var_95 == this.var_1863)
         {
            return this.var_95 + this.var_538 + this.var_659 % 4;
         }
         if(this.var_273.length == 2)
         {
            for each(_loc1_ in this.var_273)
            {
               ...
               {
                  return this.var_95 + this.var_538 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_659 % 11;
                  return this.var_95 + "_" + this.var_1863 + this.var_538 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2623 || param2 != this.var_2622 || param1 != this.var_2621)
         {
            this.var_2623 = param3;
            this.var_2622 = param2;
            this.var_2621 = param1;
            this.var_1903 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc5_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_295.definition.geometryType);
         if(_loc5_ == null)
         {
            return null;
         }
         if(this.var_1386 || this.var_46 == null || (this.var_46.width != _loc5_.width || this.var_46.height != _loc5_.height))
         {
            if(this.var_46 != null && !this.var_1386)
            {
               this.var_46.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_295.definition.geometryType,this.var_95);
         this.var_46.lock();
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_659);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_659);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_344.push(new ActiveActionData(param1,param2,this.var_659));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.resetBodyPartCache(this.var_946);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_538 = "";
         this.var_273 = this._structure.sortActions(this.var_344);
         if(this.var_273 == null)
         {
         ...
         {
            this.var_778 = this._structure.getCanvasOffsets(this.var_273,this._scale,this.var_95);
            for each(_loc4_ in this.var_273)
            {
               this.var_538 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_319)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1538 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1538 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_273)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_945 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
               ...
               if(_loc1_.actionType == AvatarAction.const_356 || _loc1_.actionType == AvatarAction.const_291 || _loc1_.actionType == AvatarAction.const_419)
               {
                  this.var_945 = true;
               }
            }
