package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2276:String = "hd-99999-99999";
      ...
      private var var_318:PetDataManager;
      
      private var var_829:PaletteManager;
      ...
      private var var_1944:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_341 = RenderMode.const_1827;
         ...
         this.var_114.add(AvatarType.const_121,_loc4_);
         ...
         this.var_114.add(AvatarType.const_57,_loc4_);
         this._aliasCollection = new AssetAliasCollection(this,param1.assets as AssetLibraryCollection);
         this.var_318 = new PetDataManager(this,param1.assets as AssetLibraryCollection);
         this.var_829 = new PaletteManager(param1.assets as AssetLibraryCollection);
         var _loc5_:XML = param3.getAssetByName("HabboAvatarPetFigure").content as XML;
         this.var_318.populateFigureData(_loc5_);
      ...
      override public function dispose() : void
      {
         ...
         {
            for each(_loc1_ in this.var_114.getValues())
            {
               _loc1_.dispose();
            }
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_318.init();
         this.var_829.init();
         _loc2_ = this.var_114.getValue(AvatarType.const_121) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_114.getValue(AvatarType.const_57) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_114.getValue(AvatarType.const_121) as AvatarStructure;
            if(_loc3_ != null)
            {
      ...
      private function checkIfReady() : void
      {
         if(!this.var_1006)
         {
            if(this.var_2689 && this.var_2690 && this.var_2691)
            {
               this.var_1006 = true;
      ...
      {
         var _loc5_:AvatarStructure = this.var_114.getValue(AvatarType.const_121) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(!this.var_1944)
         {
            this.var_1944 = new AvatarFigureContainer(this.const_2276);
         }
         this.var_241.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1944,param2);
      }
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         if(param1 == null || this.var_317 == null)
         {
            return;
         }
         for each(_loc2_ in this.var_317.getKeys())
         {
            _loc3_ = this.var_317.getValue(_loc2_);
            if(_loc3_ != null)
            {
      ...
      public function getPetFigureString(param1:String) : String
      {
         ...
         return this.var_318.createPetFigureString(_loc3_,_loc4_,_loc5_);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1882)
         {
            _loc6_ = !this.var_318.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_318.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_114.getValue(AvatarType.const_57) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
         ...
         if(param5 != null)
         {
            ...
            this.var_317.add(_loc7_,_loc9_);
         }
      ...
      public function resetPetData() : void
      {
         ...
         this.var_318.populateFigureData(_loc1_);
         var _loc2_:AvatarStructure = this.var_114.getValue(AvatarType.const_57);
         _loc2_.initFigureData(_loc1_);
         _loc2_.resetPartOffsets(context.assets);
         var _loc5_:Array = this.var_317.getKeys();
         for each(_loc6_ in _loc5_)
         {
            _loc4_ = this.var_317.getValue(_loc6_);
            if(_loc4_)
            {
      ...
      {
         var _loc2_:AvatarStructure = this.var_114.getValue(param1) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc3_:AvatarStructure = this.var_114.getValue(AvatarType.const_121) as AvatarStructure;
      ...
      {
         return this.var_318 as IPetDataManager;
      }
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarType.const_57:
               _loc3_ = this.var_114.getValue(AvatarType.const_57) as AvatarStructure;
               break;
            default:
