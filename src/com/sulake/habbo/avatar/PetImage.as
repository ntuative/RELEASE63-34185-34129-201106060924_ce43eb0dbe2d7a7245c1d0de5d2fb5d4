package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1455:String = "Default";
      ...
      protected var var_295:IActiveActionData;
      
      protected var var_1113:Boolean;
      
      private var var_946:IActiveActionData;
      ...
      private var var_611:AvatarFigureContainer;
      
      private var var_660:Boolean;
      
      private var var_220:Array;
      
      private var var_586:IAvatarDataContainer;
      ...
      public function PetImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String)
      {
         ...
         if(this._scale == null)
         {
            this._scale = AvatarScaleType.const_60;
         }
         ...
         this.var_611 = new AvatarFigureContainer(param3);
         var _loc5_:int = this.var_611.getPartSetId("pbd");
         this.solvePetAvatarTypeAndBreed(_loc5_);
         this.var_1462 = this.var_1198;
         this.var_269 = new AvatarImageCache(this._structure,this,this._assets,this._scale);
         this.setDirection(const_1454,const_1453);
         this.var_344 = new Array();
         this.var_946 = new ActiveActionData(AvatarAction.const_407);
         this.var_946.definition = this._structure.getActionDefinition(const_1455);
         this.resetActions();
      }
      ...
      {
         return this._structure.getPartColor(this.var_611,param1);
      }
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         {
            if((this.var_95 == 6 || this.var_95 == 0) && param2 == 7)
            {
               param2 = this.var_95;
            }
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1462);
            if(_loc3_ != null)
            {
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_659,param1.id);
      }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc4_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_295.definition.geometryType);
         if(this.var_46 == null || _loc4_ != null && (this.var_46.width != _loc4_.width || this.var_46.height != _loc4_.height))
         {
            _loc4_ = this._structure.getCanvas(this._scale,this.var_295.definition.geometryType);
            if(_loc4_ == null)
            {
               return null;
            }
         ...
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_295.definition.geometryType,this.var_95);
         this.var_46.lock();
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_659);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               _loc15_ = this._structure.getParts(_loc8_,this.var_611,_loc13_,"pet",_loc12_.getDirection(),[]);
               _loc16_ = this.var_1462 < 3;
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_659);
                  _loc20_ = this.var_95;
                  _loc21_ = 1;
                  switch(this.var_95)
                  {
                  ...
                  if(_loc22_ != null)
                  {
                     ...
                     _loc11_.y += _loc22_.y;
                     if(this.var_95 == 7 && _loc12_.getDirection() == 6)
                     {
                        _loc11_.offset(-1 * _loc17_,0);
                     }
                     else if(this.var_95 == 4 && _loc12_.getDirection() == 3)
                     {
                        _loc11_.offset(_loc17_,0);
                     }
                     else if(this.var_95 == 3 && _loc12_.getDirection() == 4)
                     {
                        _loc11_.offset(-1 * _loc17_,0);
                     }
                     else if(this.var_95 == 6 && _loc12_.getDirection() == 7)
                     {
                        _loc11_.offset(_loc17_,0);
                     }
                  }
         ...
         {
            if(this.var_586.paletteIsGrayscale)
            {
               ...
               this.var_46 = _loc23_;
               this.var_46.paletteMap(this.var_46,this.var_46.rect,new Point(0,0),this.var_586.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_295.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_659);
            if(_loc10_ != null)
            {
               ...
               _loc16_ = this._structure.getParts(_loc9_,this.var_611,_loc14_,"pet",_loc13_.getDirection(),[]);
               _loc17_ = 32;
               if(this._scale == AvatarScaleType.const_116)
               {
                  _loc17_ = 6;
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_659);
                  _loc21_ = this.var_95;
                  _loc22_ = 1;
                  switch(this.var_95)
                  {
                  ...
                  if(_loc23_ != null)
                  {
                     ...
                     _loc12_.y += _loc23_.y;
                     if(this.var_95 == 7 && _loc13_.getDirection() == 6)
                     {
                        _loc12_.offset(-1 * _loc17_,0);
                     }
                     else if(this.var_95 == 4 && _loc13_.getDirection() == 3)
                     {
                        _loc12_.offset(_loc17_,0);
                     }
                     else if(this.var_95 == 3 && _loc13_.getDirection() == 4)
                     {
                        _loc12_.offset(-1 * _loc17_,0);
                     }
                     else if(this.var_95 == 6 && _loc13_.getDirection() == 7)
                     {
                        _loc12_.offset(_loc17_,0);
                     }
                  }
         ...
         switch(param1)
         {
            case AvatarAction.const_444:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1946:
                  case AvatarAction.const_1910:
                  case AvatarAction.const_1904:
                  case AvatarAction.const_1325:
                  case AvatarAction.const_1306:
                  case AvatarAction.const_1877:
                  case AvatarAction.const_1762:
      ...
      private function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_344.push(new ActiveActionData(param1,param2));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_586 = null;
         this.var_1778 = 0;
         this.var_295 = this.var_946;
         this.var_295.definition = this.var_946.definition;
         this.setActionToParts(this.var_946);
         this.getCache().resetBodyPartCache(this.var_946);
         return true;
      }
      ...
      {
         this.var_1461 = true;
         if(this.var_1238 == this.var_538)
         {
            return;
         }
         this.var_1238 = this.var_538;
         this.var_1460 = this._structure.sortActions(this.var_344);
         if(this.var_1460 == null)
         {
            this.var_778 = new Array(0,0,0);
         }
         else
         {
            this.var_778 = this._structure.getCanvasOffsets(this.var_1460,this._scale,this.var_95);
         }
      }
         ...
         for each(_loc1_ in this.var_1460)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.definition.isAnimation)
               {
                  ...
                  if(_loc2_ != null)
                  {
                     this.var_220 = this.var_220.concat(_loc2_.spriteData);
                     ...
                     {
                        this.var_586 = _loc2_.avatarData;
                     }
                  }
               }
               if(_loc1_.actionType == AvatarAction.const_419)
               {
                  this.var_945 = true;
               }
               ...
               if(_loc1_.actionType == AvatarAction.const_356)
               {
                  this.var_945 = true;
               }
            }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1198 = _loc4_.id;
                     this.var_1779 = _loc4_.breed;
                     break;
                  }
               }
            }
