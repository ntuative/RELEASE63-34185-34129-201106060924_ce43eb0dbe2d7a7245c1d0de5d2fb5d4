package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1812:Number = 1.0;
      
      private var var_1809:Number = 1.0;
      
      private var var_1813:Number = 1.0;
      ...
      {
         super();
         this.var_1727 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2329 = parseInt(_loc2_,16);
         this.var_2327 = parseInt(_loc3_,16);
         this._rgb = parseInt(_loc2_,16);
         this.var_1810 = this._rgb >> 16 & 255;
         this.var_1811 = this._rgb >> 8 & 255;
         this._b = this._rgb >> 0 & 255;
         this.var_1812 = this.var_1810 / 255 * 1;
         this.var_1809 = this.var_1811 / 255 * 1;
         this.var_1813 = this._b / 255 * 1;
         if(this.var_1727 == 37)
         {
            this._alphaMultiplier = 0.5;
            this.var_2328 = false;
         }
         this.var_780 = new ColorTransform(this.var_1812,this.var_1809,this.var_1813,this._alphaMultiplier);
         this.var_1157 = this.generatePaletteMapForGrayscale(this.var_2327,this.var_2329);
      }
      ...
      {
         return this.var_1157.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1157.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1157.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1157.getValue("alphas") as Array;
      }
