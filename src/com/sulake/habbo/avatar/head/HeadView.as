   ...
   public class HeadView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_39)
         {
            ...
            var_39["null"] = new AvatarEditorGridView(var_73,FigureData.const_218,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_73,FigureData.const_276,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_73,FigureData.const_271,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_73,FigureData.const_273,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_73,FigureData.const_300,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_73 && var_156 == "")
         {
            var_73.switchCategory(FigureData.const_218);
         }
      }
