package com.sulake.habbo.avatar.hotlooks
{
   ...
   public class HotLooksView implements IAvatarEditorCategoryView
   {
      ...
      private var var_73:HotLooksModel;
      ...
      public function init() : void
      {
         ...
         this.var_613 = this._window.findChildByName("hotlooks") as IItemGridWindow;
      ...
      {
         while(this.var_613.numGridItems > 0)
         {
            this.var_613.removeGridItemAt(0);
         }
         this._window.dispose();
         this._window = null;
         this.var_73 = null;
      ...
      public function update() : void
      {
         ...
         var _loc2_:* = null;
         this.var_613.removeGridItems();
         for each(_loc2_ in this.var_73.hotLooks)
         {
            _loc1_ = _loc2_.view.window;
            this.var_613.addGridItem(_loc1_);
      ...
      private function hotLooksEventProc(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         {
            _loc3_ = this.var_613.getGridItemIndex(param2.parent);
            this.var_73.selectHotLook(_loc3_);
         }
      }
