   ...
   public class LegsView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_39)
         {
            ...
            var_39["null"] = new AvatarEditorGridView(var_73,FigureData.TROUSERS,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_73,FigureData.const_290,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_73,FigureData.const_243,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_73 && var_156 == "")
         {
            var_73.switchCategory(FigureData.TROUSERS);
         }
      }
