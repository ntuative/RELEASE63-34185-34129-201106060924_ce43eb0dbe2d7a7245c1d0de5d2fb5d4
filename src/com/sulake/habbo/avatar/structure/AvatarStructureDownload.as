package com.sulake.habbo.avatar.structure
{
   ...
   public class AvatarStructureDownload extends EventDispatcher
   {
      ...
      private var var_2217:IStructureData;
      ...
      public function AvatarStructureDownload(param1:IAssetLibrary, param2:String, param3:IStructureData)
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_43,this.onDataFailed);
      }
      ...
      private function onDataComplete(param1:Event) : void
      {
         ...
         try
         {
            ...
            {
               Core.error("Could not load avatar structure, got empty data from URL " + loaderStruct.assetLoader.url + " data length = " + data.length + ".",false,Core.const_228);
            }
            this.var_1680 = new XML(data);
         }
         catch(e:Error)
         {
         ...
         this.var_2217.appendXML(this.var_1680);
      ...
      private function onDataFailed(param1:Event) : void
      {
         ...
         Core.error("Could not load avatar structure. Failed to get data from URL " + _loc3_,false,Core.const_228);
      }
   }
}
