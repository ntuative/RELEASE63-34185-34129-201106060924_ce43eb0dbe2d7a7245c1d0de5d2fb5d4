package com.sulake.habbo.catalog.purchase
{
   ...
   public class PlacedObjectPurchaseData implements IDisposable
   {
      ...
      private var var_627:IFurnitureData;
      ...
      {
         this.var_1290 = param1.offerId;
         this.var_1677 = param1.productContainer.firstProduct.productClassId;
         this.var_1676 = param1.productContainer.firstProduct.productData;
         this.var_627 = param1.productContainer.firstProduct.furnitureData;
         this.var_1585 = param1.productContainer.firstProduct.extraParam;
      }
      
      public function toString() : String
      {
         return [this._roomCategory,this._roomId,this.var_222,this._category,this.var_2012,this._x,this.var_166,this._direction,this.var_1290,this.var_1677].toString();
      }
