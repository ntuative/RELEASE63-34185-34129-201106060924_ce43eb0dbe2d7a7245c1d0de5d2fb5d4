package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      {
         return this.var_669 != const_1089;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1924 != RecyclerStatusMessageEvent.const_1351;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_669 == const_466;
      }
      ...
      {
         this.var_669 = const_1090;
         this.var_128 = new Array(const_211);
         if(param1 == null)
         {
            return;
         }
      ...
      public function cancel() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < const_211)
         {
            this.releaseSlot(_loc1_);
            _loc1_++;
         }
         this.var_669 = const_1089;
      }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1924)
         {
            case RecyclerStatusMessageEvent.const_1964:
               this.var_669 = const_466;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1351:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1899:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1223:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1930:
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         {
            oldObjectData = this.var_128[0];
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_211)
            {
               oldObjectData = this.var_128[newSlotId];
         ...
         this.var_128[slotId] = new FurniSlotItem(itemId,category,typeId,xxxExtra);
         this.updateRecyclerSlots();
         this.updateRecyclerButton();
      }
      ...
      public function releaseSlot(param1:int) : void
      {
         ...
         if(!this._catalog.returnInventoryFurniFromRecycler(this.var_128[param1].id))
         {
            return;
         }
         this.var_128[param1] = null;
         this.updateRecyclerSlots();
         this.updateRecyclerButton();
      }
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_128.length < const_211)
         {
            return false;
         }
         var _loc1_:int = 0;
