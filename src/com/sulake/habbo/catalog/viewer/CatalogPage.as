package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1979:String = "ctlg_";
       
      
      protected var var_2211:XML;
      ...
      {
         return this._localization.getLinks(this.var_1332);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1332);
      }
      ...
      {
         var _loc2_:String = const_1979 + param1;
         ...
         this.var_2211 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2211) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1907:
               if(this.var_1331 == null)
               {
                  this.var_1331 = new ItemGridCatalogWidget(param1,this._catalog.sessionDataManager);
                  this.var_37.push(this.var_1331);
               }
               break;
            case CatalogWidgetEnum.const_1918:
               this.var_37.push(new ItemGroupCatalogWidget(param1,this._catalog.sessionDataManager));
               break;
            ...
            case CatalogWidgetEnum.const_1805:
               ...
               break;
            case CatalogWidgetEnum.const_1933:
               this.var_37.push(new SingleViewCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1691:
               this.var_37.push(new PurchaseCatalogWidget(param1,this._catalog.sessionDataManager));
               break;
            case CatalogWidgetEnum.const_1742:
               this.var_37.push(new PurseCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1784:
            ...
            case CatalogWidgetEnum.const_1747:
               ...
               break;
            case CatalogWidgetEnum.const_1731:
               this.var_37.push(new SpacesNewCatalogWidget(param1,this._catalog.sessionDataManager));
               break;
            ...
            case CatalogWidgetEnum.const_1941:
               ...
               break;
            case CatalogWidgetEnum.const_1670:
               this.var_37.push(new TextInputCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1834:
            ...
            case CatalogWidgetEnum.const_1871:
               ...
               break;
            case CatalogWidgetEnum.const_1699:
