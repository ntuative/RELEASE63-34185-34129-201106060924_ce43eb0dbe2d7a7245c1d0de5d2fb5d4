package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_281:IDisplayObjectWrapper;
      
      private var var_1979:Point;
      
      private var var_552:IItemGridWindow;
      
      private var var_1583:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_281.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
            this.var_281 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1049 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1287 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_91 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_319 = _window.findChildByName("room_canvas_container") as IWindowContainer;
         if(this.var_319 != null)
         {
            this.var_319.visible = false;
            this.var_281 = this.var_319.findChildByName("room_canvas") as IDisplayObjectWrapper;
            _loc3_ = (page.viewer.catalog as HabboCatalog).roomPreviewer;
            if(this.var_281 != null && _loc3_ != null)
            {
               this.var_281.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
               _loc3_.reset();
               _loc4_ = _loc3_.getRoomCanvas(this.var_281.width,this.var_281.height);
               if(_loc4_ != null)
               {
                  this.var_281.setDisplayObject(_loc4_);
               }
            }
            else
            {
         ...
         this.var_1979 = new Point(this.var_91.x,this.var_91.y);
         this.var_552 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1583 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(this.var_552 != null)
         {
            this.var_552.visible = false;
            this.var_552.destroyGridItems();
         }
         ...
         this.var_1049.text = _loc4_;
         this.var_1287.text = _loc5_;
         this.var_1049.height = this.var_1049.textHeight + 5;
         this.var_1287.y = this.var_1049.y + this.var_1049.height;
         this.var_1287.height = Math.max(130,this.var_1287.textHeight + 5);
         ...
         else
         {
            ...
            {
               case Offer.const_635:
                  _loc6_ = this._bundlePreview.clone();
                  if(this.var_552 != null)
                  {
                     this.var_552.visible = true;
                     _loc11_ = _loc2_.productContainer as BundleProductContainer;
                     _loc11_.populateItemGrid(this.var_552,this.var_1583,this.var_1870);
                     this.var_552.scrollV = 0;
                  }
                  if(this.var_319 != null)
                  {
                     this.var_319.visible = false;
               ...
               case Offer.const_452:
                  ...
                  if(this.var_319 != null)
                  {
                     if(_loc9_.productType == ProductTypeEnum.const_72 || _loc9_.productType == ProductTypeEnum.const_64 || _loc9_.productType == ProductTypeEnum.const_181)
                     {
                  ...
                  switch(_loc9_.productType)
                  {
                     case ProductTypeEnum.const_72:
                        if(_loc8_ != null && this.var_281 != null)
                        {
                     ...
                     case ProductTypeEnum.const_181:
                        ...
                        else
                        {
                           ...
                           _loc6_ = new BitmapData(this.var_91.width,this.var_91.height,false,_loc15_);
                           _loc16_ = null;
                           _loc17_ = page.viewer.catalog as HabboCatalog;
                           if(_loc17_.avatarRenderManager != null)
                           {
                              _loc19_ = _loc17_.sessionDataManager.figure;
                              _loc18_ = _loc17_.avatarRenderManager.createAvatarImage(_loc19_,AvatarScaleType.const_60);
                              if(_loc18_ != null)
                              {
                                 _loc18_.setDirection(AvatarSetType.const_53,3);
                                 _loc18_.initActionAppends();
                                 _loc18_.appendAction(AvatarAction.const_320,AvatarAction.const_617);
                                 _loc18_.appendAction(AvatarAction.const_319,_loc9_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2731)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2731 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_91 != null && true)
         {
            ...
            this.var_91.x = this.var_1979.x;
            this.var_91.y = this.var_1979.y;
            if(param3 != null)
            {
