package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1090.removeEventListener(WindowKeyboardEvent.const_217,this.windowKeyEventProcessor);
            this.var_1090 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1090 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_1090 != null)
         {
            this.var_1090.addEventListener(WindowKeyboardEvent.const_217,this.windowKeyEventProcessor);
         }
         return true;
      }
