package com.sulake.habbo.communication
{
   ...
   public class HabboCommunicationManager extends Component implements IHabboCommunicationManager, IConnectionStateListener
   {
      ...
      private const const_2259:int = 2;
      ...
      private var var_1620:IMessageConfiguration;
      ...
      {
         this.var_1620 = new HabboMessages();
         this.var_359 = [];
         this.var_1450 = new Timer(100,1);
      ...
      {
         if(this.var_359.length == 0 || this.var_434 < 0 || this.var_434 >= this.var_359.length)
         {
            return 0;
         }
         return this.var_359[this.var_434];
      }
      ...
      private function onCoreCommunicationManagerInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            this.var_257.registerProtocolType(HabboProtocolType.const_1342,WedgieProtocol);
            this._connection = this.var_257.createConnection(HabboConnectionType.const_263,ConnectionType.const_1229);
            _loc3_ = this.var_257.getProtocolInstanceOfType(HabboProtocolType.const_1342);
            this._connection.registerMessageClasses(this.var_1620);
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            if(_loc8_ == null)
            {
               Core.crash(this.getKey([this._a4,_loc6_,_loc4_,_loc5_],0),Core.const_393);
               return;
            }
            _loc11_ = [];
            _loc12_ = 1;
            ...
            if(_loc7_ == null)
            {
               Core.crash(this.getKey([this._a4,_loc6_,_loc4_,_loc3_],0),Core.const_393);
               return;
            }
            this.var_359 = [];
            _loc9_ = _loc7_.split(",");
            ...
            {
               this.var_359.push(parseInt(_loc10_.replace(" ","")));
            }
            _loc7_ = _loc8_;
            this.var_38 = _loc7_;
            this.var_2392 = true;
      ...
      public function initConnection(param1:String) : void
      {
         switch(param1)
         {
            case HabboConnectionType.const_263:
               if(this.var_143 == null)
               {
                  Core.crash("Tried to connect to proxy but configuration was null",Core.const_393);
                  return;
               }
               if(this._connection == null)
               {
                  Core.crash("Tried to connect to proxy but connection was null",Core.const_393);
                  return;
               }
               this.var_2394 = true;
               if(this.var_2392)
      ...
      private function nextPort() : void
      {
         ...
         ++this.var_434;
         if(this.var_434 >= this.var_359.length)
         {
            ErrorReportStorage.addDebugData("ConnectionRetry","Connection attempt " + this.var_938);
            ++this.var_938;
            _loc1_ = this.const_2259;
            if(this.var_359.length == 1)
            {
               _loc1_++;
            }
            if(this.var_938 > _loc1_)
            {
               ...
               this.var_2393 = true;
               Core.error("Connection failed to host and ports",true,Core.const_393);
               return;
            }
            this.var_434 = 0;
         }
         this._connection.timeout = this.var_938 * 10000;
         this._connection.init(this.var_38 + this.getKey([[65244,65185,65191,65189,65188],[65174,65238,65184],[65171,65172]],0),this.var_359[this.var_434]);
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("Communication IO Error","IOError " + param1.type + " on connect: " + param1.text + ". Port was " + this.var_359[this.var_434]);
         this.tryNextPort();
      }
      ...
      {
         this.var_1450.addEventListener(TimerEvent.TIMER,this.onTryNextPort);
         this.var_1450.start();
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("Communication Security Error","SecurityError on connect: " + param1.text + ". Port was " + this.var_359[this.var_434]);
         this.tryNextPort();
      }
      
      public function getHabboMainConnection(param1:Function) : IConnection
      {
         return !!this.var_257 ? this.var_257.queueConnection(HabboConnectionType.const_263,param1) : null;
      }
      ...
      public function addHabboConnectionMessageEvent(param1:IMessageEvent) : void
      {
         if(this.var_257)
         {
            this.var_257.addConnectionMessageEvent(HabboConnectionType.const_263,param1);
         }
      }
      ...
      {
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1890,param1);
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1948,String(param2));
      }
      
      public function messageReceived(param1:String, param2:String) : void
      {
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1760,String(new Date().getTime()));
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1687,param1 + " " + param2);
      ...
      {
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1811,String(new Date().getTime()));
