   ...
   public class BadgesParser implements IMessageParser
   {
      ...
      public function parse(param1:IMessageDataWrapper) : Boolean
      {
         ...
         while(_loc5_ < _loc4_)
         {
            ...
            this.var_1126.add(_loc3_,_loc2_);
            this.var_1914.push(_loc3_);
            _loc5_++;
         }
         this.var_1913 = new Array();
      ...
      {
         return this.var_1126.getValue(param1);
      }
