package com.sulake.habbo.communication.protocol
{
   ...
   public class WedgieProtocol implements IProtocol
   {
      ...
      public static const const_1785:uint = 1;
      
      public static const const_1959:uint = 2;
       
      
      private var var_1480:IProtocolEncoder;
      ...
      {
         super();
         this.var_1480 = new WedgieEncoder();
         this.var_1172 = new WedgieDecoder();
      }
      
      public function dispose() : void
      {
         this.var_1480.dispose();
