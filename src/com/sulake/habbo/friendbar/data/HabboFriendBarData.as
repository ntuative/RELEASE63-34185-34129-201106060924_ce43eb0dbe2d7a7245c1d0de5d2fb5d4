package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_309:Boolean = false;
      
      private static const const_1110:Boolean = false;
      
      private static const const_688:String = "Navigation";
      
      private static const const_689:String = "Friend Bar";
      
      private static const const_1592:String = "go.friendbar";
      
      private static const const_1589:String = "chat_btn_click";
      
      private static const const_1591:String = "find_friends_btn_click";
      
      private static const const_1108:String = "Toolbar";
      
      private static const const_1109:String = "open";
      
      private static const const_1107:String = "close";
      
      private static const const_1590:String = "FRIENDLIST";
      
      private static const const_1588:String = "MESSENGER";
      ...
      private var var_322:IHabboFriendList;
      
      private var var_464:IHabboMessenger;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            if(this.var_1299)
            {
               this.var_1299.release(new IIDHabboConfigurationManager());
               this.var_1299 = null;
            }
            if(this.var_87)
            {
            ...
            if(this.var_322)
            {
               this.var_322.release(new IIDHabboFriendList());
               this.var_322 = null;
            }
            if(this.var_464)
            {
               this.var_464.release(new IIDHabboMessenger());
               this.var_464 = null;
            }
            this.var_108 = null;
      ...
      {
         return this.var_323.getValue(param1);
      }
      ...
      {
         var _loc3_:int = this.var_108.indexOf(param1);
         if(_loc3_ > -1 && _loc3_ != param2)
         {
            this.var_108.splice(_loc3_,1);
            this.var_108.splice(param2,0,param1);
      ...
      {
         var _loc2_:* = null;
         for each(_loc2_ in this.var_483)
         {
            if(_loc2_.id == param1)
            {
               return _loc2_;
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_87)
         {
            ...
            this.var_87.getHabboMainConnection(null).send(new EventLogMessageComposer(const_688,const_689,const_1592));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_464)
         {
            this.var_464.startConversation(param1);
            events.dispatchEvent(new NewMessageEvent(false,param1));
            if(this.var_87)
            {
               this.var_87.getHabboMainConnection(null).send(new EventLogMessageComposer(const_688,const_689,const_1589));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_87)
         {
            ...
            this.var_87.getHabboMainConnection(null).send(new EventLogMessageComposer(const_688,const_689,const_1591));
         }
      }
      ...
      public function toggleFriendList() : void
      {
         ...
         if(this.var_322)
         {
            if(!this.var_322.disposed)
            {
               if(!this.var_322.isOpen())
               {
                  if(this.var_483.length > 0)
                  {
                     this.var_322.openFriendRequests();
                  }
                  else
                  {
                     this.var_322.openFriendList();
                  }
               }
               else
               {
                  _loc1_ = this.var_322.mainWindow;
               ...
               if(this.var_87)
               {
                  this.var_87.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1108,const_1590,!!this.var_322.isOpen() ? const_1109 : const_1107));
               }
            }
         }
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_464)
         {
            if(!this.var_464.disposed)
            {
               this.var_464.toggleMessenger();
               if(this.var_87)
               {
                  this.var_87.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1108,const_1588,!!this.var_464.isOpen() ? const_1109 : const_1107));
               }
            }
         }
      }
      ...
      {
         this.var_1299 = param2 as IHabboConfigurationManager;
         this.var_2766 = this.var_1299.getBoolean("friendbar.notifications.enabled",false);
      }
      ...
      private function onCommunicationManagerAvailable(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_87.addHabboConnectionMessageEvent(new FriendNotificationEvent(this.onFriendNotification));
      }
      
      private function onMessengerComponentAvailable(param1:IID, param2:IUnknown) : void
      {
         this.var_464 = param2 as IHabboMessenger;
      }
      
      private function onFriendListComponentAvailable(param1:IID, param2:IUnknown) : void
      {
         this.var_322 = param2 as IHabboFriendList;
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         {
            _loc3_ = this.var_323.getValue(_loc8_);
            if(_loc3_)
            {
               this.var_323.remove(_loc8_);
               this.var_108.splice(this.var_108.indexOf(_loc3_),1);
            }
         }
         for each(_loc4_ in _loc6_)
         {
            _loc3_ = this.var_323.getValue(_loc4_.id);
            if(_loc3_)
            {
               if(_loc4_.online || const_309)
               {
               ...
               {
                  this.var_323.remove(_loc4_.id);
                  this.var_108.splice(this.var_108.indexOf(_loc3_),1);
               }
            }
            else if(_loc4_.online || const_309)
            {
               ...
               this.var_108.splice(0,0,_loc3_);
               this.var_323.add(_loc3_.id,_loc3_);
            }
         }
         for each(_loc4_ in _loc7_)
         {
            if(_loc4_.online || const_309)
            {
               if(this.var_323.getValue(_loc4_.id) == null)
               {
                  _loc3_ = new FriendEntity(_loc4_.id,_loc4_.name,_loc4_.realName,_loc4_.motto,_loc4_.gender,_loc4_.online,_loc4_.followingAllowed,_loc4_.figure,_loc4_.categoryId,_loc4_.lastAccess);
         ...
         {
            this.var_108 = !!const_309 ? this.sortByNameAndOnlineStatus(this.var_108) : this.sortByName(this.var_108);
         }
         events.dispatchEvent(new FriendBarUpdateEvent());
      }
      ...
      private function onNewFriendRequest(param1:NewBuddyRequestEvent) : void
      {
         ...
         this.var_483.push(new FriendRequest(_loc2_.requestId,_loc2_.requesterName));
      ...
      private function onFriendRequestList(param1:BuddyRequestsEvent) : void
      {
         ...
         {
            this.var_483.push(new FriendRequest(_loc3_.requestId,_loc3_.requesterName));
         }
         events.dispatchEvent(new FriendRequestEvent());
      }
      ...
      private function onNewConsoleMessage(param1:NewConsoleMessageEvent) : void
      {
         ...
         this.var_1057 = _loc2_.senderId;
         events.dispatchEvent(new NewMessageEvent(true,this.var_1057));
         this.makeNotification(String(this.var_1057),FriendNotification.const_413,null,false,false);
      }
      ...
      private function onRoomInvite(param1:RoomInviteEvent) : void
      {
         ...
         this.var_1057 = _loc2_.senderId;
         events.dispatchEvent(new NewMessageEvent(true,this.var_1057));
         this.makeNotification(String(this.var_1057),FriendNotification.const_413,null,true,false);
      }
