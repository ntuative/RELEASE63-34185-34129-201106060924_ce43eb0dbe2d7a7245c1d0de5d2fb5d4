package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class Tab implements ITab
   {
      ...
      public static var var_1105:IHabboFriendBarData;
      
      public static var var_1375:IHabboFriendBarView;
      
      public static var ASSETS:IAssetLibrary;
      
      public static var WINDOWING:IHabboWindowManager;
      
      public static var var_2968:IHabboLocalizationManager;
      
      public static var var_2168:TextCropper;
      ...
      protected function onMouseClick(param1:WindowMouseEvent) : void
      {
         ...
         if(this.selected)
         {
            var_1375.deSelect(true);
         }
         else
         {
            var_1375.selectTab(this,true);
         }
      }
