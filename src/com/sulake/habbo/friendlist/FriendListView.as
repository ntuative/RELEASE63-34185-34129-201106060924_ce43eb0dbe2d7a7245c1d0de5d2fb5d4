package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1425:Point = new Point(110,50);
       
      
      private var _friendList:HabboFriendList;
      
      private var var_1777:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1777 = new FriendListTabsView(this._friendList);
      }
      ...
      public function openFriendList() : void
      {
         ...
         {
            this.prepare();
            this.var_17.position = const_1425;
         }
         else
         {
      ...
      private function prepare() : void
      {
         ...
         this.var_1086 = IWindowContainer(this.var_17.content.findChildByName("main_content"));
         this.var_289 = IWindowContainer(this.var_17.content.findChildByName("footer"));
         this.var_1777.prepare(this.var_1086);
         this.var_17.procedure = this.onWindow;
         this.var_17.content.setParamFlag(HabboWindowParam.const_1173,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_1278,true);
         this.var_17.header.setParamFlag(HabboWindowParam.const_816,false);
         this.var_17.header.setParamFlag(HabboWindowParam.const_776,true);
         this.var_17.content.setParamFlag(HabboWindowParam.const_816,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_776,true);
         this.var_17.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1459 = ITextWindow(this.var_17.findChildByName("info_text"));
         this.var_1459.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1774 == -1 ? 0 : int(this.var_17.height - this.var_1774);
         var _loc4_:int = this.var_1776 == -1 ? 0 : int(this.var_17.width - this.var_1776);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_289.y = Util.getLowestPoint(this.var_17.content);
         this.var_289.width = this._friendList.tabs.windowWidth;
         ...
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1151,this._friendList.tabs.findSelectedTab() != null);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_816,false);
         ...
         this.var_1774 = this.var_17.height;
         this.var_1776 = this.var_17.width;
