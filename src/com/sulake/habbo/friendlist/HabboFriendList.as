package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_151:IHabboMessenger;
      ...
      private var var_2920:FriendListLookAndFeel;
      
      private var var_453:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_2129:OpenedToWebPopup;
      
      private var var_2582:int;
      
      var var_110:FriendCategories;
      
      private var var_483:FriendRequests;
      
      private var var_2128:AvatarSearchResults;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_1017:IHabboNotifications;
      
      private var var_711:Timer;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2920 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_110 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_2128 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_711.stop();
            this.var_711.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_711 = null;
         }
         ...
         if(this.var_151)
         {
            this.var_151.release(new IIDHabboMessenger());
            this.var_151 = null;
         }
         if(this.var_181)
         {
         ...
         if(this.var_1017)
         {
            this.var_1017.release(new IIDHabboNotifications());
            this.var_1017 = null;
         }
         if(this._toolbar)
         {
         ...
         if(this.var_883)
         {
            this.var_883.release(new IIDSessionDataManager());
            this.var_883 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_2129 = new OpenedToWebPopup(this);
         }
         this.var_2129.show(x,y);
      }
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return this.var_110.findFriend(param1);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_404);
      }
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean) : int
      {
         ...
         return this.var_110.getFriendCount(param1,param2);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_326,HabboWindowStyle.const_48,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_741.createAvatarImage(param1,AvatarScaleType.const_116,null,this);
         if(!_loc2_)
         {
            return null;
         }
         var _loc3_:BitmapData = _loc2_.getCroppedImage(AvatarSetType.const_53);
         _loc2_.dispose();
         return _loc3_;
      }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_151 = param2 as IHabboMessenger;
      ...
      {
         this.var_1017 = param2 as IHabboNotifications;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_483 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_110.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_110.addCategory(new FriendCategory(FriendCategory.const_1366,this.getText("friendlist.friends")));
         this.var_110.addCategory(new FriendCategory(FriendCategory.const_454,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_110.addFriend(new Friend(_loc4_));
         }
         this.var_453 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_711)
         {
            this.var_711 = new Timer(120000);
            this.var_711.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_711.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         if(this.var_110.getFriendCount(true,false) == 0)
         {
            _loc5_ = this.var_110.findCategory(FriendCategory.const_454);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_483.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_483.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_453.findTab(FriendListTab.const_102).setNewMessageArrived(true);
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_483.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_453.findTab(FriendListTab.const_102);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_2128.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         this.var_110.onFriendListUpdate(param1);
      ...
      public function getFriendNames() : Array
      {
         ...
         return this.var_110.getFriendNames();
      }
      
      public function acceptFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = this.var_453.findTab(FriendListTab.const_102);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_883 || !this.var_483)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_883.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_45))
         {
            _loc2_ = this.var_483.vipLimit;
         }
         else if(this.var_883.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_37))
         {
            _loc2_ = this.var_483.clubLimit;
         }
         if(_loc2_ > this.var_483.limit)
         {
            this.var_483.limit = _loc2_;
         }
      }
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(disposed || this.var_110 == null)
         {
            return;
         }
         var _loc2_:Dictionary = this.var_110.getAllFriends();
         if(_loc2_ == null)
         {
            return;
         }
