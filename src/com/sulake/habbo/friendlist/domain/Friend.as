package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_2120:int = "F".charCodeAt(0);
      
      public static const const_2079:int = "M".charCodeAt(0);
      ...
      private var var_1353:BitmapData;
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_931 = param1.gender;
         this.var_872 = param1.online;
         this.var_2063 = param1.followingAllowed && param1.online;
         this.var_611 = param1.figure;
         this.var_2075 = param1.motto;
         this.var_2074 = param1.lastAccess;
         this.var_1603 = param1.categoryId;
         this.var_2076 = param1.realName;
