package com.sulake.habbo.help
{
   ...
   public class HabboHelp extends Component implements IHabboHelp
   {
      ...
      private var var_914:IHabboConfigurationManager;
      
      private var var_395:ISessionDataManager;
      
      private var var_1144:FaqIndex;
      ...
      private var var_739:HotelMergeUI;
      
      private var var_1427:CallForHelpData;
      
      private var var_2292:UserRegistry;
      
      private var var_2291:String = "";
      
      private var var_915:WelcomeScreenController;
      
      public function HabboHelp(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_1427 = new CallForHelpData();
         this.var_2292 = new UserRegistry();
         super(param1,param2,param3);
         this._assetLibrary = param3;
         this.var_1144 = new FaqIndex();
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_914)
         {
            this.var_914.release(new IIDHabboConfigurationManager());
            this.var_914 = null;
         }
      ...
      public function getConfigurationKey(param1:String, param2:String = null, param3:Dictionary = null) : String
      {
         ...
         return this.var_914.getKey(param1,param2,param3);
      }
      ...
      {
         this.var_1427.reportedUserId = param1;
         this.var_1427.reportedUserName = param2;
         this.var_69.showUI(HabboHelpViewEnum.const_394);
      }
      ...
      public function initHotelMergeUI() : void
      {
         if(!this.var_739)
         {
            this.var_739 = new HotelMergeUI(this);
         }
         this.var_739.startNameChange();
      }
      ...
      public function startNameChange() : void
      {
         if(this.var_111)
         {
            this.var_111.showView(TutorialUI.const_362);
         }
      }
      ...
      {
         this.var_918 = IHabboLocalizationManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),this.onConfigurationManagerReady);
      }
      
      private function onConfigurationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_914 = IHabboConfigurationManager(param2);
      ...
      public function showWelcomeScreen(param1:WelcomeNotification) : void
      {
         if(!this.var_915)
         {
            this.var_915 = new WelcomeScreenController(this,this._windowManager);
         }
         this.var_915.showWelcomeScreen(param1);
      }
