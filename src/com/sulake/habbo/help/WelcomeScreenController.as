package com.sulake.habbo.help
{
   ...
   public class WelcomeScreenController implements IUpdateReceiver
   {
      ...
      private var var_205:Point;
      
      private var var_66:WelcomeNotification;
      
      public function WelcomeScreenController(param1:HabboHelp, param2:IHabboWindowManager)
      {
         this.var_205 = new Point(72,10);
         super();
         this.var_180 = param1;
      ...
      public function dispose() : void
      {
         if(this.var_180)
         {
            this.var_180.removeUpdateReceiver(this);
            this.var_180.toolbar.events.removeEventListener(HabboToolbarEvent.const_49,this.onToolbarClicked);
            this.var_180 = null;
         }
      ...
      public function showWelcomeScreen(param1:WelcomeNotification) : void
      {
         ...
         this.var_66 = param1;
         this.var_180.toolbar.events.addEventListener(HabboToolbarEvent.const_49,this.onToolbarClicked);
         if(this._window == null)
         {
            this.initializeWindow();
         }
         var _loc2_:ITextWindow = ITextWindow(this._window.findChildByName("text"));
         _loc2_.caption = this.var_180.localization.getKey(param1.localizationKey);
         _loc2_.height = _loc2_.textHeight + 5;
         this.var_205.y = this.var_180.toolbar.getIconVerticalLocation(param1.targetIconId) - this._window.height / 2;
         this._window.y = this.var_205.y;
      ...
      {
         var _loc1_:XmlAsset = this.var_180.assets.getAssetByName("welcome_screen_xml") as XmlAsset;
         ...
         var _loc3_:BitmapDataAsset = this.var_180.assets.getAssetByName("welcome_screen_arrow") as BitmapDataAsset;
         ...
         _loc4_.content.setParamFlag(WindowParam.const_313,false);
         _loc4_.height -= 20;
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:Number = Point.distance(this._window.rectangle.topLeft,this.var_205);
         if(_loc2_ > 5)
         {
            _loc3_ = Point.interpolate(this._window.rectangle.topLeft,this.var_205,0.5);
            this._window.x = _loc3_.x;
            this._window.y = _loc3_.y;
         }
         else
         {
            this._window.x = this.var_205.x;
            this._window.y = this.var_205.y;
            this.var_180.removeUpdateReceiver(this);
         }
      }
      ...
      {
         this.var_180.removeUpdateReceiver(this);
         this.var_180.registerUpdateReceiver(this,10);
      }
   }
}
