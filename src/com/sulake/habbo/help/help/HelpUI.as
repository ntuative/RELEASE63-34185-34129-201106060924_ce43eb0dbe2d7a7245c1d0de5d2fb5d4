package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201106060918));
         this.var_121 = new Map();
         this.var_121.add(HabboHelpViewEnum.const_1792,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_121.add(HabboHelpViewEnum.const_209,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_121.add(HabboHelpViewEnum.const_649,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_121.add(HabboHelpViewEnum.const_360,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_121.add(HabboHelpViewEnum.const_248,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_121.add(HabboHelpViewEnum.const_394,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_121.add(HabboHelpViewEnum.const_726,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_121.add(HabboHelpViewEnum.const_287,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_121.add(HabboHelpViewEnum.const_1361,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_121.add(HabboHelpViewEnum.const_1224,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_121.add(HabboHelpViewEnum.const_708,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(param1 == this.var_1785)
         {
            this.var_515 = new Array();
         }
         else if(param2)
         {
            if(this.var_515.length == 0 || param1 != this.var_364)
            {
               this.var_515.push(this.var_364);
            }
         }
         this.var_364 = param1;
         ...
         if(_loc3_ == null)
         {
            Logger.log("* No view controller found for " + this.var_364);
            return;
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_287:
               this.showUI(HabboHelpViewEnum.const_287);
               break;
            case CallForHelpResultEnum.const_1162:
               this.showUI(HabboHelpViewEnum.const_1224);
               break;
            case CallForHelpResultEnum.const_1241:
               this.showUI(HabboHelpViewEnum.const_1361);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_121.getValue(HabboHelpViewEnum.const_209) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_23.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_567));
      }
      ...
      {
         return this.var_121.getValue(this.var_364);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2423 = this._window.width - _loc3_.width;
         this.var_2422 = this._window.height;
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2422;
         this._window.width = _loc1_.width + this.var_2423;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_515.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_364 == HabboHelpViewEnum.const_209)
         {
            return;
         }
         if(this.var_619.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_619.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_619.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_363.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_619[1],this.var_619[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_619[0],this.var_619[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_364 == HabboHelpViewEnum.const_209 || this.var_515.length == 0)
         {
            return;
         }
         if(this.var_363 == null)
         {
            ...
            this.var_363 = this._windowManager.buildFromXML(XML(_loc2_.content)) as IWindowContainer;
            _loc3_ = this.var_363.findChildByName("back_image");
            if(_loc3_ != null)
            {
            ...
            _loc4_ = this.var_363.findChildByName("back_text");
            if(_loc4_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_363 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_363 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_363 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
