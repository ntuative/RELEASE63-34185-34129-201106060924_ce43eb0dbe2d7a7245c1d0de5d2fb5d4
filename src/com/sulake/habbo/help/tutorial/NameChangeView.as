package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1517:uint = 13232628;
      
      private static var var_1858:uint = 11129827;
      ...
      private var var_1859:IWindowContainer;
      ...
      private var var_1220:NameSuggestionListRenderer;
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1859 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_792)
         {
            this.var_792 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_792)
            {
               return;
            }
            this._window.content.addChild(this.var_792);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_793)
         {
            this.var_793 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_793)
            {
               return;
            }
            this._window.content.addChild(this.var_793);
         }
         this._window.caption = this._controller.localization.getKey("tutorial.name_change.title.confirm");
         var _loc1_:ITextWindow = this.var_793.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_532;
         }
         this.showView(this.var_793);
      }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            case ChangeUserNameResultMessageEvent.var_892:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_891:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_890:
               break;
            case ChangeUserNameResultMessageEvent.var_889:
               _loc4_.text = this._controller.localization.getKey("help.tutorial.name.long");
               break;
            case ChangeUserNameResultMessageEvent.var_893:
               _loc4_.text = this._controller.localization.getKey("help.tutorial.name.short");
               break;
            case ChangeUserNameResultMessageEvent.var_1106:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1107 || param1 == ChangeUserNameResultMessageEvent.var_1106)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1220 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1220.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1517;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "header_button_close":
               this._controller.showView(TutorialUI.const_95);
         }
      }
