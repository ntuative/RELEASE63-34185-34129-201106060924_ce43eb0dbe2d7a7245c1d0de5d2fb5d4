package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_362:String = "TUI_NAME_VIEW";
      
      public static const const_392:String = "TUI_CLOTHES_VIEW";
      
      public static const const_609:String = "TUI_GUIDEBOT_VIEW";
      ...
      public function TutorialUI(param1:HabboHelp, param2:Boolean = true)
      {
         ...
         this.var_34.events.addEventListener(HabboHelpTutorialEvent.const_567,this.onTaskDoneEvent);
         this.var_34.events.addEventListener(HabboHelpTutorialEvent.const_560,this.onTaskDoneEvent);
         this.var_34.events.addEventListener(HabboHelpTutorialEvent.const_506,this.onTaskDoneEvent);
         if(this.var_34.sessionDataManager != null)
         {
            this.var_34.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_334,this.onFigureUpdate);
         }
      }
      ...
      {
         return this.var_1214 && this.var_1215 && this.var_1503;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_34)
         {
            this.var_34.events.removeEventListener(HabboHelpTutorialEvent.const_567,this.onTaskDoneEvent);
            this.var_34.events.removeEventListener(HabboHelpTutorialEvent.const_560,this.onTaskDoneEvent);
            this.var_34.events.removeEventListener(HabboHelpTutorialEvent.const_506,this.onTaskDoneEvent);
            if(this.var_34.sessionDataManager != null)
            {
               this.var_34.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_334,this.onFigureUpdate);
            }
            this.var_34 = null;
         }
      }
      ...
      public function update(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         ...
         if(this.var_45 == null || this.var_45.id == const_95)
         {
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_567:
               this.var_1503 = true;
               if(this.var_45 != null && this.var_45.id == const_609)
               {
                  this.showView(const_95);
               }
               break;
            case HabboHelpTutorialEvent.const_560:
               if(this.var_45 != null && this.var_45.id == const_392)
               {
                  this.var_1846 = true;
                  this.disposeWindow();
               }
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_2423 = this._window.width - _loc2_.width;
         ...
         this._window.height = _loc2_.height + this.var_2422;
         this._window.width = _loc2_.width + this.var_2423;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function prepareForTutorial() : void
      {
         ...
         this.var_34.hideUI();
         this.var_34.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_134));
      }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_45 != null && (this.var_45.id == const_362 || this.var_45.id == const_95))
         {
            this.showView(const_95);
         }
      }
      ...
      {
         this.var_1214 = true;
         if(this.var_45 != null && (this.var_45.id == const_392 || this.var_45.id == const_95))
         {
            this.showView(const_95);
         }
      }
      ...
      public function onChangeUserNameResult(param1:ChangeUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode == ChangeUserNameResultMessageEvent.var_582)
         {
            this.var_1215 = true;
