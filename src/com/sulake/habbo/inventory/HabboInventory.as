package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_2294:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_55)
         {
            _loc1_ = this.var_55.getKeys();
            _loc2_ = 0;
            while(_loc2_ < _loc1_.length)
            {
               _loc3_ = _loc1_[_loc2_];
               _loc4_ = this.var_55.getValue(_loc3_) as IInventoryModel;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
         ...
         if(this.var_16 != null)
         {
            this.var_16.events.removeEventListener(RoomSessionEvent.const_76,this.roomSessionEventHandler);
            this.var_16.events.removeEventListener(RoomSessionEvent.const_87,this.roomSessionEventHandler);
            this.var_16.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_588,this.roomSessionEventHandler);
      ...
      public function get furniModel() : FurniModel
      {
         ...
         return FurniModel(this.var_55.getValue(InventoryCategory.const_78));
      }
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_55.getValue(InventorySubCategory.const_345));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_55.getValue(InventoryCategory.const_862));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_55.getValue(InventoryCategory.const_295));
      }
      ...
      public function get achievementsModel() : AchievementsModel
      {
         ...
         return AchievementsModel(this.var_55.getValue(InventoryCategory.ACHIEVEMENTS));
      }
      ...
      public function get recyclerModel() : RecyclerModel
      {
         ...
         return RecyclerModel(this.var_55.getValue(InventorySubCategory.const_1136));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_55.getValue(InventoryCategory.const_139));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_55.getValue(InventoryCategory.const_403) as MarketplaceModel;
      }
      ...
      {
         this.var_395 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_16.events.addEventListener(RoomSessionEvent.const_76,this.roomSessionEventHandler);
         this.var_16.events.addEventListener(RoomSessionEvent.const_87,this.roomSessionEventHandler);
         this.var_16.events.addEventListener(RoomSessionPropertyUpdateEvent.const_588,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_87:
               this.var_1281 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_588:
               if(this.petsModel != null)
               {
                  this.petsModel.updatePetsAllowed();
               }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_395 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_16 || !this._toolbar || !this._soundManager)
         {
            return;
         }
         ...
         this.var_55.add(InventoryCategory.const_403,_loc1_);
         ...
         this.var_55.add(InventoryCategory.const_78,_loc2_);
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_395);
         this.var_55.add(InventoryCategory.const_295,_loc3_);
         ...
         this.var_55.add(InventoryCategory.const_862,_loc4_);
         var _loc5_:AchievementsModel = new AchievementsModel(this,this._windowManager,this._communication,this._assetLibrary,this._localization,this.var_395);
         this.var_55.add(InventoryCategory.ACHIEVEMENTS,_loc5_);
         ...
         this.var_55.add(InventorySubCategory.const_345,_loc6_);
         ...
         this.var_55.add(InventorySubCategory.const_1136,_loc7_);
         ...
         this.var_55.add(InventoryCategory.const_139,_loc8_);
      ...
      {
         var _loc2_:IInventoryModel = IInventoryModel(this.var_55.getValue(param1));
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < this.var_55.length)
         {
            _loc3_ = this.var_55.getWithIndex(_loc2_) as IInventoryModel;
            _loc3_.subCategorySwitch(param1);
            _loc2_++;
         }
         switch(param1)
         {
            case InventorySubCategory.const_345:
      ...
      public function closingInventoryView() : void
      {
         ...
         {
            _loc2_ = this.var_55.getWithIndex(_loc1_) as IInventoryModel;
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_1100.indexOf(param1) == -1)
            {
         ...
         {
            _loc3_ = this.var_1100.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_1100.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_1100.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         var _loc2_:IInventoryModel = this.var_55.getValue(param1) as IInventoryModel;
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_2294);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_381));
      }
      ...
      public function updateUnseenItemCounts() : void
      {
         ...
         if(_loc1_ != this.var_2952)
         {
            this.var_2952 = _loc1_;
