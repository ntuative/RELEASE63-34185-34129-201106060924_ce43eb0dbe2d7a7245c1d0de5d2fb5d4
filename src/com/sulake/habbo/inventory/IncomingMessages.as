package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      public function IncomingMessages(param1:HabboInventory)
      {
         super();
         this.var_13 = param1;
         this.var_25 = this.var_13.communication;
         ...
         this.var_25.addHabboConnectionMessageEvent(new UnseenItemsEvent(this.onUnseenItems));
      }
      ...
      public function onFurniList(param1:IMessageEvent) : void
      {
         ...
         _loc3_.insertFurniList(_loc2_.method_9,_loc2_.getFurni(),_loc2_.totalFragments,_loc2_.fragmentNo);
      }
      ...
      public function onFurniListUpdate(param1:IMessageEvent) : void
      {
         ...
         this.var_13.setInventoryCategoryInit(InventoryCategory.const_78,false);
      }
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            if(_loc6_.secondsLeftIfActive >= 0)
            {
               ...
               _loc7_.method_4 = _loc6_.secondsLeftIfActive;
               ++_loc7_.effectsInInventory;
            }
            else if(_loc6_.secondsLeftIfActive == -1)
            {
               _loc7_.isActive = false;
               _loc7_.method_4 = _loc6_.duration;
            }
            _loc2_.addEffect(_loc7_,false);
            _loc5_++;
         }
         this.var_13.setInventoryCategoryInit(InventoryCategory.const_862);
         _loc2_.refreshViews();
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         _loc3_.updateView();
         this.var_13.setInventoryCategoryInit(InventoryCategory.const_295);
      }
      ...
      {
         if(this.var_13.isStandaloneAchievementListEnabled())
         {
            return;
         }
         ...
         var _loc4_:AchievementsModel = this.var_13.achievementsModel;
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.setAchievements(_loc3_.achievements);
         this.var_13.setInventoryCategoryInit(InventoryCategory.ACHIEVEMENTS);
      }
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         this.var_13.toggleInventorySubPage(InventorySubCategory.const_345);
      ...
      private function onTradingItemList(param1:IMessageEvent) : void
      {
         ...
         while(_loc10_ < _loc5_)
         {
            ...
            if(_loc9_.category == FurniCategory.const_222)
            {
      ...
      private function onPets(param1:PetInventoryEvent) : void
      {
         ...
         this.var_13.setInventoryCategoryInit(InventoryCategory.const_139);
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this.var_13.setInventoryCategoryInit(InventoryCategory.const_403);
      ...
      {
         var _loc2_:* = null;
         if(this.var_13.isInventoryCategoryInit(InventoryCategory.const_403))
         {
      ...
      private function onUnseenItems(param1:UnseenItemsEvent) : void
      {
         ...
         this.var_13.furniModel.addUnseenFloorItems(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_428));
         this.var_13.furniModel.addUnseenWallItems(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_420));
         this.var_13.petsModel.addUnseenPets(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_57));
         this.var_13.badgesModel.addUnseenBadges(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_1219));
