package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private var var_1796:IWindowContainer;
      
      private var var_765:String;
      
      private var var_2444:IWindowContainer;
      ...
      private var var_1795:IWindowContainer;
      
      private const const_2003:Point = new Point(120,150);
      ...
      {
         return !!this.var_17 ? Boolean(this.var_17.getStateFlag(WindowState.const_93)) : false;
      }
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         this._controller.inventoryViewOpened(this.var_765);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true, param3:Boolean = false) : void
      {
         ...
         else
         {
            ...
            _loc4_.visible = true;
            _loc4_.activate();
            if(param1 != this.var_367 || !this._controller.isInventoryCategoryInit(param1))
            {
               this.setViewToCategory(param1);
            }
      ...
      public function updateSubCategoryView() : void
      {
         ...
         this.setSubViewToCategory(this.var_765);
      }
      ...
      private function resetUnseenCounters(param1:String) : void
      {
         switch(param1)
         {
            ...
            case InventoryCategory.const_139:
               ...
               break;
            case InventoryCategory.const_295:
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         _loc2_.container.removeChild(this.var_1796);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_367 == InventoryCategory.const_139)
            {
               this.toggleCategoryView(InventoryCategory.const_139);
            }
            else if(this.var_367 == InventoryCategory.const_78)
            {
      ...
      private function updateUnseenBadgeCount() : void
      {
         if(!this.var_1795)
         {
            this.var_1795 = this.createCounter("badges");
         }
         var _loc1_:int = this._controller.badgesModel.getUnseenItemCount();
         this.updateCounter(this.var_1795,_loc1_);
      ...
      private function createCounter(param1:String) : IWindowContainer
      {
         ...
         if(_loc4_)
         {
            ...
            _loc3_.x = _loc4_.width - _loc3_.width - const_1027;
            _loc3_.y = const_1027;
         }
         return _loc3_;
      }
