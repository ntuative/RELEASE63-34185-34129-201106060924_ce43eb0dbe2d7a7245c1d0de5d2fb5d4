package com.sulake.habbo.inventory
{
   ...
   public class ItemPopupCtrl
   {
      ...
      private static const const_1032:int = 5;
      
      private static const const_1433:int = 250;
      
      private static const const_1434:int = 100;
      
      private static const const_1436:int = 180;
      
      private static const const_1435:int = 200;
      ...
      {
         this.var_357 = new Timer(const_1433,1);
         this.var_356 = new Timer(const_1434,1);
         super();
         if(param1 == null)
         {
            return;
         ...
         {
            this.var_933 = _loc3_.content as BitmapData;
         }
         _loc3_ = this._assets.getAssetByName("popup_arrow_left_png") as BitmapDataAsset;
         if(_loc3_ != null && _loc3_.content != null)
         {
            this.var_756 = _loc3_.content as BitmapData;
         }
      }
      ...
      public function updateContent(param1:IWindowContainer, param2:String, param3:BitmapData, param4:int = 2) : void
      {
         ...
         if(_loc6_)
         {
            _loc7_ = new BitmapData(Math.min(const_1436,param3.width),Math.min(const_1435,param3.height),true,16777215);
      ...
      public function show() : void
      {
         ...
         this.refreshArrow(this.var_1756);
         switch(this.var_1756)
         {
            case const_1296:
               this.var_84.x = -1 * this.var_84.width - const_1032;
               break;
            case const_533:
               this.var_84.x = this._parent.width + const_1032;
         }
      ...
      private function refreshArrow(param1:int = 2) : void
      {
         ...
         {
            case const_1296:
               _loc2_.bitmap = this.var_933.clone();
               _loc2_.width = this.var_933.width;
               _loc2_.height = this.var_933.height;
               _loc2_.y = (this.var_84.height - this.var_933.height) / 2;
               _loc2_.x = this.var_84.width - 1;
               break;
            case const_533:
               _loc2_.bitmap = this.var_756.clone();
               _loc2_.width = this.var_756.width;
               _loc2_.height = this.var_756.height;
               _loc2_.y = (this.var_84.height - this.var_756.height) / 2;
               _loc2_.x = -1 * this.var_756.width + 1;
         }
         _loc2_.invalidate();
      }
