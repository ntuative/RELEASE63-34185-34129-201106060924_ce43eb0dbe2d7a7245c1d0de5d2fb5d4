package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      public static const const_1720:int = -1;
      ...
      private const const_2252:int = 5;
      ...
      public function BadgesModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:ISessionDataManager)
      {
         ...
         this.var_395 = param5;
         this.var_395.events.addEventListener(BadgeImageReadyEvent.const_114,this.onBadgeImageReady);
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < this.var_730.length)
         {
            if(this.var_730[_loc2_] == param1)
            {
      ...
      public function updateBadge(param1:String, param2:Boolean, param3:int = 0) : void
      {
         ...
         if(param3 > 0)
         {
            this.var_1126.add(param1,param3);
         }
         ...
         else
         {
            ...
            _loc10_ = this.var_593.indexOf(param3) != -1;
            _loc11_ = new Badge(param1,_loc7_,_loc10_);
            _loc11_.iconImage = this.var_395.getBadgeImage(param1);
            if(_loc10_)
            {
               this.var_226.unshift(_loc11_);
            }
            else
            {
               this.var_226.push(_loc11_);
            }
            if(param2)
            {
      ...
      private function getBadge(param1:String) : Badge
      {
         var _loc3_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_226.length)
         {
            _loc3_ = this.var_226[_loc2_];
      ...
      public function saveBadgeSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_339);
         var _loc3_:int = 0;
      ...
      public function setBadgeSelected(param1:String) : void
      {
         ...
         while(_loc2_ < this.var_226.length)
         {
            _loc3_ = this.var_226[_loc2_] as Badge;
            if(_loc3_ != null)
            {
      ...
      public function forceSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_619);
         ...
         var _loc3_:Array = this.getBadges(const_339);
      ...
      public function getBadges(param1:int = -1) : Array
      {
         ...
         switch(param1)
         {
            ...
            case const_619:
               _loc2_ = new Array();
               for each(_loc3_ in this.var_226)
               {
                  if(!_loc3_.isInUse)
                  {
                     _loc2_.push(_loc3_);
      ...
      {
         return this.getItemInIndex(param1,const_339);
      }
      
      public function getBadgeFromInactive(param1:int) : Badge
      {
         return this.getItemInIndex(param1,const_619);
      }
      ...
      {
         if(param1 == InventoryCategory.const_295 && this._controller.isVisible)
         {
      ...
      public function addUnseenBadges(param1:Array) : void
      {
         ...
         {
            if(this.var_593.indexOf(_loc2_) == -1)
            {
      ...
      public function resetUnseenItems() : void
      {
         ...
         if(this.var_593 && this.var_593.length > 0)
         {
            _loc1_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_1219));
            this.var_593 = [];
