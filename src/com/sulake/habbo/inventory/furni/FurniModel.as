package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel extends FurniModelCategory implements IInventoryModel
   {
      ...
      private static const const_1468:int = 100;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_444 = [];
         this.var_443 = [];
         this.var_626 = new Timer(const_1468,1);
         this.var_626.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc9_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc10_:XmlAsset = XmlAsset(_loc9_);
         this.var_2446 = XML(_loc10_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               this.var_626.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_626.stop();
               this.var_626 = null;
            }
            if(this.var_207 != null)
            {
               this.var_207.removeEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
               this.var_207.stop();
               this.var_207 = null;
            }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc12_:* = null;
         var _loc13_:* = null;
         if(param3 == FurniCategory.const_369)
         {
         ...
         else if(param3 == FurniCategory.const_343)
         {
         ...
         if(this.var_766 == null)
         {
            this.var_766 = this._windowManager.buildFromXML(this.var_2446) as IWindowContainer;
            _loc12_ = this._assets.getAssetByName("thumb_selected_outline_png") as BitmapDataAsset;
            _loc13_ = this.var_766.findChildByName("outline") as IBitmapWrapperWindow;
            _loc13_.bitmap = _loc12_.content as BitmapData;
            _loc13_.disposesBitmap = false;
         }
         var _loc11_:IWindowContainer = this.var_766.clone() as IWindowContainer;
      ...
      public function initListImages() : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:int = 0;
         var _loc4_:Array = [const_39,const_46];
         var _loc5_:int = 0;
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            this.var_207 = new Timer(param1,1);
            this.var_207.addEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
            this.var_207.start();
         }
         else
         {
         ...
         if(param1 == InventoryCategory.const_78 && this._controller.isVisible)
         {
            switch(this._view.visibleCategoryId)
            {
               ...
               case const_46:
                  ...
                  break;
               case const_297:
                  this._controller.toggleInventoryPage(InventoryCategory.const_139);
            }
         }
      }
      ...
      {
         this.var_2447 = getTimer();
         this.switchCategory(const_297);
      }
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_403);
      ...
      public function updateItemLocks() : void
      {
         ...
         var _loc7_:Array = [const_39,const_46];
         var _loc8_:int = 0;
      ...
      public function addLockTo(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc7_:int = 0;
         var _loc5_:Array = [const_39,const_46];
         var _loc6_:int = 0;
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_627.add(const_39,new Array());
         this.var_627.add(const_46,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1, param4:Boolean = false) : void
      {
         ...
         {
            _loc6_ = const_39;
            _loc5_ = this.var_444.indexOf(param1.ref) > -1;
         }
         else
         {
            ...
            _loc6_ = const_46;
            _loc5_ = this.var_443.indexOf(param1.ref) > -1;
         }
         ...
         else
         {
            ...
            for(; _loc10_ < _loc8_.length; _loc10_++)
            {
               ...
               if(_loc9_.type == param1.type)
               {
                  if(param1.category != FurniCategory.const_222)
                  {
                     _loc7_ = _loc9_;
                  }
         ...
         if(param4)
         {
            if(this._view.visibleCategoryId == const_297)
            {
      ...
      {
         return getTimer() < this.var_2447 + const_1467;
      }
      ...
      {
         return this._controller.getSubCategoryViewId() == InventorySubCategory.const_345;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_314 || _loc3_.category == FurniCategory.const_369 || _loc3_.category == FurniCategory.const_343)
         {
            if(param1)
            {
               return false;
      ...
      {
         return this.var_627.getValue(param1);
      }
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc3_:Array = this.var_627.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            _loc4_ = 0;
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.category == FurniCategory.const_854)
               {
                  _loc6_ = 1;
               }
               _loc7_ = 0;
      ...
      public function addUnseenFloorItems(param1:Array) : void
      {
         ...
         {
            if(this.var_444.indexOf(_loc2_) == -1)
            {
               this.var_444.push(_loc2_);
            }
         }
      }
      ...
      public function addUnseenWallItems(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            if(this.var_443.indexOf(_loc2_) == -1)
            {
               this.var_443.push(_loc2_);
            }
         }
      }
      ...
      public function getUnseenItemCount(param1:int = 0) : int
      {
         switch(param1)
         {
            case UnseenItemCategoryEnum.const_428:
               return this.var_444.length;
            case UnseenItemCategoryEnum.const_420:
               return this.var_443.length;
            default:
               return this.var_444.length + this.var_443.length;
         }
      }
      ...
      public function resetUnseenItems(param1:String = null) : void
      {
         ...
         {
            case const_46:
               if(this.var_443 && this.var_443.length > 0)
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_420));
                  this.var_443 = [];
                  _loc3_ = this.getCategoryContent(param1);
               }
               break;
            case const_39:
               if(this.var_444 && this.var_444.length > 0)
               {
