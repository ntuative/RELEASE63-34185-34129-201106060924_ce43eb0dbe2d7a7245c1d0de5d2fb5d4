package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private static const const_1449:int = 13421772;
      
      private static const const_1448:int = 10275685;
      ...
      protected var var_2200:String;
      
      protected var var_1441:Number;
      
      protected var var_897:int = 0;
      
      protected var var_722:BitmapData;
      ...
      protected var var_2978:BitmapData;
      
      private var var_1455:Boolean;
      
      private const const_1995:Number = 1;
      
      private const const_1996:Number = 0.2;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this.var_2403 = this._window.findChildByName("outline");
         this._roomEngine = param5;
         this.var_2978 = param6;
         this.var_2198 = param7;
         this._items = new Map();
         this.var_2199 = param2;
         this._category = param3;
         this.var_2200 = param8;
         this.var_1441 = param9;
         if(param10 != null)
         {
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2199 == FurniModelCategory.const_39)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1441));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2200);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_854)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      public function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1996;
               _loc1_.blend = this.const_1996;
            }
            else
            {
               this._window.blend = this.const_1995;
               _loc1_.blend = this.const_1995;
            }
         }
         this.var_1487.color = !!this.var_1455 ? uint(const_1448) : uint(const_1449);
         this.var_2403.visible = this.isSelected;
         ...
         if(_loc5_)
         {
            if(this.var_2198 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2978;
               _loc5_.visible = true;
            }
            else
            {
