package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_44:
               this.var_1510.setSelectedGridItem(this);
               this.var_1509 = true;
               break;
            ...
            case WindowMouseEvent.const_25:
               ...
               {
                  this.var_1509 = false;
                  this.var_1510.placePetToRoom(this._petData.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         if(!this._window || !this.var_1487)
         {
            return;
         }
         this.var_1487.color = !!this.var_1621 ? uint(const_1448) : uint(const_1449);
         this.var_2403.visible = param1;
      }
