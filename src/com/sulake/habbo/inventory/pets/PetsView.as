package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      private const const_1999:int = 0;
      
      private const const_1038:int = 1;
      
      private const const_1034:int = 2;
      
      private const const_1039:int = 3;
      ...
      private var var_223:PetsGridItem;
      ...
      public function update() : void
      {
         ...
         this.updateGrid();
         this.updatePreview(this.var_223);
      }
      
      public function removePet(param1:int) : void
      {
         var _loc2_:PetsGridItem = this.var_565.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         this.var_217.removeGridItem(_loc2_.window);
         if(this.var_223 == _loc2_)
         {
            this.var_223 = null;
            this.selectFirst();
         }
      ...
      {
         if(this.var_565 == null || this.var_565.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_565.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_565.getValue(param1.id) != null)
         {
            return;
         }
         var _loc2_:PetsGridItem = new PetsGridItem(this,param1,this._windowManager,this._assetLibrary,this._avatarRenderer,this.var_73.isUnseen(param1.id));
         if(_loc2_ != null)
         {
            this.var_217.addGridItem(_loc2_.window);
            this.var_565.add(param1.id,_loc2_);
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = this.var_223.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         this.var_73.placePetToRoom(param1,param2);
      }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowEvent.const_50)
         {
            ...
            {
               case "tab_floor":
                  this.var_73.switchToFurnitureCategory(FurniModelCategory.const_39);
                  break;
               case "tab_wall":
                  this.var_73.switchToFurnitureCategory(FurniModelCategory.const_46);
            }
            this.selectPetsTab();
         }
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(this.var_223 != null)
         {
            this.var_223.setSelected(false);
         }
         this.var_223 = param1;
         if(this.var_223 != null)
         {
            this.var_223.setSelected(true);
         }
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Map = this.var_73.pets;
         if(!this.var_73.isListInitialized())
         {
            _loc2_ = this.const_1038;
         }
         else if(!_loc1_ || _loc1_.length == 0)
         {
            _loc2_ = this.const_1034;
         }
         else
         {
            _loc2_ = this.const_1039;
         }
         ...
         switch(_loc2_)
         {
            case this.const_1038:
               _loc3_.visible = true;
               _loc4_.visible = false;
               _loc5_.visible = false;
               _loc6_.visible = false;
               break;
            case this.const_1034:
               _loc3_.visible = false;
               _loc4_.visible = true;
               _loc5_.visible = false;
               _loc6_.visible = false;
               break;
            case this.const_1039:
               _loc3_.visible = false;
               _loc4_.visible = false;
               _loc5_.visible = true;
               _loc6_.visible = true;
      ...
      private function updatePreview(param1:PetsGridItem = null) : void
      {
         ...
         if(this.var_73.roomSession != null)
         {
            _loc8_ = this.var_73.roomSession.arePetsAllowed;
            _loc9_ = this.var_73.roomSession.isRoomOwner;
         }
         var _loc10_:String = "";
         if(!_loc9_)
         {
      ...
      public function getPetImage(param1:int, param2:int, param3:String, param4:int, param5:Boolean) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc8_ = this._avatarRenderer.createPetImage(param1,param2,_loc7_,AvatarScaleType.const_60,this);
            if(_loc8_ != null)
            {
               ...
               {
                  _loc6_ = _loc8_.getCroppedImage(AvatarSetType.const_53);
               }
               _loc8_.dispose();
            }
         }
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_73.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_428) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_wall");
         _loc1_.visible = this.var_73.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_420) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_pets");
         _loc1_.visible = this.var_73.getUnseenItemCount() > 0;
      }
   }
}
