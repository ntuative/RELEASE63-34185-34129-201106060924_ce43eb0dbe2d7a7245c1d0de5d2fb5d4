package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1852:uint = 9;
      ...
      public static const const_251:uint = 5;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_59.updateItemList(this.var_877);
         this.var_59.updateItemList(this.var_1641);
      ...
      public function close() : void
      {
         if(this.var_798)
         {
            if(this._state != const_225 && this._state != const_251)
            {
      ...
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_878 + " OTHER: " + this.var_1356);
         ...
         {
            case const_225:
               if(param1 == const_202 || param1 == const_251)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function getOwnItemIdsInTrade() : Array
      {
         ...
         if(this.var_290 == null || this.var_290.disposed)
         {
            return _loc1_;
         }
         var _loc4_:int = 0;
         ...
         {
            _loc2_ = this.var_290.getWithIndex(_loc4_) as GroupItem;
            if(_loc2_ != null)
            {
               _loc5_ = 0;
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_59.alertPopup(TradingView.const_1185);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_877)
            {
               this.var_878 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1356 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_59.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_877)
            {
               this.var_59.alertPopup(TradingView.const_1277);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_290.length < const_1852)
         {
         ...
         else
         {
            ...
            if(this.var_290.getValue(_loc6_) == null)
            {
               return false;
            }
            this._communication.getHabboMainConnection(null).send(new AddItemToTradeComposer(param1));
