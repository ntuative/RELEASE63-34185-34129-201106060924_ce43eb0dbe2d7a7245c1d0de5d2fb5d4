package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1041:Array = [];
      
      private static var var_1959:int = 1000;
      
      private static var var_1040:Array = [];
      
      private static var var_1961:int = 200;
      ...
      private var var_1962:IMessageComposer;
      ...
      {
         this.var_830 = IWindowContainer(this.var_34.getXmlWindow("chatlog_roomheader"));
         this.var_831 = IWindowContainer(this.var_34.getXmlWindow("chatlog_chatline"));
         this.var_500 = new Timer(1000,1);
         ...
         this.var_34.connection.send(this.var_1962);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1041.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_831.clone());
      }
      
      private function storeChatLineWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_1041.length < var_1959)
         {
            ...
            param1.width = this.var_831.width;
            param1.height = this.var_831.height;
            var_1041.push(param1);
         }
         else
         {
            param1.dispose();
      ...
      private function getChatHeaderWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1040.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_830.clone());
      }
      
      private function storeChatHeaderWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_1040.length < var_1961)
         {
            _loc2_ = ITextWindow(param1.findChildByName("room_name_txt"));
            _loc2_.procedure = null;
            param1.width = this.var_830.width;
            param1.height = this.var_830.height;
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1960[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1575.getValue(param2.chatterName))
            {
               this.var_1575.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1575.getValue(_loc2_);
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1576)
         {
            this.storeChatLineWindow(_loc1_);
         }
         for each(_loc1_ in this.var_1574)
         {
