package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2269:String = "open_issues";
      
      private const const_2268:String = "picked_issues";
      
      private const const_2298:String = "closed_issues";
      ...
      private var var_376:IIssueBrowserView;
      
      private var var_1856:IIssueBrowserView;
      
      private var var_1854:IIssueBrowserView;
      
      private var var_1855:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_267 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_267.numTabItems)
            {
               _loc5_ = this.var_267.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_50,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_267 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_267 == null || this.var_267.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_267.selector.getSelectableByName("open_issues");
         this.var_267.selector.setSelected(_loc1_);
      }
      
      private function selectView(param1:String) : void
      {
         var _loc2_:IIssueBrowserView = this.getView(param1);
         if(this.var_376 == _loc2_)
         {
            return;
         }
         ...
         this.var_376.view.width = this.var_267.container.width;
         this.var_376.view.height = this.var_267.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2270:
               ...
               {
                  this.var_1856 = new MyIssuesView(this.issueManager,this,this.var_267.container);
               }
               return this.var_1856;
            case this.const_2269:
               if(this.var_1854 == null)
               {
                  this.var_1854 = new OpenIssuesView(this.issueManager,this,this.var_267.container);
               }
               return this.var_1854;
            case this.const_2268:
               if(this.var_1855 == null)
               {
                  this.var_1855 = new PickedIssuesView(this.issueManager,this,this.var_267.container);
               }
