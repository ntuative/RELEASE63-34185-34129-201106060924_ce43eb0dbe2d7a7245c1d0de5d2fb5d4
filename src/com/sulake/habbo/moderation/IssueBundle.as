package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_880:IssueMessageData = null;
      
      private var var_879:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2366 = param2.pickerUserId;
         this.var_2901 = param2.pickerUserName;
         this.var_1598 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1358 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1357;
         }
         if(this.var_880 == null || param1.timeStamp < this.var_880.timeStamp)
         {
            this.var_880 = param1;
         }
         if(this.var_879 == null || param1.priority > this.var_879.timeStamp)
         {
            this.var_879 = param1;
         }
      }
      ...
      public function removeIssue(param1:int) : IssueMessageData
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1358 -= _loc2_.priority;
            if(_loc2_.message != null && _loc2_.message != "")
            {
               --this.var_1357;
            }
            if(this.var_880 == _loc2_)
            {
               this.var_880 = null;
            }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_879;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_880;
         if(_loc2_ == null)
         {
