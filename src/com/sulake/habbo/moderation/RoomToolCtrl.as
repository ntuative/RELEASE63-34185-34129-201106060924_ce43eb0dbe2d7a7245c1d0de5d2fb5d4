package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1129:IDropMenuWindow;
      
      private var var_567:ITextFieldWindow;
      
      private var var_633:Boolean = true;
      
      private var var_906:ICheckBoxWindow;
      
      private var var_1406:ICheckBoxWindow;
      
      private var var_1407:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_34.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_383));
         Logger.log("BEGINNING TO SHOW: " + this.var_383);
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + this.var_383);
         if(param1.flatId != this.var_383)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + this.var_383);
            return;
         }
         this._data = param1;
         this.populate();
      ...
      public function populate() : void
      {
         ...
         this.var_567 = ITextFieldWindow(this._frame.findChildByName("message_input"));
         this.var_567.procedure = this.onInputClick;
         this.var_1129 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1129);
         this.var_1129.procedure = this.onSelectTemplate;
         this.var_906 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1406 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1407 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new UserInfoFrameCtrl(this.var_34,this._data.method_2),this._frame,false,false,true);
      }
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_34,WindowTracker.const_822,this._data.flatId),this._frame,false,false,true);
      }
      ...
      {
         if(this.var_633 || this.var_567.text == "")
         {
            this.var_34.windowManager.alert("Alert","You must input a message to the user",0,this.onAlertClose);
            return;
         }
         var _loc2_:int = this.determineAction(param1,this.var_906.isSelected);
         this.var_34.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1706,_loc2_,this.var_567.text,"",""));
         if(this.var_1406.isSelected || this.var_1407.isSelected || this.var_906.isSelected)
         {
            this.var_34.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1406.isSelected,this.var_1407.isSelected,this.var_906.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1748);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1857);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_34.initMsg.roomMessageTemplates[this.var_1129.selection];
         if(_loc3_ != null)
         {
            this.var_633 = false;
            this.var_567.text = _loc3_;
         }
      }
   }
}
