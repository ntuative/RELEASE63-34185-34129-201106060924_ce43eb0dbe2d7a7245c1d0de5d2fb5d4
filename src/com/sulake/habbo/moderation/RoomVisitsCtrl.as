package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_969:Array = [];
      
      private static var var_1841:int = 200;
      ...
      {
         this.var_781 = IWindowContainer(this.var_34.getXmlWindow("roomvisits_row"));
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_969.pop() as IWindowContainer;
         }
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1489)
         {
