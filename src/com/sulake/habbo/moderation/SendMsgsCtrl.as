package com.sulake.habbo.moderation
{
   ...
   public class SendMsgsCtrl implements IDisposable, TrackedWindow
   {
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Msg To: " + this.var_1725;
      ...
      {
         return WindowTracker.const_1955;
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_34.initMsg.messageTemplates[this.var_1129.selection];
         if(_loc3_ != null)
         {
            this.var_633 = false;
      ...
      private function onSendMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.connection.send(new ModMessageMessageComposer(this.var_1612,this.var_567.text,this.var_1611));
         this.dispose();
      }
