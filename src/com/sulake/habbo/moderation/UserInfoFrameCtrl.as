package com.sulake.habbo.moderation
{
   ...
   public class UserInfoFrameCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1177:UserInfoCtrl;
      ...
      public function show() : void
      {
         ...
         this.var_1177 = new UserInfoCtrl(this._frame,this.var_34,"",true);
         this.var_1177.load(this._frame.content,this._userId);
         this._frame.visible = true;
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1880;
      }
