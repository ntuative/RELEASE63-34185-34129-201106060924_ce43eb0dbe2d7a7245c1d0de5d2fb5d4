package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_1955:int = 2;
      
      public static const const_1327:int = 3;
      
      public static const const_822:int = 4;
      ...
      public static const const_1765:int = 9;
      ...
      {
         var _loc2_:Dictionary = this.var_2135[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            this.var_2135[param1] = _loc2_;
         }
         return _loc2_;
      }
   }
