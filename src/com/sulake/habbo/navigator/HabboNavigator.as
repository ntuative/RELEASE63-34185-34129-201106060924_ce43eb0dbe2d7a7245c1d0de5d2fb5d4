package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_682:RoomInfoViewCtrl;
      
      private var var_1292:RoomCreateViewCtrl;
      
      private var _data:NavigatorData;
      
      private var var_453:Tabs;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_682 = new RoomInfoViewCtrl(this);
         this.var_1292 = new RoomCreateViewCtrl(this);
         this.var_2743 = new RoomThumbnailRenderer(this);
         this.var_1001 = new GuestRoomPasswordInput(this);
         this.var_306 = new GuestRoomDoorbell(this);
         this.var_453 = new Tabs(this);
         this.var_1293 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_326,HabboWindowStyle.const_48,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_49)
         {
            ...
            {
               this.var_320.onNavigatorToolBarIconClick();
            }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_320.startSearch(Tabs.const_200,Tabs.const_411,param1);
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_320.startSearch(Tabs.const_280,Tabs.const_272);
         this.var_453.getTab(Tabs.const_280).tabPageDecorator.tabSelected();
      }
