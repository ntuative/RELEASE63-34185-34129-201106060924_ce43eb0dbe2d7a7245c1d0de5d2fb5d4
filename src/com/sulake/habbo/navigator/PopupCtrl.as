package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function PopupCtrl(param1:HabboNavigator, param2:int, param3:int, param4:String)
      {
         ...
         this.var_455.addEventListener(TimerEvent.TIMER,this.onDisplayTimer);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_455)
         {
            this.var_455.removeEventListener(TimerEvent.TIMER,this.onDisplayTimer);
            this.var_455.reset();
            this.var_455 = null;
         }
         if(this.var_382)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_57 == null)
         {
            this.var_57 = IWindowContainer(this._navigator.getXmlWindow(this.var_1111));
            this.var_57.visible = false;
            this.var_57.setParamFlag(HabboWindowParam.const_47,true);
         ...
         this.var_57.x = _loc2_.x + this.var_2619 + param1.width;
