package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1499:CutToWidth = new CutToWidth();
      
      private static var var_2531:CutToHeight = new CutToHeight();
      ...
      public static function setProc(param1:IWindowContainer, param2:String, param3:Function) : void
      {
         ...
         _loc4_.setParamFlag(HabboWindowParam.const_47,true);
      ...
      public static function cutTextToWidth(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1499.beforeSearch(param2,param1,param3);
         binarySearch(var_1499,param2.length - 1);
      }
