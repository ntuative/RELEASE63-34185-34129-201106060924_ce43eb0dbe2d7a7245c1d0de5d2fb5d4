package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_229,Tabs.const_429);
         }
         else if(_loc1_ == 1)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_229,Tabs.const_888);
         }
         else
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_229,Tabs.const_429,"" + _loc3_);
         }
         if(this.var_152)
         {
