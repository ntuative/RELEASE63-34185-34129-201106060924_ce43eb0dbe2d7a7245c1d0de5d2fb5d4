package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1350:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_702 = new Timer(100);
         this.var_702.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
         this.var_44 = new Array();
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_59,104,"a"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_59,94,"b"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_59,36,"c"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_59,84,"d"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_59,80,"e"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_59,80,"f"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_59,416,"i"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_59,320,"j"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_59,448,"k"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_59,352,"l"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_59,384,"m"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_59,372,"n"));
      ...
      public function dispose() : void
      {
         if(this.var_702)
         {
            this.var_702.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_702.reset();
            this.var_702 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1350.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_2099 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_2099 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_198 = IWindowContainer(this._navigator.getXmlWindow("roc_create_room"));
         this.var_62 = IItemListWindow(this.var_198.findChildByName("item_list"));
         ...
         var _loc3_:IWindow = this.var_198.findChildByTag("close");
         this.addMouseClickListener(_loc3_,this.onCancelButtonClick);
         this.var_1351 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_198.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
         var _loc4_:Rectangle = Util.getLocationRelativeTo(this.var_198.desktop,this.var_198.width,this.var_198.height);
         this.var_198.x = _loc4_.x;
         this.var_198.y = _loc4_.y;
      }
      
      public function refresh() : void
      {
         this.var_1351.goBackToInitialState();
         this.var_1351.input.textBackgroundColor = 4294967295;
         this.var_1350 = this.var_44[0];
         this.refreshRoomThumbnails();
      ...
      private function addThumbnail(param1:IWindowContainer, param2:RoomLayout, param3:Boolean) : void
      {
         ...
         _loc6_.setParamFlag(HabboWindowParam.const_47,false);
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_88,HabboWindowStyle.const_32,HabboWindowParam.const_68,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1351.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      
      private function getCreateButton() : IButtonWindow
      {
         return IButtonWindow(this.var_198.findChildByName("create_button"));
      }
      
      private function getCancelButton() : IButtonWindow
      {
         return IButtonWindow(this.var_198.findChildByName("back_button"));
      }
      ...
      {
         var _loc2_:String = this.var_1351.getText();
         var _loc3_:String = "model_" + this.var_1350.name;
