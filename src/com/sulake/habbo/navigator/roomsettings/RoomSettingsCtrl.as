package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_940:TextFieldManager;
      ...
      private var var_1240:ICheckBoxWindow;
      
      private var var_1246:ICheckBoxWindow;
      
      private var var_1243:ICheckBoxWindow;
      
      private var var_813:ICheckBoxWindow;
      
      private var var_1905:ITextWindow;
      
      private var var_1002:IDropMenuWindow;
      
      private var var_1003:IDropMenuWindow;
      
      private var var_2626:IWindowContainer;
      ...
      {
         this.var_383 = param1;
         this._navigator.send(new GetRoomSettingsMessageComposer(this.var_383));
         if(this.var_1244 != null)
         {
            this.var_1244.visible = false;
         }
      }
      
      public function method_10(param1:RoomSettingsData) : void
      {
         if(param1.roomId != this.var_383)
         {
            return;
         }
         this.var_53 = param1;
      ...
      {
         if(param1 != this.var_383 || this.var_1247 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1247 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1833)
         {
            this.var_811.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1911)
         {
            this.var_811.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1669)
         {
            this.var_1239.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1916)
         {
            this.setTagError(this.var_940,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_942,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1908)
         {
            this.setTagError(this.var_940,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_942,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1945)
         {
            this.var_1001.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_811.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function clearErrors() : void
      {
         ...
         this.var_940.clearErrors();
         this.var_942.clearErrors();
         this.var_1001.clearErrors();
         this.var_1245.clearErrors();
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_555,this.onDoorModePasswordUnselect);
         ...
         this.var_811 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1239 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_940 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_942 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_1001 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1245 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1240 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1246 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1243 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_813 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1905 = this._window.findChildByName("hide_walls_text") as ITextWindow;
         this.var_1002 = IDropMenuWindow(this._window.findChildByName("wall_thickness"));
         this.var_1003 = IDropMenuWindow(this._window.findChildByName("floor_thickness"));
         this.var_2626 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1242 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1241 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1907 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1540 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_234 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1244 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_1542 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1542.mouseThreshold = 0;
         this.var_1542.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1244.visible = false;
         if(!this.var_1541)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1907.visible = this.var_1541;
         this.populateForm();
         if(this.var_812)
         {
            this.var_1241.visible = true;
            this.var_1540.visible = true;
            this.refreshFlatControllers();
            this.var_1241.height = Util.getLowestPoint(this.var_1241) + 4;
         }
         else
         {
            this.var_1242.visible = true;
            this.var_1540.visible = true;
            this.var_2626.visible = this.var_1541;
            this.var_1242.height = Util.getLowestPoint(this.var_1242) + 4;
         }
         this.var_1542.text = !!this.var_812 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1242.name,this.var_1241.name,this.var_1540.name,this.var_1907.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_811.setText(_loc1_.name);
         this.var_1239.setText(_loc1_.description);
         this.var_1001.setText("");
         this.var_1245.setText("");
         ...
         this.setTag(this.var_940,_loc1_.tags[0]);
         this.setTag(this.var_942,_loc1_.tags[1]);
         if(this.var_1240)
         {
            if(_loc1_.allowPets)
            {
               this.var_1240.select();
            }
            else
            {
               this.var_1240.unselect();
            }
         }
         if(this.var_1246)
         {
            ...
            {
               this.var_1246.select();
            }
            else
            {
               this.var_1246.unselect();
            }
         }
         if(this.var_1243)
         {
            ...
            {
               this.var_1243.select();
            }
            else
            {
               this.var_1243.unselect();
            }
         }
         if(!this.VIPFeaturesAllowed())
         {
            this.disableWindow(this.var_813);
            this.disableWindow(this.var_1002);
            this.disableWindow(this.var_1003);
            this.disableWindow(this.var_1905);
         }
         else
         {
            this.enableWindow(this.var_813);
            this.enableWindow(this.var_1002);
            this.enableWindow(this.var_1003);
            this.enableWindow(this.var_1905);
         }
         if(this.var_813)
         {
            if(_loc1_.hideWalls)
            ...
            {
               this.var_813.unselect();
            }
         }
         if(this.var_1002)
         {
            this.var_1002.selection = this.getThicknessSelectionIndex(_loc1_.wallThickness);
         }
         if(this.var_1003)
         {
            this.var_1003.selection = this.getThicknessSelectionIndex(_loc1_.floorThickness);
         }
         this.clearErrors();
      }
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_811.getText();
         _loc2_.description = this.var_1239.getText();
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               ...
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_600;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_127)
         {
            _loc8_ = this.var_1001.getText();
            _loc9_ = this.var_1245.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_1001.clearErrors();
               this.var_1245.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1240.isSelected;
         _loc2_.allowFoodConsume = this.var_1246.isSelected;
         _loc2_.allowWalkThrough = this.var_1243.isSelected;
         _loc2_.hideWalls = this.var_813.isSelected;
         _loc2_.wallThickness = this.var_1002.selection - 2;
         _loc2_.floorThickness = this.var_1003.selection - 2;
         _loc2_.tags = new Array();
         this.addTag(this.var_940,_loc2_.tags);
         this.addTag(this.var_942,_loc2_.tags);
         this.clearErrors();
         this.var_1247 = _loc2_.roomId;
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_383);
         if(this.var_53 == null)
         {
            return;
         }
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_53.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")),this,this.onConfirmRoomDelete,[this.var_383]);
         _loc2_.show();
      }
      ...
      private function refreshFlatControllers() : void
      {
         ...
         var _loc1_:IWindow = this.var_234.findChildByName("ruler");
         if(_loc1_ != null)
         {
            _loc1_.visible = true;
         }
         var _loc2_:IWindow = this.var_234.findChildByName("flat_ctrls_caption_txt");
         if(_loc2_ != null)
         {
            this._navigator.registerParameter("navigator.roomsettings.flatctrls.caption","cnt","" + this.var_53.controllerCount);
            _loc2_.visible = true;
         }
         var _loc3_:IWindowContainer = IWindowContainer(this.var_234.findChildByName("flat_controller_list"));
         if(_loc3_ != null)
         {
            ...
            _loc5_ = this.var_234.findChildByName("flat_ctrls_info_txt");
            _loc6_ = this.var_234.findChildByName("flat_ctrls_limit_txt");
            _loc7_ = IWindowContainer(this.var_234.findChildByName("flat_controllers_footer"));
            if(this.var_53 != null && this.var_53.controllers.length > 0)
            {
               ...
               Util.moveChildrenToColumn(this.var_234,["flat_ctrls_caption_txt","flat_ctrls_limit_txt","flat_controller_list","flat_ctrls_info_txt","flat_controllers_footer"],_loc2_.y,5);
            }
            else
            {
         ...
         var _loc4_:IButtonWindow = IButtonWindow(this.var_234.findChildByName("remove_flat_ctrl"));
         if(_loc4_ != null)
         {
            if(_loc8_)
            {
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_88,HabboWindowStyle.const_32,HabboWindowParam.const_68,new Rectangle(0,0,100,20)));
      }
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent) : void
      {
         ...
         this._navigator.send(new RemoveAllRightsMessageComposer(this.var_383));
      }
