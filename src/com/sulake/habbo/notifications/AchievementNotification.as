package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      private const const_2015:String = "badge_bg_001_png";
      
      private const const_2257:String = "achievement_bg_001_png";
      ...
      public function AchievementNotification(param1:String, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:IAssetLibrary, param9:IHabboWindowManager, param10:IHabboLocalizationManager, param11:IHabboConfigurationManager, param12:IHabboCommunicationManager, param13:ISessionDataManager)
      {
         ...
         this.var_1546 = param7;
         this.var_2352 = param5;
         this.var_1921 = param6;
         this.var_67 = param10;
         this._assets = param8;
         this.var_395 = param13;
         ...
         this._window.center();
         this.var_2646 = this.var_67.getBadgeName(this.var_315);
         this.var_2648 = this.var_67.getBadgeDesc(this.var_315);
         this.var_2644 = this.var_67.getAchievementNameForFacebook(this.var_315,this.var_395.userName,this.var_395.realName,this.var_1223);
         this.var_2643 = this.var_67.getAchievementDescForFacebook(this.var_315,this.var_395.userName,this.var_395.realName,this.var_1223);
         this._desc = this.registerTextParameters("notifications.text.achievement");
         this.var_2645 = this.registerTextParameters("notifications.text.achievement_facebook");
         this._feedTitleFb = this.registerTextParameters("notifications.text.achievement_facebook_title");
         this.var_67.registerParameter("notifications.text.achievement.achievement_points","achievement_points",this.var_2048.toString());
         this.var_67.registerParameter("notifications.achievement.bonus.value","bonus_points",this.var_1546.toString());
         this.var_67.registerParameter("notifications.achievement.no_facebook","bonus_points",this.var_1546.toString());
         var _loc15_:IWindow = this._window.findChildByName("level_reward_points");
         var _loc16_:String = "notifications.text.achievement.reward." + this.var_1921;
         var _loc17_:String = this.var_1921 == 0 ? "pixels" : "activitypoints";
         this.var_67.registerParameter(_loc16_,_loc17_,"" + this.var_2352);
         _loc15_.caption = this.var_67.getKey(_loc16_);
         this._window.findChildByName("achievement_info").caption = this._desc;
         this.setBadge(param13.getBadgeImage(param1),this.const_2015);
         var _loc18_:BitmapData = (param8.getAssetByName(this.const_2257) as BitmapDataAsset).content as BitmapData;
         ...
         if(this.var_1546 <= 0 || !_loc21_)
         {
            _loc22_.removeListItem(_loc23_);
            _loc22_.removeListItem(_loc25_);
            _loc26_.send(new EventLogMessageComposer("Achievements",this.var_315,"client.show.no_post"));
         }
         else
         {
            ...
            {
               _loc22_.removeListItem(_loc25_);
               _loc26_.send(new EventLogMessageComposer("Achievements",this.var_315,"client.show.post"));
            }
            else
            {
               _loc22_.removeListItem(_loc23_);
               _loc26_.send(new EventLogMessageComposer("Achievements",this.var_315,"client.show.no_fb"));
            }
         }
         var _loc27_:int = 32;
      ...
      {
         this.var_67.registerParameter(param1,"badge_name",this.var_2646);
         this.var_67.registerParameter(param1,"badge_desc",this.var_2648);
         this.var_67.registerParameter(param1,"badge_name_fb",this.var_2644);
         this.var_67.registerParameter(param1,"badge_desc_fb",this.var_2643);
         this.var_67.registerParameter(param1,"level",this.var_1223.toString());
         this.var_67.registerParameter(param1,"name",this.var_395.userName);
         return this.var_67.registerParameter(param1,"realname",this.var_395.realName);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_395.events.removeEventListener(BadgeImageReadyEvent.const_114,this.onBadgeImageReady);
            this.var_395 = null;
         }
         if(this._window != null)
         {
      ...
      private function onBadgeImageReady(param1:BadgeImageReadyEvent) : void
      {
         ...
         if(param1.badgeId != this.var_315)
         {
            return;
         }
         this.setBadge(param1.badgeImage,this.const_2015);
      }
      
      public function requestPostDialog(param1:String) : void
      {
         HabboWebTools.facebookAchievementPost(this.var_315,this._feedTitleFb,this.var_2645,param1);
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               _loc3_.send(new GetAchievementShareIdComposer(this.var_2647));
               _loc3_.send(new EventLogMessageComposer("Achievements",this.var_315,"client.start_post"));
               this._window.visible = false;
               break;
            case "close":
               _loc3_.send(new EventLogMessageComposer("Achievements",this.var_315,"client.skip_post"));
               this.dispose();
               return;
         }
      }
