package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_481:int = 70;
      
      public static const const_1801:int = 4;
      
      private static const name_3:int = 0;
      
      private static const const_636:int = 1;
      ...
      private var var_243:HabboNotificationItem;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:HabboNotificationItem)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_1888 = this._window.height - _loc7_.rectangle.bottom;
         }
         else
         {
            this.var_1888 = 15;
      ...
      {
         if(param1.badgeId != this.var_243.style.iconSrc)
         {
            return;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_636:
               ...
               _loc2_ = Number(this.var_1228) / Number(this.var_995["time_fade_in"]);
               if(this.var_1228 > int(this.var_995["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_1076:
               ...
               if(this.var_1530 > int(this.var_995["time_display"]) && !this.var_1887)
               {
                  this.startFadeOut();
               }
               break;
            case const_1075:
               ...
               _loc3_ = 1 - Number(this.var_1227) / Number(this.var_995["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1227 > int(this.var_995["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         this._window.x = _loc2_.width - this._window.width - const_1801;
         this._window.y = this.var_1529;
      }
