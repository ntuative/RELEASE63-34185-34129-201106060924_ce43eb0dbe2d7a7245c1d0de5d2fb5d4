package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine, IUpdateReceiver
   {
      ...
      private var var_1301:QuestController;
      
      private var var_1059:AchievementController;
      ...
      public function HabboQuestEngine(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1301 = new QuestController(this);
         this.var_1059 = new AchievementController(this);
         ...
         registerUpdateReceiver(this,const_1593);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_395.events.removeEventListener(BadgeImageReadyEvent.const_114,this.var_1059.onBadgeImageReady);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_395.events.addEventListener(BadgeImageReadyEvent.const_114,this.var_1059.onBadgeImageReady);
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_49)
         {
            ...
            {
               this.var_1301.onToolbarClick();
            }
            if(param1.iconId == HabboToolbarIconEnum.ACHIEVEMENTS)
            {
               this.var_1059.onToolbarClick();
            }
         }
      }
      ...
      {
         return this.var_1301.questTracker.isVisible();
      }
      ...
      {
         this.var_1301.update(param1);
         this.var_1059.update(param1);
      }
   }
}
