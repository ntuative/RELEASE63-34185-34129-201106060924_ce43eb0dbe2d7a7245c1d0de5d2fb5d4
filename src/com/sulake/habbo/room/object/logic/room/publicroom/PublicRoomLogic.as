package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomLogic extends RoomLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectRoomAdEvent.const_214,RoomObjectRoomAdEvent.const_310,RoomObjectRoomAdEvent.const_333];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         _loc2_.setString(RoomObjectVariableEnum.const_406,"");
         _loc2_.setString(RoomObjectVariableEnum.const_907,"");
         _loc2_.setNumber(RoomObjectVariableEnum.const_541,Number(false));
         this.var_754 = true;
      }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_1197:
                  _loc2_.setString(RoomObjectVariableEnum.const_406,_loc3_.asset);
                  _loc2_.setString(RoomObjectVariableEnum.const_907,_loc3_.clickUrl);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_541,Number(true));
                  this.var_1490 = getTimer() + _loc2_.getNumber(RoomVariableEnum.const_1330);
            }
         }
      }
      ...
      public function adDelayTimeout() : void
      {
         ...
         _loc1_.setNumber(RoomObjectVariableEnum.const_541,Number(false));
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_548)
               {
                  _loc7_ = _loc4_.getString(RoomObjectVariableEnum.const_907);
            ...
            case MouseEvent.ROLL_OUT:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_548)
               {
                  eventDispatcher.dispatchEvent(new RoomObjectRoomAdEvent(RoomObjectRoomAdEvent.const_333,_loc5_,_loc6_));
               }
         }
      }
   }
