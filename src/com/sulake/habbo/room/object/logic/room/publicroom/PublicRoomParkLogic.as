package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomParkLogic extends PublicRoomLogic
   {
      ...
      private static const const_1640:String = "goawaybus";
      
      private static const const_1639:String = "bus";
      
      private static const const_1638:String = "bus_oviopen_hidden";
      ...
      {
         var _loc1_:Array = [RoomObjectRoomActionEvent.const_629,RoomObjectRoomActionEvent.const_596];
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               switch(_loc3_.spriteTag)
               {
                  ...
                  case const_1639:
                  case const_1638:
                     _loc6_ = new RoomObjectRoomActionEvent(RoomObjectRoomActionEvent.const_596,0,_loc4_,_loc5_);
               }
         }
