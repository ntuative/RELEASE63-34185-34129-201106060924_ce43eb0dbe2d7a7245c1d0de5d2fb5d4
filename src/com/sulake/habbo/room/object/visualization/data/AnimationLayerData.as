   ...
   public class AnimationLayerData
   {
      ...
      public function calculateLength() : void
      {
         ...
         while(_loc1_ < this.var_231.length)
         {
            ...
            if(_loc2_ != null)
            {
               this.var_445 += _loc2_.frameCount;
            }
            _loc1_++;
         }
      }
      ...
      public function getFrame(param1:int, param2:int) : AnimationFrame
      {
         ...
         if(!this.var_1799)
         {
            _loc6_ = param2 / this.var_445;
            param2 %= this.var_445;
            if(this._loopCount > 0 && _loc6_ >= this._loopCount || this._loopCount <= 0 && this.var_445 == 1)
            {
               param2 = this.var_445 - 1;
               _loc4_ = true;
            }
            _loc7_ = 0;
            _loc5_ = 0;
