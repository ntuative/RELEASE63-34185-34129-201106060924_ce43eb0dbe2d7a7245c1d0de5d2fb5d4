package com.sulake.habbo.room.object.visualization.data
{
   ...
   public class SizeData
   {
      ...
      private var var_1210:DirectionData = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_265 != null)
         {
            ...
            {
               _loc2_ = this.var_265.getWithIndex(_loc1_) as DirectionData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function defineDirections(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            _loc8_ = _loc6_.layer;
            if(this.var_265.getValue(String(_loc7_)) != null)
            {
               return false;
            }
            ...
            this.var_265.add(String(_loc7_),_loc3_);
            this.var_1843 = -1;
            this.var_1210 = null;
            _loc5_++;
         }
      ...
      private function defineDirection(param1:DirectionData, param2:XMLList) : Boolean
      {
         ...
         while(_loc4_ < param2.length())
         {
            ...
            {
               case "ADD":
                  param1.setInk(_loc6_,LayerData.const_1143);
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc6_,LayerData.const_1213);
                  break;
               case "DARKEN":
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + this.var_1496 / 2) % 360 / this.var_1496;
         if(this.var_265.getValue(String(_loc2_)) != null)
         {
            return _loc2_;
         }
         ...
         {
            _loc6_ = int(this.var_265.getKey(_loc5_)) * this.var_1496;
         ...
         if(_loc4_ >= 0)
         {
            return int(this.var_265.getKey(_loc4_));
         }
         return const_1815;
      }
      ...
      {
         if(param1 == this.var_1843)
         {
            return this.var_1210;
         }
         var _loc2_:* = null;
         _loc2_ = this.var_265.getValue(String(param1)) as DirectionData;
         if(_loc2_ == null)
         {
            _loc2_ = this.var_785;
         }
         this.var_1843 = param1;
         this.var_1210 = _loc2_;
         return this.var_1210;
      }
