package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class AnimatedFurnitureVisualization extends FurnitureVisualization
   {
      ...
      private var var_133:AnimationStateData;
      ...
      {
         super();
         this.var_133 = new AnimationStateData();
      }
      ...
      {
         return this.var_133.animationId;
      }
      
      protected function getAnimationId(param1:AnimationStateData) : int
      {
         var _loc2_:int = this.animationId;
         if(_loc2_ != const_1354 && this._animationData.hasAnimation(this.var_484,_loc2_))
         {
            return _loc2_;
         }
         return const_1354;
      ...
      override protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(super.updateObject(param1,param2))
         {
            ...
            {
               this.method_1(_loc4_);
               this._state = _loc4_;
               _loc5_ = _loc3_.getModel();
               if(_loc5_ != null)
               {
                  _loc6_ = _loc5_.getNumber(RoomObjectVariableEnum.const_728);
                  this.var_2132 = _loc6_;
               }
            }
            return true;
         }
         ...
         if(super.updateModel(param1))
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc5_ = _loc3_.getNumber(RoomObjectVariableEnum.const_728);
                     if(_loc5_ > this.var_2132)
                     {
                        this.var_2132 = _loc5_;
                        this.method_1(this._state);
                     }
                  }
                  _loc4_ = _loc3_.getNumber(RoomObjectVariableEnum.const_738);
                  if(!isNaN(_loc4_))
                  {
                     _loc6_ = this._animationData.getAnimationId(this.var_484,_loc4_);
                     this.method_1(_loc6_);
                  }
               }
            }
            return true;
      ...
      protected function method_1(param1:int) : void
      {
         if(this._animationData != null)
         {
            this.setSubAnimation(this.var_133,param1,this._state >= 0);
         }
      }
      ...
      {
         return this.var_133.getLastFramePlayed(param1);
      }
      ...
      protected function resetAllAnimationFrames() : void
      {
         if(this.var_133 != null)
         {
            this.var_133.setLayerCount(this.var_709);
         }
      }
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         {
            this.var_484 = param1;
            this.var_709 = this._animationData.getLayerCount(param1);
      ...
      {
         var _loc2_:int = 0;
         if(!this.var_133.animationOver || this.var_1095)
         {
            _loc2_ = this.updateFramesForAnimation(this.var_133,param1);
            if(this.var_133.animationOver)
            {
               if(AnimationData.isTransitionFromAnimation(this.var_133.animationId) || AnimationData.isTransitionToAnimation(this.var_133.animationId))
               {
                  this.method_1(this.var_133.animationAfterTransitionId);
                  this.var_133.animationOver = false;
               }
            }
         }
         return _loc2_;
      ...
      protected function updateFramesForAnimation(param1:AnimationStateData, param2:Number) : int
      {
         ...
         var _loc11_:* = null;
         var _loc12_:int = 0;
         if(param1.animationOver && !this.var_1095)
         {
            return 0;
         }
         ...
         var _loc7_:* = 1 << this.var_709 - 1;
         var _loc8_:int = this.var_709 - 1;
         while(_loc8_ >= 0)
         {
            _loc9_ = param1.getAnimationPlayed(_loc8_);
            if(!_loc9_ || this.var_1095)
            {
               ...
               if(this.var_1095 || _loc11_ == null || _loc11_.remainingFrameRepeats >= 0 && _loc13_ <= 0)
               {
                  _loc12_ = 0;
                  if(_loc11_ != null)
                  {
                  ...
                  if(_loc12_ == AnimationFrame.const_1279)
                  {
               ...
               if(_loc11_ == null || _loc11_.remainingFrameRepeats == AnimationFrame.const_592)
               {
                  _loc10_ = true;
                  _loc9_ = true;
               }
      ...
      {
         var _loc3_:AnimationFrame = this.var_133.getFrame(param2);
         if(_loc3_ != null)
         {
            return _loc3_.id;
         }
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         var _loc5_:AnimationFrame = this.var_133.getFrame(param3);
         if(_loc5_ != null)
         {
            _loc4_ += _loc5_.x;
         }
