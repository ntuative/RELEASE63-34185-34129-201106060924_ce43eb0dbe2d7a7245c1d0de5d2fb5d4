package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureFireworksVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private var var_235:FurnitureParticleSystem;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_662)
         {
            for each(_loc1_ in this.var_662)
            {
               _loc1_.dispose();
            }
            this.var_662 = null;
      ...
      override protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(super.updateObject(param1,param2))
         {
            ...
            {
               this.readDefinition();
               this.var_235 = this.var_662[param1];
               _loc3_ = true;
            }
            else if(param1 != var_96)
            {
               if(this.var_235)
               {
                  this.var_235.reset();
      ...
      {
         if(this.var_235 && this.var_235.controlsSprite(param3))
         {
            return this.var_235.getSpriteYOffset(param1,param2,param3);
         }
      ...
      private function readDefinition() : Boolean
      {
         ...
         var _loc3_:String = _loc2_.getString(RoomObjectVariableEnum.const_1228);
         if(_loc3_.length == 0)
         {
