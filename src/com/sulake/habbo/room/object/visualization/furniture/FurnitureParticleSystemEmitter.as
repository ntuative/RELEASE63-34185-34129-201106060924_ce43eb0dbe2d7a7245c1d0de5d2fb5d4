package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1727:String = "cone";
      
      public static const const_1895:String = "plane";
      
      public static const const_1807:String = "sphere";
      ...
      private var var_977:Number = 0.1;
      ...
      public function reset() : void
      {
         ...
         this.var_978 = 0;
         this.var_1062 = false;
         this.init(0,0,0,this._direction,this.var_2552,this.var_977,this.var_2550,true);
      }
      ...
      public function configureParticle(param1:int, param2:Boolean, param3:Array, param4:Boolean) : void
      {
         ...
         _loc5_["fade"] = param4;
         this.var_1216.push(_loc5_);
      }
      
      override protected function ignite() : void
      {
         this.var_1062 = true;
         if(this.var_978 < this.var_1506)
         {
            if(this.age > 1)
            {
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.var_2553)
         {
            switch(this.var_2551)
            {
               case const_1727:
                  _loc3_.x = !!this.method_3(0.5) ? Number(Math.random()) : Number(-Math.random());
                  _loc3_.y = -(Math.random() + 1);
                  _loc3_.z = !!this.method_3(0.5) ? Number(Math.random()) : Number(-Math.random());
                  break;
               case const_1895:
                  _loc3_.x = !!this.method_3(0.5) ? Number(Math.random()) : Number(-Math.random());
                  _loc3_.y = 0;
               ...
               case const_1807:
                  _loc3_.x = !!this.method_3(0.5) ? Number(Math.random()) : Number(-Math.random());
                  _loc3_.y = !!this.method_3(0.5) ? Number(Math.random()) : Number(-Math.random());
                  _loc3_.z = !!this.method_3(0.5) ? Number(Math.random()) : Number(-Math.random());
                  break;
            }
            _loc3_.normalize();
            ...
            _loc4_.init(param1.x,param1.y,param1.z,_loc3_,this._energy,this.var_977,_loc6_,_loc7_,_loc9_,_loc8_);
      ...
      {
         var _loc1_:int = Math.floor(Math.random() * this.var_1216.length);
         return this.var_1216[_loc1_];
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_978 < this.var_1506)
         {
            if(this.age % this.var_2554 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_978 < this.var_1506)
         {
            ...
            this.y = (2 - this.var_266) * this.y - (1 - this.var_266) * this.lastY + this.var_1848 * this.var_977 * this.var_977;
         ...
         for each(_loc2_ in this.var_374)
         {
            ...
            _loc2_.y = (2 - this.var_266) * _loc2_.y - (1 - this.var_266) * _loc2_.lastY + this.var_1848 * this.var_977 * this.var_977;
      ...
      private function method_3(param1:Number) : Boolean
      {
