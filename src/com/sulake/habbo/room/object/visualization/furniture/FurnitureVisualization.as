package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1978:Number = Math.sqrt(0.5);
      ...
      private var var_1317:String = null;
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(param4)
         {
            this.var_1607 |= this.updateAnimation(_loc6_);
         }
         else
         {
            _loc7_ = this.updateAnimation(_loc6_) | this.var_1607;
            this.var_1607 = 0;
         }
         if(_loc5_ || _loc7_ != 0)
         {
      ...
      protected function updateSprites(param1:int, param2:Boolean, param3:int) : void
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(this.var_709 != spriteCount)
         {
            createSprites(this.var_709);
         }
         if(param2)
         {
      ...
      private function updateSprite(param1:int, param2:int) : void
      {
         ...
         if(_loc4_ != null && _loc3_ != null)
         {
            ...
            if(_loc5_ != null && _loc5_.asset != null)
            {
               ...
               _loc4_.clickHandling = this.var_2277;
            }
            else
            {
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_498 != _loc3_.getUpdateID() || param1 != var_96 || param2 != this.var_2809)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(var_157 != _loc3_.getUpdateID())
         {
            this.var_2806 = _loc3_.getNumber(RoomObjectVariableEnum.const_289);
            _loc4_ = Number(_loc3_.getNumber(RoomObjectVariableEnum.const_330));
            if(isNaN(_loc4_))
            {
               _loc4_ = 1;
            }
            ...
            this.var_1317 = this.getAdClickUrl(_loc3_);
            if(this.var_1317 == null || this.var_1317.indexOf("http") != 0)
            {
               this.var_1317 = null;
            }
            this.var_2277 = this.var_1317 != null;
            this.var_2805 = _loc3_.getNumber(RoomObjectVariableEnum.const_930);
      ...
      {
         if(this.var_2804 != param2 || this.var_2807 != param1)
         {
            this.var_1065 = [];
            this.var_1066 = [];
            this.var_856 = [];
      ...
      {
         this.var_709 = param1;
         this.var_1608 = this.var_709 - this.getAdditionalSpriteCount();
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         var _loc3_:String = this.var_1065[param2];
         var _loc4_:Boolean = this.var_1066[param2];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            ...
            this.var_1065[param2] = _loc3_;
            this.var_1066[param2] = _loc4_;
         }
         if(_loc4_)
         {
      ...
      {
         if(this.var_859[param3] != null && !this.var_2039)
         {
            return this.var_859[param3];
         }
         if(this._data == null)
         {
         ...
         this.var_859[param3] = _loc4_;
         return _loc4_;
      }
      
      protected function getSpriteColor(param1:int, param2:int, param3:int) : int
      {
         if(this.var_857[param2] != null)
         {
            return this.var_857[param2];
         }
         if(this._data == null)
         {
