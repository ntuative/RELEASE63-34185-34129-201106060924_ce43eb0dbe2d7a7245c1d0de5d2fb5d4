package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualizationData implements IRoomObjectVisualizationData
   {
      ...
      private var var_986:SizeData = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_312 != null)
         {
            ...
            {
               _loc1_ = this.var_312.getWithIndex(_loc2_) as SizeData;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      protected function defineVisualizations(param1:XML) : Boolean
      {
         ...
         while(_loc4_ < _loc2_.length())
         {
            ...
            if(this.var_312.getValue(String(_loc6_)) != null)
            {
               return false;
            }
            ...
            this.var_312.add(String(_loc6_),_loc9_);
      ...
      protected function getSizeData(param1:int) : SizeData
      {
         ...
         if(_loc2_ < this._sizes.length)
         {
            this.var_986 = this.var_312.getValue(String(this._sizes[_loc2_])) as SizeData;
         }
         else
         {
            this.var_986 = null;
