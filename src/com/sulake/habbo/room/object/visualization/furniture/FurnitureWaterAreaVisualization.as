package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1429:String = "shore";
      ...
      override public function dispose() : void
      {
         ...
         {
            for each(_loc1_ in this.var_1162)
            {
      ...
      {
         if(this.var_2357 == param1 && this.var_2356 == direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,direction,_loc2_) == const_1429)
            {
               this.var_1742 = _loc2_;
               this.var_2357 = param1;
               this.var_2356 = direction;
               return this.var_1742;
            }
            _loc2_--;
         }
      ...
      private function getInstanceMask(param1:int) : IGraphicAsset
      {
         ...
         if(_loc3_ != null)
         {
            if(this.var_1162.indexOf(_loc2_) < 0)
            {
      ...
      private function updateBorderData() : void
      {
         ...
         this.var_1743 = false;
         _loc5_ = 0;
         while(_loc5_ < this.var_432.length)
         {
            if(this.var_432[_loc5_] == true)
            {
               this.var_1743 = true;
            }
            _loc5_++;
      ...
      private function updateTopBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc8_ < _loc3_ - 1)
         {
            if(_loc4_[_loc8_] == false)
            {
               ...
               this.var_609[param2] = ShoreMaskCreatorUtility.getBorderType(_loc6_,_loc7_);
            }
            param2++;
            _loc8_++;
         }
      ...
      private function updateRightBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc10_ < _loc4_ - 1)
         {
            ...
            if(_loc7_[_loc3_ - 1] == false)
            {
               ...
               this.var_609[param2] = ShoreMaskCreatorUtility.getBorderType(_loc5_,_loc6_);
            }
            param2++;
            _loc10_++;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_512 == 0 || this.var_608 == 0)
         {
            ...
            this.var_512 = _loc2_.getNumber(RoomObjectVariableEnum.const_352);
            this.var_608 = _loc2_.getNumber(RoomObjectVariableEnum.const_383);
         }
         this.var_432 = [];
         this.var_609 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_512 * 2 + this.var_608 * 2)
         {
            this.var_432.push(false);
            this.var_609.push(ShoreMaskCreatorUtility.const_83);
            _loc1_++;
         }
      }
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_74,getSize(param3),this.var_432,this.var_609,assetCollection);
      }
