package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetAnimationSizeData extends AnimationSizeData
   {
      ...
      public static const const_777:int = -1;
      ...
      public function definePostures(param1:XML) : Boolean
      {
         ...
         {
            this.var_734 = param1.@defaultPosture;
         }
         else
         {
            this.var_734 = null;
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            this.var_598.add(_loc6_,_loc7_);
         ...
         if(this.var_598.getValue(this.var_734) == null)
         {
            return false;
         }
         return true;
      ...
      {
         if(this.var_598.getValue(param1) == null)
         {
            param1 = this.var_734;
         }
         return int(this.var_598.getValue(param1));
      }
