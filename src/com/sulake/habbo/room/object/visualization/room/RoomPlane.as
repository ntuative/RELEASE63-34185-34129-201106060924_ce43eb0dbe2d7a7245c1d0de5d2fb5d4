package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      public static const const_1823:int = 0;
      ...
      private var var_837:PlaneMaskManager = null;
      
      private var _id:String = null;
      
      private var var_2684:Number = 0;
      ...
      private var var_461:PlaneBitmapData = null;
      ...
      private var var_240:BitmapData = null;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         this.var_1213.assign(param1);
         this.var_101 = new Vector3d();
         this.var_101.assign(param2);
      ...
      {
         return this._isVisible && this.var_828;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_209 != null)
         {
            ...
            {
               _loc2_ = this.var_209.getWithIndex(_loc1_) as PlaneBitmapData;
               if(_loc2_ != null)
               {
      ...
      {
         var _loc3_:PlaneBitmapData = this.var_209.remove(param1) as PlaneBitmapData;
         if(_loc3_ != null)
         {
      ...
      private function resetTextureCache(param1:BitmapData = null) : void
      {
         ...
         if(this.var_209 != null)
         {
            ...
            {
               _loc3_ = this.var_209.getWithIndex(_loc2_) as PlaneBitmapData;
               if(_loc3_ != null)
               {
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc3_:PlaneBitmapData = this.var_461;
         if(_loc3_ == null)
         {
            _loc4_ = this.getTextureIdentifier(param1.scale);
            _loc3_ = this.var_209.getValue(_loc4_) as PlaneBitmapData;
         }
         this.updateMaskChangeStatus();
         if(this.var_828 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_393))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(this.needsNewTexture(param1,param2))
         {
            ...
            if(this.var_1038 != null)
            {
               _loc3_ = this.var_1038.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_1941,this.var_2684,this.var_2686,this.var_2688,this.var_2687,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1750 != geometry.updateId)
         {
            geometryChanged = true;
         }
         if(!geometryChanged || !this.var_828)
         {
            if(!this.visible)
            {
               return false;
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1566.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1566[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originPos = geometry.getScreenPosition(this.var_1213);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_165.z - originZ,this.var_124.z - originZ,this.var_90.z - originZ,this.var_125.z - originZ);
            if(this._type == TYPE_LANDSCAPE)
            {
               relativeDepth += 0.02;
            }
            this.var_2535 = relativeDepth;
            this._isVisible = true;
            this.var_1750 = geometry.updateId;
         }
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2685);
      ...
      public function addBitmapMask(param1:String, param2:Number, param3:Number) : Boolean
      {
         ...
         if(this.var_1036)
         {
            _loc4_ = null;
            _loc5_ = 0;
            while(_loc5_ < this.var_279.length)
            {
               _loc4_ = this.var_279[_loc5_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_279.length == this.var_1037.length)
         {
            while(_loc1_ < this.var_279.length)
            {
               _loc4_ = this.var_279[_loc1_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
                  _loc6_ = false;
         ...
         if(this.var_392.length > this.var_1567.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_1036 || this.var_279.length == 0 && this.var_392.length == 0 && !this.var_393 || this.var_837 == null)
         {
            return;
         }
         ...
         if(this.var_393)
         {
            ...
            while(_loc5_ < this.var_279.length)
            {
               _loc3_ = this.var_279[_loc5_] as RoomPlaneBitmapMask;
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_74.width - this.var_74.width * _loc3_.leftSideLoc / this.var_310.length;
                  _loc11_ = this.var_74.height - this.var_74.height * _loc3_.rightSideLoc / this.var_309.length;
                  _loc12_ = _loc3_.type;
                  this.var_837.updateMask(this.var_74,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
            ...
            while(_loc6_ < this.var_392.length)
            {
               ...
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_74.width - this.var_74.width * _loc4_.leftSideLoc / this.var_310.length;
                  _loc11_ = this.var_74.height - this.var_74.height * _loc4_.rightSideLoc / this.var_309.length;
                  _loc13_ = this.var_74.width * _loc4_.leftSideLength / this.var_310.length;
                  _loc14_ = this.var_74.height * _loc4_.rightSideLength / this.var_309.length;
                  this.var_74.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  this.var_1567.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_393 = false;
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         if(this.var_240 != null && (this.var_240.width != param1.width || this.var_240.height != param1.height))
         {
            this.var_240.dispose();
            this.var_240 = null;
         }
         if(this.var_240 == null)
         {
            this.var_240 = new BitmapData(param1.width,param1.height,true,4294967295);
         }
         this.var_240.copyChannel(param1,param1.rect,const_679,BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_240.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_240,this.var_240.rect,const_679,BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
