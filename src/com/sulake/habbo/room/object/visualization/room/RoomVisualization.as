package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1774:int = 16777215;
      
      public static const const_1872:int = 13421772;
      
      private static const const_1123:int = 16777215;
      
      private static const const_1124:int = 13421772;
      
      private static const const_1122:int = 10066329;
      
      private static const const_1121:int = 10066329;
      
      public static const const_1860:int = 16777215;
      
      public static const const_1917:int = 13421772;
      
      public static const const_1859:int = 10066329;
      ...
      private var var_865:Rectangle = null;
      ...
      private var var_1423:Number = NaN;
      
      private var var_2043:String = null;
      
      private var var_1324:uint = 16777215;
      
      private var var_2821:int = 255;
      
      private var var_2820:int = 255;
      
      private var var_2819:int = 255;
      ...
      private const const_2279:int = 250;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_331["null"] = false;
         this.var_331["null"] = true;
         this.var_331["null"] = true;
         this.var_331["null"] = true;
      }
      ...
      private function resetRoomPlanes() : void
      {
         ...
         if(this.var_147 != null)
         {
            ...
            {
               _loc2_ = this.var_147[_loc1_] as RoomPlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_865 = super.boundingRectangle;
         }
         return new Rectangle(this.var_865.x,this.var_865.y,this.var_865.width,this.var_865.height);
      }
      ...
      protected function defineSprites() : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc1_:int = this.var_147.length;
         createSprites(_loc1_);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            _loc3_ = this.var_147[_loc2_] as RoomPlane;
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         {
            this._planeParser.wallThicknessMultiplier = this.var_1423;
         }
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1280);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1328);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            if(_loc12_ == RoomPlaneData.const_283)
            {
               ...
               if(_loc14_.z != 0)
               {
                  _loc13_.color = const_1774;
               }
               else
               {
                  _loc13_.color = const_1872;
               }
            ...
            else if(_loc12_ == RoomPlaneData.const_451)
            {
               ...
               if(_loc14_.y > 0)
               {
                  _loc13_.color = const_1860;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_1917;
               }
               else
               {
                  _loc13_.color = const_1859;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1782)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_75,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_451)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this.var_1845 + this.const_2279 && !_loc6_ && !_loc8_)
         {
            return;
         }
         ...
         {
            _loc10_ = 0;
            while(_loc10_ < this.var_405.length)
            {
               _loc11_ = this.var_692[_loc10_];
               _loc12_ = getSprite(_loc11_);
               _loc13_ = this.var_405[_loc10_] as RoomPlane;
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_2045)
                  {
                     _loc14_ = uint(_loc13_.color);
                     _loc15_ = uint((_loc14_ & 255) * this.var_2819 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2820 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2821 / 255);
         ...
         var_157 = _loc7_.getUpdateID();
         this.var_1845 = _loc9_;
      }
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1750)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1502 || _loc3_.y != this.var_2536 || _loc3_.z != this.var_2533 || param1.scale != this.var_2044))
            {
               this.var_1502 = _loc3_.x;
               this.var_2536 = _loc3_.y;
               this.var_2533 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         var _loc2_:Boolean = false;
         if(var_157 != param1.getUpdateID())
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1157);
            if(_loc3_ != this.var_2043)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2043 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_751));
            if(_loc4_ != this.var_1324)
            {
               this.var_1324 = _loc4_;
               this.var_2819 = this.var_1324 & 255;
               this.var_2820 = this.var_1324 >> 8 & 255;
               this.var_2821 = this.var_1324 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1331));
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_157 != param1.getUpdateID())
         {
            ...
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_213);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_758));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_778));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_850));
      ...
      private function updatePlaneThicknesses(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_157 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1346);
            _loc3_ = param1.getNumber(RoomObjectVariableEnum.const_1144);
            if(!isNaN(_loc2_) && !isNaN(_loc3_) && (_loc2_ != this._floorThicknessMultiplier || _loc3_ != this.var_1423))
            {
               this._floorThicknessMultiplier = _loc2_;
               this.var_1423 = _loc3_;
               this.resetRoomPlanes();
               return true;
            }
         }
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_147.length)
         {
            _loc5_ = this.var_147[_loc4_] as RoomPlane;
            if(_loc5_ != null)
            {
      ...
      {
         if(param1 != this.var_331["null"] || param2 != this.var_331["null"] || param3 != this.var_331["null"])
         {
            this.var_331["null"] = param1;
            this.var_331["null"] = param2;
            this.var_331["null"] = param3;
            this.var_405 = [];
            this.var_692 = [];
         }
      }
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_405;
         if(this.var_405.length == 0)
         {
            _loc6_ = this.var_147;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_405.length > 0;
         var _loc9_:int = 0;
         while(_loc9_ < _loc6_.length)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc11_.visible != (_loc12_.visible && this.var_331[_loc12_.type]))
                  {
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1323;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         var _loc6_:Boolean = false;
         var _loc7_:int = 0;
         while(_loc7_ < this.var_147.length)
         {
            _loc3_ = this.var_147[_loc7_] as RoomPlane;
            if(_loc3_ != null)
            {
         ...
         while(_loc8_ < this.var_568.maskCount)
         {
            ...
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_147.length)
               {
                  _loc3_ = this.var_147[_loc13_] as RoomPlane;
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_75 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_304)
                              {
         ...
         while(_loc9_ < _loc4_.length)
         {
            ...
            {
               _loc3_ = this.var_147[_loc18_] as RoomPlane;
