package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_2219:int = 1;
      
      public static const const_2246:int = 16777216;
      ...
      private var var_1922:int = 16777216;
      
      private var var_3012:int = 69069;
      
      private var var_3013:int = 5;
      ...
      {
         var _loc1_:int = this.var_3012 * this.var_1923 + this.var_3013;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1922;
         this.var_1923 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_1922 * param2);
      }
   }
}
