package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      public static var var_340:int = 3;
      ...
      private var var_2038:TriggerConfs;
      
      private var var_2037:ActionTypes;
      
      private var var_2036:ConditionTypes;
      ...
      private var var_1316:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_2038 = new TriggerConfs();
         this.var_2037 = new ActionTypes();
         this.var_2036 = new ConditionTypes();
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1316 = new SliderWindowController(this.var_88,IWindowContainer(this.find(this.var_54,"delay_slider_container")),this.var_88.assets,0,20,1);
         this.var_1316.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1316.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_851.hideAll(this.var_287);
         }
      }
      ...
      private function prepareStuffSelectionForUpdate() : void
      {
         ...
         if(this.var_36.stuffTypeSelectionEnabled)
         {
            ...
            if(_loc2_.requiresFurni == STUFF_SELECTION_OPTION_BY_ID_OR_BY_TYPE)
            {
               ...
               this.getFurniTypeMatchesText().caption = this.var_88.localization.getKey("wiredfurni.pickfurnis.furnitypematches");
               this.getFurniTypeMatchesCheckBox().visible = true;
               this.getFurniTypeMatchesText().visible = true;
            }
            else if(_loc2_.requiresFurni == var_340)
            {
      ...
      {
         this.getFurniTypeMatchesText().caption = this.var_88.localization.getKey("wiredfurni.pickfurnis.stuffselectiontype." + this.var_36.stuffTypeSelectionCode);
      }
      ...
      private function onSave(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_36 as TriggerDefinition != null)
         {
            this.var_88.send(new UpdateTriggerMessageComposer(this.var_36.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.resolveStuffSelectionType()));
         }
         else if(this.var_36 as ActionDefinition != null)
         {
            this.var_88.send(new UpdateActionMessageComposer(this.var_36.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.getActionDelay(),this.resolveStuffSelectionType()));
         }
         else if(this.var_36 as ConditionDefinition != null)
         {
            this.var_88.send(new UpdateConditionMessageComposer(this.var_36.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.resolveStuffSelectionType()));
         }
         this.close();
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1316.getValue()) : 0;
      }
      ...
      private function onApplySnapshot(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_88.send(new ApplySnapshotMessageComposer(this.var_36.id));
      }
      ...
      private function resolveStuffSelectionType() : int
      {
         ...
         if(_loc1_.requiresFurni == var_340)
         {
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_2038);
         this.refreshConfigureElement(this.var_2037);
         this.refreshConfigureElement(this.var_2036);
