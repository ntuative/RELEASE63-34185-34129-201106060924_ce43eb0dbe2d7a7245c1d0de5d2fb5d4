package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      private var var_650:Number = 0.0;
      ...
      public function setValue(param1:Number, param2:Boolean = true) : void
      {
         ...
         param1 = Math.min(this.var_1222,param1);
         this.var_985 = param1;
         if(param2)
         {
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_985);
         }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_984)
         {
            if(param1.type == WindowMouseEvent.const_56 || param1.type == WindowMouseEvent.const_226)
            {
               this.var_984 = false;
            }
         }
         if(!this.var_984 || param1.type != WindowEvent.const_440)
         {
            return;
         }
         if(this.var_650 != 0)
         {
            ...
            _loc4_ = Math.round(_loc3_ / this.var_650) * this.var_650;
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_650 != 0)
            {
               _loc3_ = this.var_985 + this.var_650;
      ...
      private function displaySlider() : void
      {
         ...
         {
            _loc2_.bitmap = new BitmapData(this.var_799.width,this.var_799.height,true,16777215);
            _loc2_.bitmap.copyPixels(this.var_799,this.var_799.rect,new Point(0,0),null,null,true);
         }
         _loc1_ = this._sliderContainer.findChildByName("slider_movement_area") as IWindowContainer;
         if(_loc1_ != null)
         {
            _loc2_ = _loc1_.findChildByName("slider_button") as IBitmapWrapperWindow;
            if(_loc2_ != null && this.var_800 != null)
            {
               _loc2_.bitmap = new BitmapData(this.var_800.width,this.var_800.height,true,16777215);
               _loc2_.bitmap.copyPixels(this.var_800,this.var_800.rect,new Point(0,0),null,null,true);
               _loc2_.procedure = this.sliderProcedure;
               this.var_1872 = _loc1_.width - _loc2_.width;
            }
         }
