package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1519:String = "sendAccessTokenToServer";
      
      private static const const_1520:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1519,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1520,this.jsFaceBookLogOutCallback);
