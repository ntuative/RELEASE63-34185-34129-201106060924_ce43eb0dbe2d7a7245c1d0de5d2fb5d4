package com.sulake.habbo.session.handler
{
   ...
   public class RoomUsersHandler extends BaseHandler
   {
      ...
      public function RoomUsersHandler(param1:IConnection, param2:IRoomHandlerListener)
      {
         ...
         param1.addMessageEvent(new PetCommandsMessageEvent(this.method_7));
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:IRoomSession = listener.getSession(_xxxRoomId,var_27);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function onDoorbell(param1:IMessageEvent) : void
      {
         ...
         listener.events.dispatchEvent(new RoomSessionDoorbellEvent(RoomSessionDoorbellEvent.const_130,_loc3_,_loc2_.userName));
      }
      ...
      {
         var _loc2_:IRoomSession = listener.getSession(_xxxRoomId,var_27);
         if(_loc2_ == null)
         {
            return;
         }
         ...
         _loc5_.method_2 = _loc4_.method_2;
