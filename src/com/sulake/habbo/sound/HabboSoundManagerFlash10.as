package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager, IUpdateReceiver
   {
      ...
      private static const const_1546:int = 60;
      
      private static const const_1547:int = 25165823;
      
      private static const const_1545:int = 16777215;
      ...
      private var var_1016:Number = 1.0;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null, param4:Boolean = true)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_750,this.onTraxLoadComplete);
      ...
      public function playSound(param1:String) : void
      {
         ...
         if(_loc2_ == null)
         {
            ...
            this.var_1018.add(param1,_loc2_);
         }
         _loc2_.volume = this.var_1016;
         _loc2_.play();
      }
      ...
      private function loadSample(param1:int) : void
      {
         ...
         var _loc2_:String = this.var_181.getKey("flash.dynamic.download.url","furniture/");
         _loc2_ += this.var_181.getKey("flash.dynamic.download.samples.template","mp3/sound_machine_sample_%typeid%.mp3");
         ...
         _loc4_.load(_loc3_);
         this.var_670.add(_loc4_,param1);
      }
      ...
      private function addTraxSongForDownload(param1:int, param2:String) : IHabboSound
      {
         ...
         if(!_loc3_.ready)
         {
            this.var_1260.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      private function createTraxInstance(param1:int, param2:String, param3:Boolean = true) : TraxSequencer
      {
         ...
         var _loc5_:TraxSequencer = new TraxSequencer(param1,_loc4_,this.var_275,events);
         _loc5_.volume = this.var_1016;
      ...
      private function validateSampleAvailability(param1:TraxSequencer, param2:Boolean) : void
      {
         ...
         {
            if(this.var_275.getValue(int(_loc4_[_loc6_])) == null)
            {
               if(param2)
               {
      ...
      public function notifyPlayedSong(param1:String, param2:String) : void
      {
         ...
         this.var_1017.addSongPlayingNotification(param1,param2);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            if(this.var_181.getBoolean("trax.player.sample.memory.purge.enabled",false))
            {
               this.var_2664 = true;
            }
         }
      ...
      private function onNotificationsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1017 = IHabboNotifications(param2);
      }
      ...
      {
         if(this.var_181 == null || this._connection == null || this._roomEngine == null || this.var_239 != null)
         {
            return;
         }
      ...
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1894,this.var_818));
         this.var_818 = -1;
         this.var_817 = null;
      }
      ...
      private function storeVolumeSetting() : void
      {
         ...
         {
            this._connection.send(new SetSoundSettingsComposer(int(this.var_1016 * 100)));
         }
      }
      ...
      private function updateVolumeSetting(param1:Number) : void
      {
         ...
         this.var_239.updateVolume(this.var_1016);
      }
      ...
      private function processLoadedSample(param1:Sound) : void
      {
         ...
         {
            _loc2_ = this.var_670.remove(param1);
            if(this.var_275.getValue(_loc2_) == null)
            {
               this.var_1548.clear();
               _loc3_ = param1.length;
               param1.extract(this.var_1548,int(_loc3_ * 44.1));
               _loc4_ = new TraxSample(this.var_1548,_loc2_,TraxSample.const_1866,TraxSample.const_1884);
               this.var_275.add(_loc2_,_loc4_);
            }
         }
      }
      ...
      private function processLoadedSamples() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         if(this.var_1261.length > 0)
         {
            _loc1_ = getTimer();
            _loc2_ = _loc1_;
            while(_loc2_ - _loc1_ < const_1546 && this.var_1261.length > 0)
            {
               _loc3_ = this.var_1261.splice(0,1)[0];
               this.processLoadedSample(_loc3_);
               _loc2_ = getTimer();
            }
            if(this.var_670.length == 0 && this.var_818 != -1)
            {
               this.var_817.ready = true;
               _loc4_ = this.var_818;
               this.var_818 = -1;
               this.var_817 = null;
               events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_750,_loc4_));
               if(this.var_2664)
               {
      ...
      private function loadNextSong() : void
      {
         var _loc1_:int = 0;
         var _loc2_:* = null;
         if(this.var_817 == null && this.var_1260.length > 0)
         {
            _loc1_ = this.var_1260.getKey(0);
            _loc2_ = this.var_1260.remove(_loc1_);
            if(_loc2_ != null && !_loc2_.disposed)
            {
               this.validateSampleAvailability(_loc2_,true);
               if(_loc2_.ready)
               {
                  events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_750,_loc1_));
               }
               else
               {
                  this.var_817 = _loc2_;
      ...
      private function processSampleMemoryUsage() : void
      {
         ...
         {
            _loc5_ = this.var_275.getKey(_loc4_);
            _loc6_ = this.var_275.getWithIndex(_loc4_);
         ...
         if(_loc1_ > const_1547)
         {
            ...
            _loc8_ = 0;
            _loc9_ = 0;
            while(_loc8_ < _loc1_ - const_1545 && _loc9_ < _loc2_.length)
            {
            ...
            if(_loc7_.length > 0)
            {
               for each(_loc11_ in _loc7_)
               {
                  ...
                  _loc12_ = this.var_275.getValue(_loc11_) as TraxSample;
                  _loc12_.dispose();
                  this.var_275.remove(_loc11_);
               }
