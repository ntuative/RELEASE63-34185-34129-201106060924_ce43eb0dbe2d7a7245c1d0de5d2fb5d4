package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private static const const_1641:int = HabboMusicPrioritiesEnum.const_138;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_767.push(new TraxSongInfoMessageEvent(this.onSongInfoMessage));
         this.var_767.push(new UserSongDisksInventoryMessageEvent(this.onSongDiskInventoryMessage));
         for each(_loc5_ in this.var_767)
         {
            this._connection.addMessageEvent(_loc5_);
         }
         this.var_88.addEventListener(RoomEngineSoundMachineEvent.const_976,this.onJukeboxInit);
         this.var_88.addEventListener(RoomEngineSoundMachineEvent.const_245,this.onJukeboxDispose);
         this.var_88.addEventListener(RoomEngineSoundMachineEvent.const_991,this.onSoundMachineInit);
         this.var_88.addEventListener(RoomEngineSoundMachineEvent.const_849,this.onSoundMachineDispose);
         this.var_1333 = new Timer(1000);
         this.var_1333.start();
         this.var_1333.addEventListener(TimerEvent.TIMER,this.sendNextSongRequestMessage);
         this._events.addEventListener(SoundCompleteEvent.TRAX_SONG_COMPLETE,this.onSongFinishedPlayingEvent);
         _loc6_ = 0;
         while(_loc6_ < HabboMusicPrioritiesEnum.const_260)
         {
            this.var_332[_loc6_] = null;
            this.var_868[_loc6_] = 0;
            _loc6_++;
         }
      }
      ...
      protected function onSongFinishedPlayingEvent(param1:SoundCompleteEvent) : void
      {
         ...
         {
            if(this.getTopRequestPriority() == this._priorityPlaying && this.getSongRequestCountAtPriority(this._priorityPlaying) == this.var_2058)
            {
               this.resetSongStartRequest(this._priorityPlaying);
            }
            _loc2_ = this._priorityPlaying;
            this.playSongWithHighestPriority();
            if(_loc2_ >= HabboMusicPrioritiesEnum.const_408)
            {
               this._events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_132,_loc2_,param1.id,-1));
            }
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this._connection)
            {
               for each(_loc1_ in this.var_767)
               {
            ...
            if(this.var_288)
            {
               ...
               {
                  _loc3_ = this.var_288.getWithIndex(_loc2_) as SongDataEntry;
            ...
            if(this.var_88)
            {
               this.var_88.removeEventListener(RoomEngineSoundMachineEvent.const_976,this.onJukeboxInit);
               this.var_88.removeEventListener(RoomEngineSoundMachineEvent.const_245,this.onJukeboxDispose);
               this.var_88.removeEventListener(RoomEngineSoundMachineEvent.const_991,this.onSoundMachineInit);
               this.var_88.removeEventListener(RoomEngineSoundMachineEvent.const_849,this.onSoundMachineDispose);
            }
      ...
      {
         if(param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_260)
         {
            return false;
         }
         var _loc7_:SongStartRequestData = new SongStartRequestData(param2,param3,param4,param5,param6);
         this.var_332[param1] = _loc7_;
         this.var_868[param1] += 1;
         return true;
      }
      ...
      private function getSongIdRequestedAtPriority(param1:int) : int
      {
         ...
         if(this.var_332[param1] == null)
         {
            return -1;
         }
         var _loc2_:SongStartRequestData = this.var_332[param1];
      ...
      private function getSongRequestCountAtPriority(param1:int) : int
      {
         ...
         return this.var_868[param1];
      }
      
      private function getTopRequestPriority() : int
      {
         var _loc1_:int = this.var_332.length - 1;
         while(_loc1_ >= 0)
         {
            if(this.var_332[_loc1_] != null)
            {
               return _loc1_;
            }
            _loc1_--;
      ...
      private function getSongDataEntry(param1:int) : SongDataEntry
      {
         ...
         {
            _loc2_ = this.var_288.getValue(param1) as SongDataEntry;
         }
         return _loc2_;
      }
      ...
      public function updateVolume(param1:Number) : void
      {
         ...
         var _loc4_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < HabboMusicPrioritiesEnum.const_260)
         {
      ...
      {
         if(this.var_695.getValue(param1) == null)
         {
            this.var_695.add(param1,param2);
      ...
      {
         if(param1 >= 0 && param1 < this.var_407.length)
         {
            return this.var_407.getKey(param1);
         }
         return -1;
      }
      ...
      public function getSongDiskInventorySongId(param1:int) : int
      {
         if(param1 >= 0 && param1 < this.var_407.length)
         {
            return this.var_407.getWithIndex(param1);
         }
         return -1;
      }
      ...
      public function samplesUnloaded(param1:Array) : void
      {
         ...
         while(_loc2_ < this.var_288.length)
         {
            ...
            if(_loc3_.id != this.var_1615 && _loc4_ != null && _loc4_.ready)
            {
      ...
      public function get samplesIdsInUse() : Array
      {
         ...
         {
            if(this.var_332[_loc2_] != null)
            {
               _loc3_ = this.var_332[_loc2_];
               _loc4_ = this.var_288.getValue(_loc3_.songId);
               if(_loc4_ != null)
               {
      ...
      private function sendNextSongRequestMessage(param1:TimerEvent) : void
      {
         ...
         this._connection.send(new GetSongInfoMessageComposer(this.var_869));
         Logger.log("Requested song info\'s : " + this.var_869);
         this.var_869 = new Array();
      }
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               this.var_288.add(_loc6_.id,_loc10_);
               ...
               while(this.var_867.indexOf(_loc6_.id) != -1)
               {
                  this.var_867.splice(this.var_867.indexOf(_loc6_.id),1);
      ...
      {
         if(param2 == -1 || param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_260)
         {
            return false;
         }
         ...
         this.var_2058 = this.getSongRequestCountAtPriority(param1);
         this.var_1615 = param2;
         if(this._priorityPlaying <= const_1641)
         {
            this.notifySongPlaying(_loc4_);
         }
         if(param1 > HabboMusicPrioritiesEnum.const_138)
         {
            this._events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_133,param1,_loc4_.id,-1));
         }
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_2830 != param1.id || _loc3_ > this.var_2831 + 8000))
         {
            this._soundManager.notifyPlayedSong(param1.name,param1.creator);
            this.var_2830 = param1.id;
      ...
      private function areSamplesRequested(param1:int) : Boolean
      {
         ...
         return this.var_695.getValue(param1);
      }
      ...
      private function onSongDiskInventoryMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.songDiskCount)
         {
            ...
            this.var_407.add(_loc5_,_loc6_);
            if(this.var_288.getValue(_loc6_) == null)
            {
               this.var_867.push(_loc6_);
      ...
      private function onSoundMachineInit(param1:Event) : void
      {
         ...
         this.var_574 = new SoundMachinePlayListController(this._soundManager,this,this._events,this.var_88,this._connection) as IPlayListController;
      }
