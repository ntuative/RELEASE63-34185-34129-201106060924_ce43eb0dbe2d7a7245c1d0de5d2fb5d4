package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_239 = param2;
         this.var_767 = [];
         this.var_767.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_767.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         for each(_loc6_ in this.var_767)
         {
         ...
         this.var_88.addEventListener(RoomEngineSoundMachineEvent.const_765,this.onSoundMachinePlayEvent);
         this.var_88.addEventListener(RoomEngineSoundMachineEvent.const_901,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_88)
            {
               this.var_88.removeEventListener(RoomEngineSoundMachineEvent.const_765,this.onSoundMachinePlayEvent);
               this.var_88.removeEventListener(RoomEngineSoundMachineEvent.const_901,this.onSoundMachineStopEvent);
               this.var_88 = null;
            }
            this._disposed = true;
         }
      ...
      public function stopPlaying() : void
      {
         this.var_447 = -1;
         this.var_632 = false;
         this.var_239.stop(HabboMusicPrioritiesEnum.const_138);
      }
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_239.playSong(param1,HabboMusicPrioritiesEnum.const_138,_loc3_,0,0,0))
         {
