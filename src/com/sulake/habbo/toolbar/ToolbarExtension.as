package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarExtension
   {
      ...
      private static const const_1465:uint = 16777215;
      
      private static const const_1463:uint = 12247545;
      
      private static const const_1464:String = "HELP";
      
      private static const const_1466:String = "ROOMINFO";
      ...
      private var var_390:IWindow;
      
      private var var_625:IWindowContainer;
      
      private const const_844:int = 41;
      ...
      public function ToolbarExtension(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         this.var_390 = this._window.findChildByName("roominfo_region");
      ...
      {
         this.var_62.removeListItem(this.var_390);
      }
      
      public function showRoomInfo() : void
      {
         this.var_62.addListItemAt(this.var_390,0);
      }
      ...
      private function createWindow(param1:String) : IWindow
      {
         ...
         _loc3_.x = _loc4_.width - _loc3_.width - this.const_954;
         _loc3_.y = this.const_844;
         return _loc3_;
      }
      ...
      private function showConfirmation() : void
      {
         if(!this.var_625)
         {
            this.var_625 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
         }
      }
      ...
      private function onClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "logout_region":
               ...
               break;
            case "help_region":
               this._toolbar.toggleWindowVisibility(const_1464);
               break;
            case "roominfo_region":
               this._toolbar.toggleWindowVisibility(const_1466);
               break;
            case "confirm":
               if(false)
               {
