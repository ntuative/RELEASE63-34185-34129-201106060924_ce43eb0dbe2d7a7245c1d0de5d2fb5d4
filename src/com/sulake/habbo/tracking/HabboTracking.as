package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_1028:uint = 11;
      ...
      private var var_1158:IHabboWindowManager;
      ...
      private var var_254:PerformanceTracker = null;
      
      private var var_431:FramerateTracker = null;
      
      private var var_255:LatencyTracker = null;
      
      private var var_603:LagWarningLogger = null;
      
      private var var_430:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_254 = new PerformanceTracker();
         this.var_431 = new FramerateTracker();
         this.var_255 = new LatencyTracker();
         this.var_603 = new LagWarningLogger();
         this.var_430 = new ToolbarClickTracker(this);
         this.var_1439 = new Array(const_1028);
         var _loc4_:int = 0;
         while(_loc4_ < const_1028)
         {
            this.var_1439[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1821,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1714,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1803,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_925,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1178,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1158)
            {
               this.var_1158.release(new IIDHabboWindowManager());
               this.var_1158 = null;
            }
            if(this.var_299)
            {
            ...
            if(this.var_204)
            {
               if(!this.var_204.disposed)
               {
                  ...
                  Component(this.var_204).events.removeEventListener(HabboFriendListTrackingEvent.const_527,this.onFriendlistTrackingEvent);
               }
            ...
            if(this._roomEngine)
            {
               if(!this._roomEngine.disposed)
               {
                  ...
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_185,this.onRoomAction);
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_357,this.onRoomAction);
               }
            ...
            {
               this.var_302.stop();
               this.var_302.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
               this.var_302 = null;
            }
      ...
      {
         this.var_1439[param2] = param1;
      }
      
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_181 = IHabboConfigurationManager(param2);
         if(this.var_181)
         {
            if(this.var_255 != null)
            {
               this.var_255.configuration = this.var_181;
            }
            if(this.var_254 != null)
            {
               this.var_254.configuration = this.var_181;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1961);
            if(this.var_181)
            {
               if(this.var_603 != null)
               {
                  this.var_603.configure(this.var_181);
               }
               if(this.var_431 != null)
               {
                  this.var_431.configure(this.var_181);
               }
               if(this.var_430 != null)
               {
                  this.var_430.configure(this.var_181);
               }
            }
         }
      }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.trackLoginStep(HabboLoginTrackingStep.const_175);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_764,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_841,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_79,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_511,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_255 != null)
            {
               this.var_255.communication = this._communication;
               this.var_255.connection = param1;
            }
            if(this.var_603 != null)
            {
               this.var_603.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_841)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1741);
         }
         else if(param1.type == HabboHotelViewEvent.const_511)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1790);
         }
         else if(param1.type == HabboHotelViewEvent.const_79)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1778);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1905);
               break;
            case HabboCommunicationEvent.const_764:
               this.trackLoginStep(HabboLoginTrackingStep.const_1713,String(this._communication.port));
               break;
      ...
      {
         this.var_1158 = IHabboWindowManager(param2);
         if(this.var_1158)
         {
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_181)
            {
               if(this.var_181.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = this.var_181.getKey("client.fatal.error.url");
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1439)
                  {
                  ...
                  if(this.var_254 != null)
                  {
                     _loc4_["null"] = this.var_254.flashVersion;
                     _loc4_["null"] = this.var_254.averageUpdateInterval;
                  }
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1236);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1236,this.onCoreRunning);
         }
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_204).events.addEventListener(HabboFriendListTrackingEvent.const_527,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_527:
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2334)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1798);
            this.var_2334 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.privateRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1178,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_925,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_185,this.onRoomAction);
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_357,this.onRoomAction);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_299 = param2 as IAdManager;
         this.var_299.events.addEventListener(AdEvent.const_623,this.onRoomAdLoad);
      }
      ...
      {
         if(param1.type == RoomEngineEvent.const_185)
         {
            if(this.var_1728 < 1)
            {
               if(!this.var_302)
               {
                  this.var_302 = new Timer(60000,1);
                  this.var_302.addEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
                  this.var_302.start();
               }
            }
         }
         else if(param1.type == RoomEngineEvent.const_357)
         {
            if(this.var_302)
            {
               this.var_302.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
         ...
         if(!disposed)
         {
            if(this._connection)
            {
               if(this.var_431)
               {
                  ...
                  if(this._roomEngine)
                  {
                     _loc3_ = this._roomEngine.getRoomObjectCount(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectCategoryEnum.const_30);
                  ...
                  this.trackEventLog("Performance","fps",String(this.var_431.frameRate),_loc2_);
                  ++this.var_1728;
               }
            }
         }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_430)
         {
            this.var_430.track(param1.iconName);
         }
      }
      ...
      private function onZoomToggle(param1:HabboNavigatorEvent) : void
      {
         if(this.var_430)
         {
            this.var_430.track(param1.type);
         }
      }
      ...
      {
         if(this.var_181 != null && !Boolean(this.var_181.getKey("processlog.enabled")))
         {
            return;
         }
      ...
      {
         this.var_603.chatLagDetected(param1);
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_509 > -1 && _loc2_ < this.var_509)
         {
            ++this.var_1729;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1729);
         }
         if(this.var_509 > -1 && _loc2_ - this.var_509 > 15000)
         {
            ++this.var_1730;
         ...
         if(this.var_254 != null)
         {
            this.var_254.update(param1,this.var_509);
         }
         if(this.var_255 != null)
         {
            this.var_255.update(param1,this.var_509);
         }
         if(this.var_431 != null)
         {
            this.var_431.trackUpdate(param1,this,this.var_509);
         }
         if(this.var_603 != null)
         {
            this.var_603.update(this.var_509);
         }
      }
   }
}
