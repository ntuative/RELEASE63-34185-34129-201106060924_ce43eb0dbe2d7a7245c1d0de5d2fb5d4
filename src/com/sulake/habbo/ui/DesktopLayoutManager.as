package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private static const const_700:String = "room_view";
      
      private static const const_1660:String = "room_widget";
      ...
      public function setLayout(param1:XML, param2:IHabboWindowManager, param3:IHabboConfigurationManager) : void
      {
         ...
         while(_loc6_ < this.var_94.numChildren)
         {
            ...
            {
               _loc5_.addEventListener(WindowEvent.const_124,this.trimContainer);
            }
            _loc6_++;
         }
      }
      ...
      public function addWidgetWindow(param1:String, param2:IWindow) : Boolean
      {
         ...
         if(param1 == RoomWidgetEnum.const_433)
         {
         ...
         {
            if(String(_loc3_[_loc5_]).indexOf(const_1660) == 0)
            {
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = this.var_94.getChildByTag(const_700) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = this.var_94.findChildByTag(const_700) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
