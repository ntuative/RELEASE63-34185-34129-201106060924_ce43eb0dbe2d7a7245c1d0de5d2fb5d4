package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      public static const const_634:int = -1;
      ...
      private var var_1139:IHabboHelp = null;
      ...
      private var var_348:DesktopLayoutManager;
      ...
      private var var_2214:uint = 16777215;
      ...
      private var var_1671:Rectangle;
      ...
      public function RoomDesktop(param1:IRoomSession, param2:IAssetLibrary, param3:IConnection)
      {
         ...
         this.var_348 = new DesktopLayoutManager();
      }
      ...
      public function set friendList(param1:IHabboFriendList) : void
      {
         ...
         if(this._friendList)
         {
            this._friendList.events.addEventListener(FriendRequestEvent.const_65,this.processEvent);
            this._friendList.events.addEventListener(FriendRequestEvent.const_327,this.processEvent);
         }
      }
      ...
      {
         this.var_348.setLayout(param1,this._windowManager,this._config);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this._friendList.events.removeEventListener(FriendRequestEvent.const_65,this.processEvent);
            this._friendList.events.removeEventListener(FriendRequestEvent.const_327,this.processEvent);
         }
         ...
         {
            this.var_500.reset();
            this.var_500.removeEventListener(TimerEvent.TIMER,this.onResizeTimerEvent);
            this.var_500 = null;
         }
         this.var_1671 = null;
      }
      ...
      public function init() : void
      {
         if(this._roomEngine != null && this.var_31 != null)
         {
            this.var_728 = this._roomEngine.loadRoomResources(this.var_31.roomResources);
         ...
         if(this.var_299 != null && this.var_31.state == RoomSessionEvent.const_258)
         {
            this.var_1673 = !this.var_299.showInterstitial();
         }
      ...
      private function onRoomContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         var _loc2_:int = this.var_728.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
            this.var_728.splice(_loc2_,1);
         }
         if(this.var_728.length == 0)
         {
            this.var_1672 = true;
      ...
      public function createWidget(param1:String) : void
      {
         ...
         var _loc2_:IRoomWidget = this.var_37.getValue(param1) as IRoomWidget;
         if(_loc2_ != null)
         {
            return;
         }
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc9_ != null)
            {
               ...
               {
                  _loc8_ = this.var_726.getValue(_loc11_);
                  if(_loc8_ == null)
                  {
                     _loc8_ = [];
                     this.var_726.add(_loc11_,_loc8_);
                  }
                  else
                  {
            ...
            if(_loc10_ != null)
            {
               ...
               {
                  _loc8_ = this.var_727.getValue(_loc12_);
                  if(_loc8_ == null)
                  {
                     _loc8_ = [];
                     this.var_727.add(_loc12_,_loc8_);
                  }
                  _loc8_.push(_loc4_);
               }
            }
         }
         _loc2_ = this.var_1122.createWidget(param1,_loc4_);
         if(_loc2_ == null)
         {
            return;
         }
         ...
         this.var_348.addWidgetWindow(param1,_loc2_.mainWindow);
         ...
         {
            param1 = "null";
            _loc13_ = new RoomWidgetRoomViewUpdateEvent(param1,this.var_348.roomViewRect);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         var _loc2_:Array = this.var_726.getValue(param1.type);
         if(_loc2_ != null)
         {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         var _loc2_:Array = this.var_727.getValue(param1.type);
         if(_loc2_ != null)
         {
            for each(_loc3_ in _loc2_)
            {
      ...
      private function isFurnitureSelectionDisabled(param1:RoomEngineObjectEvent) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               if(_loc4_.getNumber(RoomObjectVariableEnum.const_1141) == 1)
               {
                  _loc2_ = true;
                  if(this.var_395.isAnyRoomController)
                  {
                     _loc2_ = false;
                  }
               }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_779:
               ...
               {
                  _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_981,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               }
               if(this.var_910 != null && _loc3_ == RoomObjectCategoryEnum.const_30)
               {
                  _loc7_ = this.var_31.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_125)
                  {
                     this.var_910.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            ...
            case RoomEngineObjectEvent.const_184:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_998,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               break;
            case RoomEngineObjectEvent.const_180:
               ...
               break;
            case RoomEngineObjectEvent.const_811:
            ...
            case RoomEngineObjectEvent.const_172:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_977,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               this.processWidgetMessage(_loc5_);
               break;
            ...
            case RoomEngineObjectEvent.const_156:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_946,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               this.processWidgetMessage(_loc5_);
               break;
            ...
            case RoomEngineObjectEvent.const_162:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_965,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               this.processWidgetMessage(_loc5_);
               break;
            case RoomEngineObjectEvent.const_160:
               ...
               this.processWidgetMessage(_loc5_);
               break;
            case RoomEngineObjectEvent.const_622:
      ...
      public function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomEngineEvent.const_502:
               _loc2_ = new RoomWidgetRoomEngineUpdateEvent(RoomWidgetRoomEngineUpdateEvent.const_435,param1.roomId,param1.roomCategory);
         }
         if(_loc2_ != null)
         {
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         var _loc21_:* = null;
         var _loc2_:Rectangle = this.var_348.roomViewRect;
         ...
         if(_loc7_ != null)
         {
            _loc13_ = this._roomEngine.getRoomNumberValue(this.var_31.roomId,this.var_31.roomCategory,RoomVariableEnum.const_810);
            _loc14_ = this._roomEngine.getRoomNumberValue(this.var_31.roomId,this.var_31.roomCategory,RoomVariableEnum.const_710);
            _loc15_ = this._roomEngine.getRoomNumberValue(this.var_31.roomId,this.var_31.roomCategory,RoomVariableEnum.const_1004);
            _loc16_ = this._roomEngine.getRoomNumberValue(this.var_31.roomId,this.var_31.roomCategory,RoomVariableEnum.const_900);
         ...
         _loc10_.addEventListener(WindowMouseEvent.const_230,this.canvasMouseHandler);
         ...
         _loc10_.addEventListener(WindowMouseEvent.const_226,this.canvasMouseHandler);
         ...
         this.var_348.addRoomView(_loc9_);
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(this.var_2214);
      ...
      {
         var _loc3_:IWindowContainer = this.var_348.getRoomView() as IWindowContainer;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function getRoomViewRect() : Rectangle
      {
         ...
         return this.var_348.roomViewRect;
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         this.var_1671 = _loc2_.rectangle;
         this._roomEngine.modifyRoomCanvas(this.var_31.roomId,this.var_31.roomCategory,this.var_298[0],_loc2_.width,_loc2_.height);
         if(this.var_500 == null)
         {
            this.var_500 = new Timer(const_1380,1);
            this.var_500.addEventListener(TimerEvent.TIMER,this.onResizeTimerEvent);
         }
         else
         {
            this.var_500.reset();
      ...
      private function onResizeTimerEvent(param1:TimerEvent) : void
      {
         ...
         this.events.dispatchEvent(new RoomWidgetRoomViewUpdateEvent(_loc2_,this.var_1671));
      }
      ...
      {
         if(this.var_16 != null && this.var_31 != null && this.var_1673 && this.var_1672)
         {
      ...
      private function handleRoomAdClick(param1:RoomEngineObjectEvent) : void
      {
         ...
         var _loc4_:String = _loc3_.getString(RoomObjectVariableEnum.const_436);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_604:
               ...
               this.var_225 = this._windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_417,WindowStyle.const_131,WindowParam.const_101) as IToolTipWindow;
      ...
      public function method_11(param1:IRoomWidgetHandler) : void
      {
         if(this._updateListeners == null)
         {
            return;
