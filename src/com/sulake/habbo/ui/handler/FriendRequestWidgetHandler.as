package com.sulake.habbo.ui.handler
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_866);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_791);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_732);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_866:
               ...
               if(_loc4_)
               {
                  _loc5_ = this._container.roomEngine.getRoomObjectBoundingRectangle(_loc3_.roomId,_loc3_.roomCategory,_loc4_.id,RoomObjectCategoryEnum.const_30,this._container.getFirstCanvasId());
                  _loc6_ = this._container.roomEngine.getRoomObjectScreenLocation(_loc3_.roomId,_loc3_.roomCategory,_loc4_.id,RoomObjectCategoryEnum.const_30,this._container.getFirstCanvasId());
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_791:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_732:
      ...
      public function getProcessedEvents() : Array
      {
         ...
         _loc1_.push(FriendRequestEvent.const_65);
         _loc1_.push(FriendRequestEvent.const_327);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionFriendRequestEvent.const_150:
               ...
               break;
            case FriendRequestEvent.const_65:
            case FriendRequestEvent.const_327:
