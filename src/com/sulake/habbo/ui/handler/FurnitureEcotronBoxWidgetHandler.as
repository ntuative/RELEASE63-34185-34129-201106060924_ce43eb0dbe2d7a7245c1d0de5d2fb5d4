package com.sulake.habbo.ui.handler
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_761,RoomWidgetEcotronBoxOpenMessage.const_1007,RoomWidgetEcotronBoxOpenedMessage.const_1733];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_761:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_1007:
