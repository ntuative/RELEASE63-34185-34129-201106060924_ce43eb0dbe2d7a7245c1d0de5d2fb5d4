package com.sulake.habbo.ui.handler
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         {
            this.var_239.events.addEventListener(NowPlayingEvent.const_104,this.onNowPlayingChanged);
            this.var_239.events.addEventListener(SongInfoReceivedEvent.const_96,this.onSongInfoReceivedEvent);
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_189,this.onFigureUpdate);
         ...
         if(this._container.roomSessionManager != null)
         {
            this._container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_189,this.onFigureUpdate);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_706.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_706.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_239 != null)
         {
            this.var_239.events.removeEventListener(NowPlayingEvent.const_104,this.onNowPlayingChanged);
            this.var_239.events.removeEventListener(SongInfoReceivedEvent.const_96,this.onSongInfoReceivedEvent);
            this.var_239 = null;
         }
         this.var_1113 = true;
         this.container = null;
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_514);
         _loc1_.push(RoomWidgetRoomObjectMessage.const_999);
         _loc1_.push(RoomWidgetUserActionMessage.const_491);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_910);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_927);
         _loc1_.push(RoomWidgetFurniActionMessage.const_1362);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_715);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_718);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_818);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1919);
         _loc1_.push(RoomWidgetPetCommandMessage.const_626);
         _loc1_.push(RoomWidgetPetCommandMessage.const_885);
         _loc1_.push(RoomWidgetUserActionMessage.const_561);
         _loc1_.push(RoomWidgetUserActionMessage.const_450);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_840);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            else if(param1.type == RoomWidgetUserActionMessage.const_450 || param1.type == RoomWidgetUserActionMessage.const_561 || param1.type == RoomWidgetUserActionMessage.const_487)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_524:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1238,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_518:
               ...
               break;
            case RoomWidgetUserActionMessage.const_910:
            ...
            case RoomWidgetFurniActionMessage.const_724:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_927:
               this._container.roomEngine.useRoomObjectInActiveRoom(_loc5_,_loc6_);
               break;
            case RoomWidgetFurniActionMessage.const_1362:
            ...
            case RoomWidgetUserActionMessage.const_450:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_715:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_718:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_818:
      ...
      private function handleGetObjectNameMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               {
                  _loc11_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_241);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_318);
               _loc6_.id = param1.id;
               _loc6_.category = param1.category;
               _loc7_ = this._container.roomEngine.getRoomObject(_loc2_,_loc3_,param1.id,param1.category);
               _loc8_ = _loc7_.getModel();
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_391) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_391);
               }
               else if(_loc8_.getNumber(RoomObjectVariableEnum.const_932) == 1)
               {
                  _loc6_.extraParam = RoomWidgetInfostandExtraParamEnum.const_1267;
               }
               ...
               {
                  _loc24_ = _loc8_.getNumber(RoomObjectVariableEnum.const_241);
                  if(param1.category == RoomObjectCategoryEnum.const_27)
                  {
               ...
               _loc10_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1264);
               _loc11_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1166);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc28_ = "";
                  _loc29_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_523)
                  {
                  ...
                  else if(_loc6_.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_421) == 0)
                  {
                     _loc31_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_421.length);
            ...
            case RoomObjectCategoryEnum.const_30:
               ...
               if(_loc12_.type == RoomObjectTypeEnum.const_224)
               {
                  this._container.roomSession.userDataManager.requestPetInfo(_loc12_.webID);
                  return null;
               }
               if(_loc12_.type == RoomObjectTypeEnum.const_125)
               {
                  _loc13_ = "null";
               ...
               {
                  if(_loc12_.type != RoomObjectTypeEnum.const_489)
                  {
                     return null;
                  }
                  _loc13_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc14_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_358);
               }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_153)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc38_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_792);
                  ...
                  if(!_loc34_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_870;
                  }
                  if(!_loc35_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_725;
                  }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc15_.push(RoomWidgetUserInfoUpdateEvent.const_1689);
               }
               else
               {
               ...
               _loc19_ = _loc12_.sex;
               _loc20_ = this._container.avatarRenderManager.createAvatarImage(_loc18_,AvatarScaleType.const_60,_loc19_);
               if(_loc20_ != null)
               {
      ...
      {
         return [RoomSessionUserBadgesEvent.const_142];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_142:
      ...
      private function onFigureUpdate(param1:RoomSessionUserFigureUpdateEvent) : void
      {
         ...
         {
            _loc5_ = this._container.avatarRenderManager.createAvatarImage(param1.figure,AvatarScaleType.const_60,param1.gender);
            if(_loc5_ != null)
            {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_706.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_706.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            _loc8_ = _loc2_.method_2 == this._container.sessionDataManager.userId;
            _loc9_ = new RoomWidgetPetInfoUpdateEvent(_loc5_,_loc6_,_loc3_.name,_loc2_.petId,_loc7_,_loc8_,_loc2_.method_2,_loc2_.ownerName,_loc3_.id);
            ...
            _loc13_ = this._container.roomSession.userDataManager.getUserData(_loc2_.method_2);
            if(_loc13_ != null)
            {
               _loc14_ = this._container.roomEngine.getRoomObject(_loc11_,_loc12_,_loc13_.id,RoomObjectCategoryEnum.const_30);
               if(_loc14_ != null)
               {
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc3_ < 8)
         {
            _loc4_ = this._container.avatarRenderManager.createPetImageFromFigure(param1,AvatarScaleType.const_60,null);
            if(_loc4_ != null)
            {
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_239 != null)
         {
            ...
            this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_437,_loc2_,_loc3_,_loc4_));
         }
      }
