package com.sulake.habbo.ui.widget
{
   ...
   public class RoomWidgetFactory extends Component implements IRoomWidgetFactory
   {
      ...
      private var var_3007:IAssetLibrary;
      ...
      public function RoomWidgetFactory(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_3007 = param1.root.assets;
      ...
      public function createWidget(param1:String, param2:IRoomWidgetHandler) : IRoomWidget
      {
         ...
         switch(param1)
         {
            case RoomWidgetEnum.const_453:
               _loc3_ = new RoomChatWidget(param2,this._windowManager,assets,this.var_67,this.var_143,this.var_2557++,this,this._questEngine);
               break;
            case RoomWidgetEnum.const_433:
               _loc3_ = new RoomChatInputWidget(param2,this._windowManager,assets,this.var_67,this.var_143,this);
               break;
            case RoomWidgetEnum.const_542:
               _loc3_ = new InfostandWidget(param2,this._windowManager,assets,this.var_67,this.var_143,this._catalog);
               break;
            case RoomWidgetEnum.const_515:
               _loc3_ = new MeMenuWidget(param2,this._windowManager,assets,this.var_67,events,this.var_143);
               break;
            case RoomWidgetEnum.const_929:
               _loc3_ = new PlaceholderWidget(param2,this._windowManager,assets,this.var_67);
               break;
            case RoomWidgetEnum.const_520:
               _loc3_ = new CreditFurniWidget(param2,this._windowManager,assets,this.var_67);
               break;
            ...
            case RoomWidgetEnum.const_650:
               _loc3_ = new TeaserFurniWidget(param2,this._windowManager,assets,this.var_67,this.var_143,this.var_13);
               break;
            ...
            case RoomWidgetEnum.const_585:
               _loc3_ = new PetPackageFurniWidget(param2,this._windowManager,assets,this.var_67);
               break;
            case RoomWidgetEnum.const_130:
               _loc3_ = new DoorbellWidget(param2,this._windowManager,assets,this.var_67);
               break;
            case RoomWidgetEnum.const_573:
               _loc3_ = new LoadingBarWidget(param2,this._windowManager,assets,this.var_67,this.var_143);
               break;
            case RoomWidgetEnum.const_857:
               _loc3_ = new RoomQueueWidget(param2,this._windowManager,assets,this.var_67,this.var_143);
               break;
            case RoomWidgetEnum.const_126:
               _loc3_ = new VoteWidget(param2,this._windowManager,assets,this.var_67,this.var_143);
               break;
            case RoomWidgetEnum.const_432:
               _loc3_ = new PollWidget(param2,this._windowManager,assets,this.var_67);
               break;
            case RoomWidgetEnum.const_353:
               _loc3_ = new UserChooserWidget(param2,this._windowManager,assets,this.var_67);
               break;
            case RoomWidgetEnum.const_525:
               _loc3_ = new FurniChooserWidget(param2,this._windowManager,assets,this.var_67);
               break;
            case RoomWidgetEnum.const_547:
               _loc3_ = new DimmerFurniWidget(param2,this._windowManager,assets,this.var_67);
               break;
            case RoomWidgetEnum.const_150:
               _loc3_ = new FriendRequestWidget(param2,this._windowManager,assets,this.var_67,this);
               break;
            case RoomWidgetEnum.const_593:
               _loc3_ = new ClothingChangeFurnitureWidget(param2,this._windowManager,assets,this.var_67);
               break;
            case RoomWidgetEnum.const_986:
               _loc3_ = new RoomWidgetBase(param2,this._windowManager);
               break;
            case RoomWidgetEnum.const_122:
               _loc3_ = new UserNotificationWidget(param2,this._windowManager,assets,this.var_67);
               break;
            case RoomWidgetEnum.const_446:
               _loc3_ = new PurseWidget(param2,this._windowManager,assets,this.var_67);
               break;
            case RoomWidgetEnum.const_135:
               _loc3_ = new AvatarInfoWidget(param2,this._windowManager,assets,this.var_143,this.var_67,this);
               break;
            case RoomWidgetEnum.const_521:
               _loc3_ = new WelcomeGiftWidget(param2,this._windowManager,assets,this.var_67);
               break;
            case RoomWidgetEnum.const_607:
               _loc3_ = new PlayListEditorWidget(param2,this._windowManager,this._soundManager,assets,this.var_67,this.var_143,this._catalog);
               break;
