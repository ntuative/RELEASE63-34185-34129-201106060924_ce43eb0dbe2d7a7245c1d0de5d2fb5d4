package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarMenuView extends AvatarInfoView
   {
      ...
      protected static const const_1371:uint = 0;
      
      protected static const const_371:uint = 1;
      
      protected static const const_1010:uint = 2;
      
      protected static var var_1399:uint = const_371;
      
      private static const const_1381:uint = 16744755;
      
      private static const const_1382:uint = 16756591;
       
      
      protected var _data:AvatarInfoData;
      
      protected var var_341:uint = 1;
      ...
      protected function updateButtons() : void
      {
         ...
         if(!this.var_1376)
         {
            ...
            {
               this.var_341 = const_1010;
            }
            else
            {
               this.var_341 = var_1399;
            }
         }
         if(this.var_341 == const_1371)
         {
         ...
         if(this.var_341 == const_1371 || this.var_341 == const_371)
         {
            ...
            else
            {
               ...
               this.var_341 = const_371;
            }
         }
         if(this.var_341 == const_371)
         {
      ...
      private function buttonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            else if(param2.tags.indexOf("link") > -1)
            {
               ...
               {
                  ITextWindow(IWindowContainer(param2).getChildAt(0)).textColor = const_1382;
               }
            }
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            ...
            else if(param2.tags.indexOf("link") > -1)
            {
               ...
               {
                  ITextWindow(IWindowContainer(param2).getChildAt(0)).textColor = const_1381;
               }
            }
         }
         if(_loc3_)
