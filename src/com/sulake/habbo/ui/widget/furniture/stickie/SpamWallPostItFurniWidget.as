package com.sulake.habbo.ui.widget.furniture.stickie
{
   ...
   public class SpamWallPostItFurniWidget extends StickieFurniWidget
   {
      ...
      {
         var_2204 = "spamwall_postit_container";
      ...
      private function onEditPostItRequest(param1:RoomWidgetSpamWallPostItEditEvent) : void
      {
         ...
         this.var_477 = param1.location;
         var_1384 = param1.objectType;
         _text = "";
         var_343 = "FFFF33";
         _controller = true;
         showInterface();
      ...
      override protected function sendUpdate() : void
      {
         ...
         if(var_222 != -1)
         {
            ...
            {
               _loc1_ = new RoomWidgetSpamWallPostItFinishEditingMessage(RoomWidgetSpamWallPostItFinishEditingMessage.const_936,var_222,this.var_477,_text,var_343);
