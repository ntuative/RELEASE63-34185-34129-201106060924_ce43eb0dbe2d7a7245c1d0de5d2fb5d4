package com.sulake.habbo.ui.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_2023:int = 0;
      
      private const const_2019:int = 1;
      
      private const const_2024:int = 2;
      
      private const const_2021:int = 3;
      
      private const const_2018:int = 4;
      
      private const const_2288:int = 0;
      
      private const const_2284:int = 1;
      
      private const const_2280:int = 2;
      
      private const const_2281:int = 3;
      
      private const const_2287:int = 4;
      
      private const const_2285:int = 5;
      
      private const const_2022:String = "deco_img";
      
      private const const_2020:String = "dialog_bg";
      
      private const const_2283:String = "%campaign%_dialog_bg.png";
      
      private const const_377:String = "%campaign%_gift_package.png";
      
      private const const_2282:String = "%campaign%_gift_content.png";
      
      private const const_2286:String = "%campaign%_friend_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager, param6:IHabboInventory)
      {
         ...
         this.var_1616 = this.var_143.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1616 += "Viral/";
      }
      ...
      override public function dispose() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1617.length)
         {
            _loc2_ = this.var_1617.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_143 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_612,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_786,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_717,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_612,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_612:
               _loc2_ = this.const_2023;
               this._shareId = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_717:
               ...
               if(_loc5_)
               {
                  if(_loc4_ && _loc4_ != "")
                  {
                     _loc2_ = this.const_2021;
                     var_67.registerParameter("widget.furni.teaser.notify.unlocked.desc","username",_loc4_);
                  }
                  else
                  {
                     _loc2_ = this.const_2024;
                  }
               }
               else
               {
               ...
               this._shareId = null;
               this.var_1618 = param1.itemCategory;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_786:
               _loc2_ = this.const_2019;
               this.var_222 = param1.objectId;
               this._shareId = param1.data;
               this.var_415 = param1.status;
               this.var_1618 = param1.itemCategory;
               var_67.registerParameter("notifications.viral_furni.fb.title","realname",param1.ownRealName);
               var_67.registerParameter("notifications.viral_furni.fb.desc","realname",param1.ownRealName);
               var_67.registerParameter("widget.furni.teaser.gift.unlocked.desc","username",param1.firstClickUserName);
               break;
            default:
               Logger.log("Error, invalid viral widget update message: " + param1.type);
         }
         if(this._window && (this.var_1619 != _loc2_ || _loc3_ != this.var_196))
         {
            this._window.dispose();
            this._window = null;
         }
         ...
         if(!this._window)
         {
            switch(this.var_1619)
            {
               ...
               case this.const_2019:
                  ...
                  else if(this.var_415 == this.const_2284)
                  {
                     ...
                     _loc2_ = this.const_2282;
                  }
                  else if(this.var_415 == this.const_2280)
                  {
                     ...
                     _loc3_ = var_67.getKey("widget.furni.teaser.gift.no_fb.title");
                     _loc4_ = var_67.getKey("widget.furni.teaser.gift.no_fb.desc");
                     _loc2_ = this.const_377;
                  }
                  else if(this.var_415 == this.const_2281)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_196,"client.show.not_enough_fb_friends");
                     _loc3_ = var_67.getKey("widget.furni.teaser.gift.no_spam.title");
                     _loc4_ = var_67.getKey("widget.furni.teaser.gift.no_spam.desc");
                     _loc2_ = this.const_377;
                  }
                  else if(this.var_415 == this.const_2287)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_196,"client.show.not_enough_fb_friends");
                     _loc3_ = var_67.getKey("widget.furni.teaser.gift.no_min_fb_friends.title");
                     _loc4_ = var_67.getKey("widget.furni.teaser.gift.no_min_fb_friends.desc");
                     _loc2_ = this.const_377;
                  }
                  else if(this.var_415 == this.const_2285)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_196,"client.show.campaign_closed");
                     _loc3_ = var_67.getKey("widget.furni.teaser.gift.campaign_closed.title","widget.furni.teaser.gift.campaign_closed.title");
                     _loc4_ = var_67.getKey("widget.furni.teaser.gift.campaign_closed.desc","widget.furni.teaser.gift.campaign_closed.desc");
                     _loc2_ = this.const_377;
                  }
                  break;
               case this.const_2024:
                  _loc1_ = assets.getAssetByName("notification_gift_received") as XmlAsset;
                  _loc2_ = this.const_2286;
                  break;
            ...
            _loc5_ = this.const_2283.replace("%campaign%",this.var_196);
            this.setDecoImage(_loc5_,this.const_2020);
            _loc2_ = _loc2_.replace("%campaign%",this.var_196);
            this.setDecoImage(_loc2_,this.const_2022);
            if(_loc3_)
            {
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_772);
      ...
      {
         var _loc2_:String = var_67.getKey("notifications.viral_furni.fb.title");
         var _loc3_:String = var_67.getKey("notifications.viral_furni.fb.desc");
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(this.var_13)
         {
            if(this.var_1618 != 0)
            {
               this.var_13.toggleInventoryPage(this.var_1618 == 1 ? "null" : InventoryCategory.const_139);
            }
         }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_755,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1617.push(new ImageDownloader(this,_assets,this.var_196,this.var_1616,param1,param2));
            return;
         }
