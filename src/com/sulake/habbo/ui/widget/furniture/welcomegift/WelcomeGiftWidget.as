package com.sulake.habbo.ui.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_695:String = "welcome_gift_email_unverified";
      
      private const const_1129:String = "welcome_gift_email_verified";
      
      private const const_1648:String = "welcome_gift_email_change";
      
      private const const_2289:int = 4;
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1339)
         {
            this.setViewState(this.const_1129);
         }
         else
         {
            this.setViewState(this.const_695);
         }
      }
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_695:
               ...
               this._view.findChildByName("edit_text").visible = this.var_1083;
               this._view.findChildByName("edit").setParamFlag(WindowParam.const_31,this.var_1083);
               break;
            ...
            case this.const_1648:
               ...
               this.setBitmap("email_icon","email_icon");
               this.setButtonState("save_email",this.var_1083);
               _loc6_ = this._view.findChildByName("email_input") as ITextFieldWindow;
               _loc6_.caption = this.var_1629;
               _loc6_.focus();
      ...
      {
         this.setViewState(this.const_1648);
      }
      ...
      {
         this.setViewState(!!this.var_1339 ? this.const_1129 : this.const_695);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1628 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1628));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_627,this.updateEventHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_627,this.updateEventHandler);
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_627:
               this.var_1629 = param1.email;
               this.var_1339 = param1.isVerified;
               this.var_1083 = param1.allowEmailChange;
      ...
      private function emailChangeHandler(param1:RoomWidgetChangeEmailResultEvent) : void
      {
         if(param1.result == 0)
         {
            this.var_1629 = this.var_1628;
            this.setViewState(this.const_695);
         }
         else
         {
            if(param1.result == this.const_2289)
            {
               this.var_1083 = false;
            }
      ...
      private function showEmailChangeError(param1:int) : void
      {
         ...
         this.setCaption("email_input",this.var_1628);
