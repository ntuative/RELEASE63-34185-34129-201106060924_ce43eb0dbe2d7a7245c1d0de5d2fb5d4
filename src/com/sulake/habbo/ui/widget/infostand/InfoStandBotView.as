package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandBotView extends InfoStandUserView
   {
      ...
      override protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         _loc3_ = var_52.getListItemByName("score_spacer") as ITextWindow;
         var_52.removeListItem(_loc3_);
         _loc3_ = var_52.getListItemByName("score_text") as ITextWindow;
         var_52.removeListItem(_loc3_);
         _loc3_ = var_52.getListItemByName("score_value") as ITextWindow;
         var_52.removeListItem(_loc3_);
      }
      ...
      override protected function updateButtons(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         var_103.visible = param1.canBeKicked;
      }
