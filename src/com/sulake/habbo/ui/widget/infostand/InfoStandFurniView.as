package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      protected function createWindow(param1:String) : void
      {
         ...
         this.var_249 = this.var_47.findChildByTag("catalog");
         if(this.var_249 != null)
         {
            this.var_249.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onCatalogButtonClicked);
         }
      }
      ...
      {
         if(this.var_52 == null || this.var_47 == null || this._buttons == null)
         {
            return;
         }
      ...
      public function update(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         if(param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_1267 || param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_523 && param1.isRoomOwner)
         {
      ...
      private function showCatalogButton(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_52.addListItem(this.var_249);
            }
            this.var_249.visible = param1;
         }
         else
         {
            this.var_52.removeListItem(this.var_249);
         }
      }
   }
}
