package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private static const const_1625:int = 152;
      
      private static const const_1632:int = 16;
      
      private static const const_693:int = 4;
      
      private static const const_1626:uint = 14342874;
      
      private static const const_1635:uint = 3815994;
      
      private static const const_1627:uint = 2085362;
      
      private static const const_1634:uint = 39616;
      
      private static const const_1633:uint = 10513106;
      
      private static const const_1623:uint = 8734654;
      
      private static const const_1629:uint = 9094430;
      
      private static const const_1631:uint = 6200576;
      
      private static const const_1630:String = "happiness";
      
      private static const const_1628:String = "experience";
      
      private static const const_1624:String = "energy";
      
      private static const const_1636:int = 250;
      
      private static const const_1126:int = 25;
      
      private static const const_1125:int = 5;
      ...
      private var var_218:PetCommandTool;
      ...
      private function updateWindow() : void
      {
         ...
         this.var_103.width = this.var_103.width;
         this.var_103.visible = this.var_103.width > 0;
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(const_1630,param1.nutrition,param1.nutritionMax,const_1634,const_1627);
         this.updateStateElement(const_1628,param1.experience,param1.experienceMax,const_1623,const_1633);
         this.updateStateElement(const_1624,param1.energy,param1.energyMax,const_1631,const_1629);
         ...
         this.updateWindow();
         this.var_518 = param1.id;
         this._petData.remove(param1.id);
         this._petData.add(param1.id,param1);
         if(this.var_218 && this.var_218.isVisible() && param1.isOwnPet)
         {
            this.var_218.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:CommandConfiguration) : void
      {
         ...
         this.var_218.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(const_1625,const_1632,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),const_1626);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,const_1635);
         var _loc9_:Rectangle = new Rectangle(1,1 + const_693,_loc7_.width - 2,_loc7_.height - 2 - const_693);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,const_693);
      ...
      private function openTrainView() : void
      {
         if(this.var_218 == null)
         {
            this.var_218 = new PetCommandTool(this._widget);
         }
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_518) as InfoStandPetData;
         if(_loc1_ != null)
         {
            this.var_218.showWindow(true);
            this.var_218.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var _loc4_:* = [];
         this.var_103.groupChildrenWithTag("CMD_BUTTON",_loc4_,true);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_218 && this.var_218.getPetId() == this.var_518)
               {
                  this.var_218.showWindow(false);
               }
               break;
            case "btn_train":
               this.openTrainView();
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1753,true);
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_396,this._widget.petData.method_2);
      ...
      private function arrangeButtons() : void
      {
         ...
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.visible)
            {
               ...
               {
                  _loc3_ = _loc1_;
                  _loc4_ += const_1126 + const_1125;
               }
               _loc5_.x = _loc3_ - _loc5_.width;
               _loc5_.y = _loc4_;
               _loc3_ = _loc5_.x - const_1125;
            }
         }
         this.var_103.height = _loc4_ + const_1126;
         this.updateWindow();
      }
   }
}
