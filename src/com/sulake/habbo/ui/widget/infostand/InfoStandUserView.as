package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      protected var var_103:IWindowContainer;
      
      private var var_47:IBorderWindow;
      
      private var var_1024:TagListRenderer;
      
      private var var_142:IBorderWindow;
      
      private var var_2597:int;
      
      private var var_2596:Boolean = true;
      
      private const const_1074:int = 5;
      
      private const const_2271:int = 3;
      
      private const const_1508:int = 11184810;
      
      private const const_1509:int = 16777215;
      
      private const const_2273:int = 2000;
      
      private const const_2274:int = 50;
      
      private const const_2272:int = 23;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1024 = new TagListRenderer(param1,this.onTagSelected);
         this.var_2596 = !this._widget.config.getBoolean("menu.avatar.enabled",false);
      }
      ...
      {
         if(this.var_52 == null || this.var_47 == null || this.var_103 == null)
         {
            return;
         }
         this.var_52.height = this.var_52.scrollableRegion.height;
         this.var_47.height = this.var_52.height + 20;
         this._window.width = Math.max(this.var_47.width,this.var_103.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_47.width < this.var_103.width)
         {
         ...
         {
            this.var_103.x = this._window.width - this.var_103.width;
            this.var_47.x = 0;
         }
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         this.var_103 = this._window.getListItemByName("button_list") as IWindowContainer;
         var _loc3_:* = [];
         this.var_103.groupChildrenWithTag("CMD_BUTTON",_loc3_,true);
         ...
         if(this.var_47 != null)
         {
            this.var_52 = this.var_47.findChildByName("infostand_element_list") as IItemListWindow;
         }
         ...
         var _loc9_:IWindowContainer = this.var_52.getListItemByName("motto_container") as IWindowContainer;
         if(_loc9_)
         {
      ...
      private function showGroupBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = this.var_142.getChildByName("name") as ITextWindow;
         if(_loc3_ != null)
         {
            _loc3_.text = "Group Info";
         }
         _loc4_ = this.var_142.getChildByName("description") as ITextWindow;
         if(_loc4_ != null)
         {
         ...
         this.var_142.x = _loc5_.left - this.var_142.width;
         this.var_142.y = _loc5_.top + (_loc5_.height - this.var_142.height) / 2;
      }
      ...
      private function showBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         this.createBadgeDetails();
         _loc6_ = this.var_142.getChildByName("name") as ITextWindow;
         if(_loc6_ != null)
         {
            _loc6_.text = this._widget.localizations.getBadgeName(_loc5_);
         }
         _loc6_ = this.var_142.getChildByName("description") as ITextWindow;
         if(_loc6_ != null)
         {
         ...
         this.var_142.x = _loc7_.left - this.var_142.width;
         this.var_142.y = _loc7_.top + (_loc7_.height - this.var_142.height) / 2;
      }
      ...
      private function createBadgeDetails() : void
      {
         ...
         this.var_142 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IBorderWindow;
         if(this.var_142 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_1074;
      ...
      {
         var _loc3_:IWindowContainer = this.var_52.getListItemByName("motto_container") as IWindowContainer;
         if(!_loc3_)
         {
            return;
         }
         ...
         var _loc6_:IWindowContainer = this.var_52.getListItemByName("motto_spacer") as IWindowContainer;
         ...
         if(param2)
         {
            ...
            if(param1 == "")
            {
               ...
               _loc5_.textColor = this.const_1508;
            }
            else
            {
               _loc5_.textColor = this.const_1509;
            }
            _loc5_.enable();
         }
         else
         ...
         _loc5_.text = param1;
         _loc5_.height = Math.min(_loc5_.textHeight + this.const_1074,this.const_2274);
         _loc5_.height = Math.max(_loc5_.height,this.const_2272);
         _loc3_.height = _loc5_.height + this.const_2271;
         if(param2)
         {
            _loc5_.addEventListener(WindowKeyboardEvent.const_365,this.onMottoKeyboard);
            _loc5_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc5_.removeEventListener(WindowKeyboardEvent.const_365,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1024.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      private function enableButton(param1:String, param2:Boolean = true) : void
      {
         ...
         var _loc3_:IRegionWindow = this.var_103.getChildByName(param1) as IRegionWindow;
      ...
      protected function showButton(param1:String, param2:Boolean) : void
      {
         ...
         var _loc3_:IWindow = this.var_103.getChildByName(param1);
         if(_loc3_ != null)
         {
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.const_870:
               ...
               break;
            case RoomWidgetUserInfoUpdateEvent.const_725:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:IWindowContainer = this.var_52.getListItemByName("motto_container") as IWindowContainer;
         if(!_loc2_)
         {
            return;
         }
         ...
         {
            _loc6_ = getTimer();
            if(_loc6_ - this.var_2597 > this.const_2273 && _loc4_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2597 = _loc6_;
               _loc3_.textColor = this.const_1509;
            }
         }
         else
         {
            _loc3_.textColor = this.const_1508;
         }
      }
      ...
      {
         var _loc5_:* = null;
         this.var_103.width = 250;
         var _loc2_:* = [];
         this.var_103.groupChildrenWithTag("CMD_BUTTON_REGION",_loc2_,true);
         var _loc3_:int = 250;
         var _loc4_:int = 0;
