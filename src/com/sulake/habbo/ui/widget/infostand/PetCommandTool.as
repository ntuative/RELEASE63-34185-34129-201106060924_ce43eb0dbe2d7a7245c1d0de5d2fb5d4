package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private static const const_1425:Point = new Point(100,30);
      ...
      private const const_2263:int = 1100;
      
      public function PetCommandTool(param1:InfostandWidget)
      {
         super();
         this._widget = param1;
         this.var_1189 = new Map();
         this.var_369 = new Timer(this.const_2263);
         this.var_369.addEventListener(TimerEvent.TIMER,this.onButtonDisableTimeout);
      }
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:CommandConfiguration = this.var_1189.getValue(param1) as CommandConfiguration;
         if(_loc6_ == null)
         {
            this.disableAllButtons();
            this.requestEnabledCommands(this.var_518);
         }
         else
         {
      ...
      {
         var _loc2_:CommandConfiguration = this.var_1189.getValue(this.var_518) as CommandConfiguration;
      ...
      {
         this.var_1189.remove(param1);
         this.var_1189.add(param1,param2);
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_885,param1);
      ...
      private function createCommandWindow() : void
      {
         ...
         this.var_41.setParamFlag(WindowParam.const_101,true);
         ...
         this.var_41.position = const_1425;
      }
      ...
      private function openInfoWindow() : void
      {
         ...
         if(this.var_446 == null)
         {
            ...
            this.var_446 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(this.var_446 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            this.var_446.x = 200;
            this.var_446.procedure = this.onInfoWindowProcedure;
         }
         else
         {
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_450,this.var_518));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_626,this.var_518,this.var_1801 + " " + _loc6_);
      ...
      private function onTrainButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc6_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_626,this.var_518,this.var_1801 + " " + _loc5_);
