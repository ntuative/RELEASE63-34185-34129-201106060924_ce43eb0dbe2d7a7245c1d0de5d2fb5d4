package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_1075:MeMenuSoundSettingsSlider;
      
      private var var_1079:BitmapData;
      
      private var var_1077:BitmapData;
      
      private var var_1076:BitmapData;
      
      private var var_1078:BitmapData;
      ...
      {
         this.var_1016 = param1.volume;
         if(this.var_1075 != null)
         {
            this.var_1075.setValue(this.var_1016);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            this.var_1079 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_off_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1077 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_on_color") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1076 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_on_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1078 = (_loc5_.content as BitmapData).clone();
         }
         this.var_1075 = new MeMenuSoundSettingsSlider(this,this._window.findChildByName("volume_container") as IWindowContainer,this._widget.assets,0,1);
         this.updateSoundIcons();
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_747));
      }
      ...
      private function updateSoundIcons() : void
      {
         if(this.var_1016 == 0)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1078);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1079);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1076);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1077);
         }
      }
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_928);
         }
         else
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_788);
         }
