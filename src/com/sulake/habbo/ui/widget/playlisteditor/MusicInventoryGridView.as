package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MusicInventoryGridView
   {
      ...
      private var var_105:MusicInventoryGridItem;
      ...
      public function refresh() : void
      {
         ...
         while(_loc5_ < _loc4_)
         {
            ...
            this.var_615.addGridItem(_loc12_.window);
      ...
      public function setPreviewIconToPause() : void
      {
         ...
         {
            this.var_105.playButtonState = MusicInventoryGridItem.const_1316;
         }
      }
      ...
      public function setPreviewIconToPlay() : void
      {
         if(this.var_105 != null)
         {
            this.var_105.playButtonState = MusicInventoryGridItem.const_642;
         }
      }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || _loc3_)
         {
            if(param2.name == "button_to_playlist" || _loc3_)
            {
               if(this.var_105 != null)
               {
                  this.var_105.deselect();
                  this.stopPreview();
                  this._widget.sendAddToPlayListMessage(this.var_105.diskId);
                  this.var_105 = null;
               }
            }
            else if(param2.name == "button_play_pause")
            {
               if(this.var_105.playButtonState == MusicInventoryGridItem.const_642)
               {
                  this.var_105.playButtonState = MusicInventoryGridItem.const_1293;
                  this._widget.playUserSong(this.var_105.songId);
               }
               else
               {
                  this.stopPreview();
            ...
            {
               _loc4_ = this.var_615.getGridItemIndex(param1.window);
               if(_loc4_ != -1)
               {
                  _loc5_ = this._items.getWithIndex(_loc4_);
                  if(_loc5_ != this.var_105)
                  {
                     if(this.var_105 != null)
                     {
                        this.var_105.deselect();
