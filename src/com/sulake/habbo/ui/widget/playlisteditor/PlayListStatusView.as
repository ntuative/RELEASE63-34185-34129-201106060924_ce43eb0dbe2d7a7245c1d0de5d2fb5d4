package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_872:String = "PLSV_ADD_SONGS";
      
      public static const const_1188:String = "PLSV_START_PLAYBACK";
      
      public static const const_484:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_45 != const_484)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_468[this.var_45];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_468[const_872];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_468.add(const_484,_loc1_);
