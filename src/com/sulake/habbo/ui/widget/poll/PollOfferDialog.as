package com.sulake.habbo.ui.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_1772:String = "POLL_OFFER_STATE_OK";
      
      public static const const_969:String = "POLL_OFFER_STATE_CANCEL";
      
      public static const const_108:String = "POLL_OFFER_STATE_UNKNOWN";
      ...
      {
         if(this._state != const_108)
         {
            return;
         }
         this._state = const_1772;
         this._widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_836,this._id));
      }
