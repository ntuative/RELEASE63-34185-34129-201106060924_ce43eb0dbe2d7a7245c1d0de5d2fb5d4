package com.sulake.habbo.ui.widget.poll
{
   ...
   public class PollWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPollUpdateEvent.const_151,this.showPollOffer);
         param1.addEventListener(RoomWidgetPollUpdateEvent.const_79,this.showPollError);
         param1.addEventListener(RoomWidgetPollUpdateEvent.const_144,this.showPollContent);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPollUpdateEvent.const_151,this.showPollOffer);
         param1.removeEventListener(RoomWidgetPollUpdateEvent.const_79,this.showPollError);
         param1.removeEventListener(RoomWidgetPollUpdateEvent.const_144,this.showPollContent);
      }
