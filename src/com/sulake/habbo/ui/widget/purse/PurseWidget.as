package com.sulake.habbo.ui.widget.purse
{
   ...
   public class PurseWidget extends RoomWidgetBase
   {
      ...
      private const const_2026:int = 3;
      
      private const const_2291:uint = 4.291993382E9;
      
      private const const_2293:uint = 4.29080704E9;
      
      private const const_2292:uint = 4.285767869E9;
      
      private const const_2290:uint = 4.28366404E9;
      ...
      public function PurseWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         if(_loc5_)
         {
            ...
            this._view.x = _loc6_.width - this._view.width - this.const_2026;
            this._view.y = this.const_2026;
      ...
      {
         this.var_2101 = param1.balance;
         if(this._view)
         {
            this._view.findChildByName("credits").caption = this.var_2101.toString();
            this._view.findChildByName("credits_shadow").caption = this.var_2101.toString();
         }
      }
      
      private function onPixelBalance(param1:RoomWidgetPurseUpdateEvent) : void
      {
         this.var_2100 = param1.balance;
         if(this._view)
         {
            this._view.findChildByName("pixels").caption = this.var_2100.toString();
            this._view.findChildByName("pixels_shadow").caption = this.var_2100.toString();
         }
      }
      ...
      {
         messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1312));
      }
      
      private function onOrangeMouseOver(param1:WindowMouseEvent) : void
      {
         param1.window.color = this.const_2293;
      }
      
      private function onOrangeMouseOut(param1:WindowMouseEvent) : void
      {
         param1.window.color = this.const_2291;
      }
      ...
      {
         param1.window.color = this.const_2292;
      }
   }
}
