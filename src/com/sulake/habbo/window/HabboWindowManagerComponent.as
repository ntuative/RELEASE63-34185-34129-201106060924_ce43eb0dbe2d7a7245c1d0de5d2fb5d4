package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_1458:uint = 1;
      ...
      private var var_947:IWindowRenderer;
      
      private var _skinContainer:ISkinContainer;
      
      private var var_259:Array;
      
      private var var_1469:IEventDispatcher;
      
      private var var_1183:Boolean = false;
      
      private var var_1787:ProfilerOutput;
      
      private var var_1467:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_947 = new WindowRenderer(this._skinContainer);
         this._windowContextArray = new Array(const_463);
         ...
         {
            this._windowContextArray[_loc6_] = new WindowContext("layer_" + _loc6_,this.var_947,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this.var_280 = this._windowContextArray[const_1458];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1787)
            {
               this.var_1787 = new ProfilerOutput(context,this,this.var_947);
            }
            this.var_1787.profiler = _loc3_;
            this.var_1467 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1467);
            this.var_1468 = new ProfilerAgentTask("Redraw","Window rasterizer");
      ...
      {
         return this.var_280.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      {
         return this.var_280.getWindowParser().windowToXMLString(param1);
      }
      ...
      {
         return this._windowContextArray[param1].getDesktopWindow().getChildAt(this.var_280.getDesktopWindow().numChildren - 1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_412.length > 0)
         {
            this.var_1469.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_463 - 1;
            while(_loc2_ >= 0)
            {
         ...
         this.var_1469.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         ...
         if(WindowContext.var_412.length > 0)
         {
            WindowContext.var_412.flush();
         }
         MouseCursorControl.change();
         this.var_1469.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1966,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1920,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1729,param2.name + ": " + param2.toString());
            }
         }
      }
