package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_56:IRoomContentLoader;
      ...
      private var var_3032:IRoomContentLoader;
      
      private var var_604:IRoomObjectFactory = null;
      
      private var var_511:IRoomObjectVisualizationFactory = null;
      
      private var _state:int = 0;
      
      private var var_1159:XML = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_605 = [];
         this.var_606 = [];
         events.addEventListener(RoomContentLoadedEvent.const_380,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_556,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_889,this.onContentLoaded);
      }
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_604 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_604 == null || this.var_511 == null)
         {
            return;
         }
         this._state = const_1802;
         if(this.var_1159 != null)
         {
            _loc1_ = this.var_1159;
            this.var_1159 = null;
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         this.var_972 = 50;
         this.var_158 = param2;
         var _loc3_:Array = this.var_56.getPlaceHolderTypes();
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_.length)
         {
            _loc5_ = _loc3_[_loc4_];
            if(this.var_605.indexOf(_loc5_) < 0)
            {
               this.var_56.loadObjectContent(_loc5_,events);
               this.var_605.push(_loc5_);
            }
            _loc4_++;
         }
      ...
      {
         return this.var_104.getWithIndex(param1);
      }
      
      public function getRoomCount() : int
      {
         return this.var_104.length;
      }
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         if(!this.var_56.hasInternalContent(param3))
         {
            _loc7_ = this.var_56.getGraphicAssetCollection(param3);
            if(_loc7_ == null)
            {
               this.var_56.loadObjectContent(param3,events);
               _loc12_ = this.var_56.getPlaceHolderType(param3);
               _loc7_ = this.var_56.getGraphicAssetCollection(_loc12_);
            }
            _loc8_ = this.var_56.getVisualizationXML(_loc12_);
            _loc9_ = this.var_56.getLogicXML(_loc12_);
            if(_loc8_ == null || _loc7_ == null)
            {
               return null;
            }
            _loc10_ = this.var_56.getVisualizationType(_loc12_);
            _loc11_ = this.var_56.getLogicType(_loc12_);
         }
         else
         {
            _loc10_ = param3;
         ...
         var _loc17_:IRoomObjectGraphicVisualization = this.var_511.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = this.var_511.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_604.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_604 != null)
         {
            return this.var_604.createRoomObjectManager();
         }
         return null;
      }
      ...
      public function isContentAvailable(param1:String) : Boolean
      {
         if(this.var_56 != null)
         {
            if(this.var_56.getGraphicAssetCollection(param1) != null)
            {
               return true;
            }
         }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this._state == const_731)
         {
            return;
         }
         if(this.var_56 == null)
         {
            this._state = const_731;
            return;
         }
         if(this.var_56.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = this.var_605.indexOf(param1);
            if(_loc2_ >= 0)
            {
               this.var_605.splice(_loc2_,1);
            }
            if(this.var_605.length == 0)
            {
               this._state = const_733;
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(this.var_926.indexOf(_loc2_) < 0)
         {
            this.var_926.push(_loc2_);
         }
      }
      ...
      private function processLoadedContentTypes() : void
      {
         ...
         {
            _loc2_ = this.var_926[0];
            this.var_926.splice(0,1);
            _loc3_ = this.var_56.getVisualizationXML(_loc2_);
            if(_loc3_ == null)
            {
               if(this.var_158 != null)
               {
            ...
            _loc4_ = this.var_56.getGraphicAssetCollection(_loc2_);
            if(_loc4_ == null)
            {
               if(this.var_158 != null)
               {
      ...
      private function updateObjectContents(param1:String) : void
      {
         ...
         if(this.var_56 == null || this.var_511 == null)
         {
            return;
         }
         var _loc2_:XML = this.var_56.getVisualizationXML(param1);
         var _loc3_:XML = this.var_56.getLogicXML(param1);
         var _loc4_:IGraphicAssetCollection = this.var_56.getGraphicAssetCollection(param1);
         if(_loc2_ == null || _loc4_ == null)
         {
            return;
         }
         var _loc5_:String = this.var_56.getVisualizationType(param1);
         var _loc6_:String = this.var_56.getLogicType(param1);
         var _loc7_:IRoomObjectVisualizationData = this.var_511.getRoomObjectVisualizationData(param1,_loc5_,_loc2_);
         var _loc8_:int = this.var_104.length - 1;
         while(_loc8_ >= 0)
         {
            _loc9_ = this.var_104.getWithIndex(_loc8_) as RoomInstance;
            _loc10_ = this.var_104.getKey(_loc8_);
            if(_loc9_ != null)
            {
               ...
               for each(_loc12_ in _loc11_)
               {
                  ...
                  while(_loc14_ >= 0)
                  {
                     ...
                     if(_loc15_ != null)
                     {
                        _loc16_ = this.var_511.createRoomObjectVisualization(_loc5_);
                        if(_loc16_ != null)
                        {
                           ...
                           else
                           {
                              ...
                              _loc17_ = this.var_604.createRoomObjectLogic(_loc6_);
                              ...
                              if(this.var_158 != null)
                              {
                                 this.var_158.objectInitialized(_loc10_,_loc15_.getId(),_loc12_);
                              }
                           }
                        }
                        else
