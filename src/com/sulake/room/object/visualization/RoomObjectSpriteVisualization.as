package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      private var var_403:IRoomObject;
      
      private var var_876:IGraphicAssetCollection;
      
      protected var var_498:int = -1;
      
      protected var var_157:int = -1;
      
      protected var var_96:int = -1;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_220 != null)
         {
            ...
            {
               _loc1_ = this.var_220[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function set assetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         {
            this.var_876.removeReference();
         }
         this.var_876 = param1;
         if(this.var_876 != null)
         {
            this.var_876.addReference();
         }
      }
      ...
      {
         var _loc2_:* = null;
         while(this.var_220.length > param1)
         {
            _loc2_ = this.var_220[this.var_220.length - 1] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
         ...
         while(this.var_220.length < param1)
         {
            ...
            this.var_220.push(_loc2_);
         }
      }
      
      public function get spriteCount() : int
      {
         return this.var_220.length;
      }
      ...
      {
         this.var_498 = 4294967295;
         this.var_157 = 4294967295;
         this.var_96 = -1;
      }
