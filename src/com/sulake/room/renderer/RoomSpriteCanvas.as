package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private var var_262:BitmapDataCache;
      
      private var var_639:RoomObjectCache;
      
      private var var_523:Array;
      
      private var var_635:Array;
      
      private var var_1483:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2472:Number = -1.0E7;
      
      private var var_2473:Number = -1.0E7;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this._id = param2;
         this.var_261 = new Sprite();
         this.var_261.mouseEnabled = false;
         this.var_106 = new Sprite();
         this.var_106.name = "canvas";
         this.var_106.mouseEnabled = false;
         this.var_261.addChild(this.var_106);
         ...
         this.var_262 = new BitmapDataCache(16,32,1);
         var _loc6_:* = null;
         ...
         this.var_639 = new RoomObjectCache(_loc6_);
         this.var_780 = new ColorTransform();
         this.var_638 = new Matrix();
      ...
      {
         this.var_524.x -= param1 - this.var_637;
         this.var_637 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_524.y -= param1 - this.var_636;
         this.var_636 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_1036 = true;
            if(this.var_141 != null && !this.var_261.contains(this.var_141))
            {
               this.var_261.addChild(this.var_141);
               this.var_106.mask = this.var_141;
            }
         }
         else if(!param1 && this.var_1036)
         {
            this.var_1036 = false;
            if(this.var_141 != null && this.var_261.contains(this.var_141))
            {
               this.var_261.removeChild(this.var_141);
      ...
      public function dispose() : void
      {
         ...
         {
            while(this.var_261.numChildren > 0)
            {
               this.var_261.removeChildAt(0);
            }
            this.var_261 = null;
         }
         this.var_106 = null;
      ...
      {
         this.var_639.removeObjectCache(param1);
      }
      
      public function render(param1:int) : void
      {
         this.var_1823 = !this.var_1823;
         ...
         if(this.var_521 != this.var_2475 || this.var_522 != this.var_2476)
         {
            _loc8_ = true;
         }
         if(this.var_106.x != this.var_637 || this.var_106.y != this.var_636)
         {
            this.var_106.x = this.var_637;
            this.var_106.y = this.var_636;
            _loc8_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_2475 = this.var_521;
         this.var_2476 = this.var_522;
      }
      ...
      private function calculateUpdateInterval(param1:int) : void
      {
         ...
         if(this.var_1484 > 0)
         {
            ...
            if(_loc2_ > const_1056 * 3)
            {
               ...
               this.var_2470 = _loc2_;
            }
            if(_loc2_ <= MAXIMUM_VALID_FRAME_UPDATE_INTERVAL)
            {
               ++this.var_774;
               if(this.var_774 == const_372 + 1)
               {
                  this.var_547 = _loc2_;
                  this.var_1822 = this.var_2474;
               }
               else if(this.var_774 > const_372 + 1)
               {
                  _loc3_ = Number(this.var_774 - const_372);
                  this.var_547 = this.var_547 * (_loc3_ - 1) / _loc3_ + Number(_loc2_) / _loc3_;
                  this.var_1822 = this.var_1822 * (_loc3_ - 1) / _loc3_ + Number(this.var_2474) / _loc3_;
                  if(this.var_774 > const_372 + const_1484)
                  {
                     this.var_774 = const_372;
                     if(!this.var_1197 && this.var_547 > const_1056)
                     {
                        this.var_1197 = true;
                        Logger.log("Room canvas updating really slow - now entering frame skipping mode...");
                     }
                     else if(this.var_1197 && this.var_547 < const_1485)
                     {
                        this.var_1197 = false;
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_639.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_639.getObjectCache(param2);
         ...
         _loc6_.update(this._geometry,param3,!_loc9_.isEmpty || param4,this.var_1823 && this.var_1197);
         ...
         _loc13_ += int(this.var_521 / 2);
         _loc14_ += int(this.var_522 / 2);
         var _loc16_:int = 0;
         var _loc17_:* = null;
         var _loc18_:* = null;
         var _loc19_:int = 0;
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  ...
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_636;
                  if(this.rectangleVisible(_loc19_,_loc20_,_loc22_.width,_loc22_.height))
                  {
                     ...
                     _loc17_.y = _loc20_ - this.var_636;
      ...
      {
         if(param1 < this.var_521 && param1 + param3 >= 0 && (param2 < this.var_522 && param2 + param4 >= 0))
         {
            if(!this.var_3005)
            {
               return true;
      ...
      private function rectangleVisibleWithExclusion(param1:int, param2:int, param3:int, param4:int) : Boolean
      {
         ...
         if(param1 + param3 >= this.var_521)
         {
            param3 -= this.var_521 + 1 - (param1 + param3);
         }
         if(param2 + param4 >= this.var_522)
         {
            param4 -= this.var_522 + 1 - (param2 + param4);
         }
         for each(_loc5_ in this.var_2471)
         {
      ...
      {
         if(param1 < 0 || param1 >= this.var_961)
         {
            return null;
         }
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(param2 < 0 || param2 >= this.var_961)
         {
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         if(param1 < this.var_775 || this.var_775 == 0)
         {
            _loc4_ = this.var_961 - 1;
            while(_loc4_ >= param1)
            {
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:Boolean, param5:int) : BitmapData
      {
         ...
         if((param3 || param4) && param5 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc6_ = this.var_262.getBitmapData(_loc7_);
            }
            if(_loc6_ == null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     this.var_262.addBitmapData(_loc7_,_loc6_);
                  }
                  return _loc6_;
               }
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false, param4:Boolean = true, param5:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(name.length > 0)
         {
            finalData = this.var_262.getBitmapData(cacheName);
            if(!allowCreation)
            {
               return finalData;
            }
         ...
         if(finalData == null)
         {
            ...
            this.var_638.identity();
            if(flipH)
            {
               this.var_638.scale(-1,1);
               this.var_638.translate(data.width,0);
            }
            if(flipV)
            {
               this.var_638.scale(1,-1);
               this.var_638.translate(0,data.height);
            }
            finalData.draw(data,this.var_638);
            if(name.length > 0)
            {
               this.var_262.addBitmapData(cacheName,finalData);
            }
         }
         return finalData;
      }
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            {
               finalData = new ExtendedBitmapData(data.width,data.height,true,16777215);
               finalData.copyPixels(data,data.rect,const_679);
            }
            catch(e:Error)
            {
               finalData = new ExtendedBitmapData(1,1,true,16777215);
            }
            this.var_780.redMultiplier = tR;
            this.var_780.greenMultiplier = tG;
            this.var_780.blueMultiplier = tB;
            finalData.colorTransform(finalData.rect,this.var_780);
            if(name.length > 0)
            {
               this.var_262.addBitmapData(cacheName,finalData);
            }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         ...
         this.var_1824 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1196;
         return this.var_1824;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_521 / 2;
         var _loc12_:Number = param2 - this.var_522 / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1825,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_634.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_634.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2472 || param2 != this.var_2473)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_634.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_634.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
         ...
         while(_loc1_ < this.var_371.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1483.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
