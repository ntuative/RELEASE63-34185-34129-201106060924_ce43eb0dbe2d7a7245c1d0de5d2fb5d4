package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectSortableSpriteCacheItem
   {
      ...
      {
         if(param1 != this.var_2606 || param2 != this.var_2605)
         {
      ...
      public function setSpriteCount(param1:int) : void
      {
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(param1 < this.var_220.length)
         {
            _loc2_ = param1;
            while(_loc2_ < this.var_220.length)
            {
            ...
            this.var_220.splice(param1,this.var_220.length - param1);
         }
